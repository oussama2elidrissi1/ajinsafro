        ...
        <div class="card-body">
            <form method="GET" class="row g-2 align-items-end">
                <div class="col-md-6">
                    ...
                    <input type="text" name="q" class="form-control" value="<?php echo e($search); ?>" placeholder="Nom du voyage ou slug">
                </div>
                <div class="col-md-3">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($st); ?>" <?php if($status === $st): echo 'selected'; endif; ?>><?php echo e(\App\Models\Departure::make(['status' => $st])->status_label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-3 d-flex gap-2">
                    <button type="submit" class="btn btn-primary w-100">Filtrer</button>
                    <a href="<?php echo e(route('admin.circuits.departs-dates')); ?>" class="btn btn-light w-100">Réinitialiser</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $voyages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voyage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="card dd-card">
                    <div class="dd-cover">
                        <?php if($cover): ?>
                            <img src="<?php echo e($cover); ?>" alt="<?php echo e($voyage->name); ?>" loading="lazy">
                        <?php endif; ?>
                    </div>
                    <div class="card-body">
                        <h5 class="mb-1"><?php echo e($voyage->name); ?></h5>
                        <p class="text-muted small mb-3"><?php echo e($destination); ?></p>

                        <div class="row g-2 mb-3">
                            <div class="col-4">
                                <div class="dd-kpi">
                                    <span class="dd-kpi__label">Départs</span>
                                    <div class="dd-kpi__value"><?php echo e((int) ($summary['total_departures'] ?? 0)); ?></div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="dd-kpi">
                                    <span class="dd-kpi__label">Actifs</span>
                                    <div class="dd-kpi__value text-success"><?php echo e((int) ($summary['active_departures'] ?? 0)); ?></div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="dd-kpi">
                                    <span class="dd-kpi__label">Disponibles</span>
                                    <div class="dd-kpi__value text-primary"><?php echo e((int) ($summary['available_capacity'] ?? 0)); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            <button
                                ...
                                data-ra-voyage-id="<?php echo e($voyage->id); ?>"
                                data-ra-departures-url="<?php echo e($departuresUrl); ?>"
                                data-ra-sync-url="<?php echo e($syncUrl); ?>"
                                data-ra-panel-base="<?php echo e($panelBase); ?>"
                                data-ra-select-departure="<?php echo e($firstDepartureId > 0 ? $firstDepartureId : ''); ?>"
                                data-bs-toggle="modal"
                                data-bs-target="#voyageRoomAvailabilityModal"
                            >
                                Gérer les départs
                            </button>
                            <a href="<?php echo e(route('admin.circuits.voyages.edit', $voyage->wp_post_id ?? $voyage->id)); ?>#availability" class="btn btn-outline-secondary btn-sm">
                                Availability
                            </a>
                        </div>
                    </div>
