...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><?php echo e($isEdit ? 'Modifier agence' : 'Nouvelle agence'); ?></h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="<?php echo e($isEdit ? route('admin.branches.update', $branch) : route('admin.branches.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <?php if($isEdit): ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('code', $branch->code)); ?>" required maxlength="20">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('city', $branch->city)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('country', $branch->country)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="manager_user_id" class="form-select <?php $__errorArgs = ['manager_user_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__errorArgs = ['manager_user_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', $branch->email)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1" id="is_active" <?php echo e(old('is_active', $branch->is_active ?? true) ? 'checked' : ''); ?>>
