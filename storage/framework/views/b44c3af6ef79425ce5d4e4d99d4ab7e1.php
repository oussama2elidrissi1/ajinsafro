...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Espace client'); ?> · Ajinsafro</title>
    ...
    <header class="aj-header">
        <div class="aj-header-inner">
            <div class="aj-brand">
                ...
                <h4><?php echo $__env->yieldContent('page_title', 'Espace client'); ?></h4>
            </div>
            <nav class="aj-nav">
                <a class="btn-nav <?php if(request()->routeIs('client.dashboard')): ?> active <?php endif; ?>" href="<?php echo e(route('client.dashboard')); ?>">
                    <i class="ri-home-3-line"></i> Dashboard
                </a>
                <a class="btn-nav <?php if(request()->routeIs('client.reservations.*')): ?> active <?php endif; ?>" href="<?php echo e(route('client.reservations.index')); ?>">
                    <i class="ri-calendar-check-line"></i> Réservations
                </a>
                <a class="btn-nav <?php if(request()->routeIs('client.profile.*')): ?> active <?php endif; ?>" href="<?php echo e(route('client.profile.edit')); ?>">
    ...
    <main class="aj-content">
        ...
        <?php if(session('error')): ?>
            <div class="alert aj-alert alert-danger alert-dismissible fade show mb-3" role="alert">
                <i class="ri-error-warning-line me-1"></i> <?php echo e(session('error')); ?>
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\client\layout.blade.php ENDPATH**/ ?>