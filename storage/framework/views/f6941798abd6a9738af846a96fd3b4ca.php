        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <img class="rounded mr-2" alt="200x200" width="200" src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>"
                                data-holder-rendered="true">
                        </div>
                        <div class="col-md-6">
                            <div class="mt-4 mt-md-0">
                                <img class="rounded-circle avatar-xl" alt="200x200" src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>"
                                    data-holder-rendered="true">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Images in Bootstrap are made responsive with <code
                            class="highlighter-rouge">.img-fluid</code>. <code class="highlighter-rouge">max-width:
                            100%;</code> and <code class="highlighter-rouge">height: auto;</code> are applied to the image
                        so
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\ui-images.blade.php ENDPATH**/ ?>