...
<?php $__env->startSection('content'); ?>
    <div id="res-hub-root"
         class="d-none"
         data-res-base="<?php echo e(rtrim(url('/admin/reservations'), '/')); ?>"
         data-csrf="<?php echo e(csrf_token()); ?>"
         data-can-edit="<?php echo e(auth()->user()->can('reservations.edit') ? '1' : '0'); ?>"
         data-can-update="<?php echo e(auth()->user()->can('reservations.update') ? '1' : '0'); ?>"
         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reservations.view')): ?>
         data-hub-refresh-url="<?php echo e(route('admin.reservations.hub-refresh')); ?>"
         <?php endif; ?>
         <?php if(config('app.debug') && auth()->user()->can('reservations.view')): ?>
         data-hub-debug-url="<?php echo e(route('admin.reservations.hub-debug')); ?>"
         <?php endif; ?>
    ></div>
    ...
    <div class="res-hub-page">
        <div class="page-title-box res-hub-hero">
            <div class="res-hub-hero__copy">
                ...
                <p class="res-hub-hero__meta mb-0">
                    ...
                    <?php if($showCrossAgencyBranchCol): ?>
            ...
            <div class="res-hub-hero__actions">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reservations.view')): ?>
                    <a href="<?php echo e(route('admin.reservations.workspace')); ?>" class="btn res-hub-btn res-hub-btn--soft">
                        <i class="bx bx-grid-alt"></i>
                        <span>Catalogue (reserver)</span>
                    </a>
                <?php endif; ?>
                <a href="<?php echo e(route('admin.reservations.create')); ?>" class="btn res-hub-btn res-hub-btn--primary">
        ...
        <?php if(session('success') && empty($reservationCreated)): ?>
        ...
        <?php if(is_array($reservationCreated)): ?>
                ...
                <div class="d-flex flex-wrap align-items-start justify-content-between gap-3">
                    <div class="flex-grow-1 min-w-0">
                        ...
                        <dl class="row mb-0 small">
                            ...
                            <dd class="col-sm-8 col-md-9 mb-1"><strong>#<?php echo e($reservationCreated['id'] ?? '-'); ?></strong></dd>
                            <dt class="col-sm-4 col-md-3 text-muted fw-normal mb-1">Offre liee</dt>
                            <dd class="col-sm-8 col-md-9 mb-1"><?php echo e($reservationCreated['voyage_name'] ?? '-'); ?></dd>
                            <dt class="col-sm-4 col-md-3 text-muted fw-normal mb-1">Date de depart</dt>
                            <dd class="col-sm-8 col-md-9 mb-1"><?php echo e($reservationCreated['departure_label'] ?? '-'); ?></dd>
                            <dt class="col-sm-4 col-md-3 text-muted fw-normal mb-1">Personnes</dt>
                            <dd class="col-sm-8 col-md-9 mb-1"><?php echo e($reservationCreated['pax_count'] ?? '-'); ?></dd>
                            <?php if($canViewReservationFinancial): ?>
                                <dt class="col-sm-4 col-md-3 text-muted fw-normal mb-1">Total</dt>
                                <dd class="col-sm-8 col-md-9 mb-1"><?php echo e($reservationCreated['total_label'] ?? '-'); ?></dd>
                            <?php endif; ?>
                            <dt class="col-sm-4 col-md-3 text-muted fw-normal mb-0">Statut</dt>
                            <dd class="col-sm-8 col-md-9 mb-0"><?php echo e($reservationCreated['status_label'] ?? '-'); ?></dd>
                        </dl>
                    </div>
                    <div class="d-flex flex-wrap gap-2 align-items-center flex-shrink-0">
                        <a href="<?php echo e($reservationCreated['urls']['edit'] ?? '#'); ?>" class="btn res-hub-btn res-hub-btn--primary btn-sm">Voir la reservation</a>
        ...
        <div class="card res-hub-filter-card border-0 shadow-sm mb-4">
            <div class="card-body">
                <form method="get" action="<?php echo e(route('admin.reservations.index')); ?>" class="res-hub-filter-grid">
                    <?php if($filterChannel): ?>
                        <input type="hidden" name="channel" value="<?php echo e($filterChannel); ?>">
                    <?php endif; ?>
                    <div class="res-hub-field">
                        ...
                        <select name="voyage_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $voyageOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($v->id); ?>" <?php if((string) $filterTourId === (string) $v->id): echo 'selected'; endif; ?>><?php echo e($v->resolved_name ?? $v->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="res-hub-field">
                        <label class="form-label">Depart (TravelDate id)</label>
                        <input type="number" name="travel_date_id" class="form-control" placeholder="ex. 234" value="<?php echo e($filterTravelDateId); ?>">
                    </div>
                    <div class="res-hub-field">
                        <label class="form-label">Statut</label>
                        <select name="status" class="form-select">
                            <option value="">Tous</option>
                            <option value="<?php echo e(\App\Models\Reservation::STATUS_EN_COURS); ?>" <?php if($filterStatus === \App\Models\Reservation::STATUS_EN_COURS): echo 'selected'; endif; ?>>En attente</option>
                            <option value="<?php echo e(\App\Models\Reservation::STATUS_SHARED_ROOM_PENDING); ?>" <?php if($filterStatus === \App\Models\Reservation::STATUS_SHARED_ROOM_PENDING): echo 'selected'; endif; ?>>En attente de jumelage demi-double</option>
                            <option value="<?php echo e(\App\Models\Reservation::STATUS_SHARED_ROOM_PAIRED); ?>" <?php if($filterStatus === \App\Models\Reservation::STATUS_SHARED_ROOM_PAIRED): echo 'selected'; endif; ?>>Demi-double jumelee</option>
                            <option value="<?php echo e(\App\Models\Reservation::STATUS_VALIDEE); ?>" <?php if($filterStatus === \App\Models\Reservation::STATUS_VALIDEE): echo 'selected'; endif; ?>>Confirmee</option>
                            <option value="<?php echo e(\App\Models\Reservation::STATUS_ANNULEE); ?>" <?php if($filterStatus === \App\Models\Reservation::STATUS_ANNULEE): echo 'selected'; endif; ?>>Annulee</option>
                        </select>
                    </div>
                    <div class="res-hub-field">
                        <label class="form-label">Recherche client</label>
                        <input type="text" name="search" class="form-control" placeholder="<?php echo e($canViewClientContact ? 'Nom, email, telephone...' : 'Nom client ou voyage...'); ?>" value="<?php echo e($filterSearch); ?>">
                    </div>
                    ...
                    <div class="res-hub-field res-hub-field--actions">
                        <a href="<?php echo e($resetUrl); ?>" class="btn res-hub-btn res-hub-btn--soft w-100">
                ...
                <div class="card res-hub-kpi res-hub-kpi--blue border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="res-hub-kpi__copy">
                            ...
                            <div class="res-hub-kpi__value" id="res-hub-stat-total"><?php echo e($hubStats['total']); ?></div>
                ...
                <div class="card res-hub-kpi res-hub-kpi--amber border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="res-hub-kpi__copy">
                            ...
                            <div class="res-hub-kpi__value" id="res-hub-stat-en-cours"><?php echo e($hubStats['en_cours']); ?></div>
                            <div class="res-hub-kpi__meta">Reservations</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card res-hub-kpi res-hub-kpi--green border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="res-hub-kpi__copy">
                            ...
                            <div class="res-hub-kpi__value" id="res-hub-stat-validee"><?php echo e($hubStats['validee']); ?></div>
                            <div class="res-hub-kpi__meta">Reservations</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card res-hub-kpi res-hub-kpi--red border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="res-hub-kpi__copy">
                            ...
                            <div class="res-hub-kpi__value" id="res-hub-stat-annulee"><?php echo e($hubStats['annulee']); ?></div>
                            <div class="res-hub-kpi__meta">Reservations</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card res-hub-table-card shadow-sm border-0">
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0 reservations-table">
                        ...
                        <tbody id="res-hub-tbody">
                            <?php echo $__env->make('admin.reservations.partials.hub-table-rows', [
                ...
                <?php if(method_exists($reservations, 'links')): ?>
                    <div class="px-3 py-3 border-top" id="res-hub-pagination"><?php echo e($reservations->links()); ?></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
(function () {
    ...
    var voyageName = <?php echo json_encode($voyage->resolved_name ?? $voyage->name ?? '', 15, 512) ?>;
    var allReservationsUrl = <?php echo json_encode($allReservationsUrl, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin-v6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\reservations\index.blade.php ENDPATH**/ ?>