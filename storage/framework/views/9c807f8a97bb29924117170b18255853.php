...
?>
<form id="workspace-reservation-form" method="post" action="<?php echo e(route('admin.reservations.workspace.store')); ?>" class="ws-booking-form">
    <?php echo csrf_field(); ?>
    <input type="hidden" id="ws-reservation-data-url-template" value="<?php echo e($wsReservationDataUrlTemplate); ?>">
                ...
                <div id="ws-prefill-panel" class="hidden ws-section ws-section--voyage">
                    ...
                    <div id="details-package" class="details-block ws-step-block">
                        <div class="ws-step-block__header">
                            ...
                            <p class="ws-step-block__sub">Choisissez l’option de séjour la plus adaptée au dossier.</p>
                        </div>
                        ...
                        <div class="ws-form-field ws-form-field--full hidden" id="ws-client-existing-wrap">
                            ...
                            <select name="client_external_id" id="ws-client-external-id" class="ws-input-shell">
                                ...
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($c->id); ?>"><?php echo e($c->client_code); ?> — <?php echo e($c->full_name ?: $c->email); ?></option>
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\reservations\workspace\partials\form.blade.php ENDPATH**/ ?>