...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.form-section','data' => ['title' => '1. Informations générales','subtitle' => 'Structure principale de l’offre économique.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => '1. Informations générales','subtitle' => 'Structure principale de l’offre économique.']); ?>
            <div class="row g-3">
                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?></div>
                <div class="col-md-2"><label class="form-label">Ville d’arrivée</label><input type="text" name="arrival_city" value="<?php echo e(old('arrival_city', $offer->arrival_city)); ?>" class="form-control <?php $__errorArgs = ['arrival_city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
