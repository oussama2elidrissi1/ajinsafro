                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="post_status" name="post_status">
                                        <option value="publish" <?php echo e(old('post_status', $voyage->post_status) === 'publish' ? 'selected' : ''); ?>>Publi̩</option>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <small class="text-muted d-block mt-2" id="locationCount" style="font-size: 12px; color: #646970;">
                            ...
                            <span id="locationCountText"><?php echo e(count($selectedLocationIds ?? [])); ?> location(s) s̩lectionn̩e(s)</span>
                        </small>
                    </div>
                </div>
