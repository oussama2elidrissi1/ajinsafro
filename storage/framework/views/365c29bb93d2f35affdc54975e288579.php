                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">URL: ajinsafro.net/tours/<strong><?php echo e($voyage->post_name); ?></strong></small>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="duration_day" name="duration_day" value="<?php echo e(old('duration_day', $meta['duration_day'] ?? '')); ?>" min="1">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_people" name="max_people" value="<?php echo e(old('max_people', $meta['max_people'] ?? '')); ?>" min="1">
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="id_location" name="id_location" value="<?php echo e(old('id_location', $meta['id_location'] ?? '')); ?>">
                                </div>
                                
                                <div class="mb-3">
                                    <label for="location_id" class="form-label">Location ID (alias)</label>
                                    <input type="number" class="form-control" id="location_id" name="location_id" value="<?php echo e(old('location_id', $meta['location_id'] ?? '')); ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="map_lat" name="map_lat" value="<?php echo e(old('map_lat', $meta['map_lat'] ?? '')); ?>" placeholder="Ex: 33.5731">
                                </div>
                                
                                <div class="mb-3">
                                    <label for="map_lng" class="form-label">Longitude</label>
                                    <input type="text" class="form-control" id="map_lng" name="map_lng" value="<?php echo e(old('map_lng', $meta['map_lng'] ?? '')); ?>" placeholder="Ex: -7.5898">
                                </div>
                                
                                <div class="mb-3">
                                    <label for="map_zoom" class="form-label">Zoom carte</label>
                                    <input type="number" class="form-control" id="map_zoom" name="map_zoom" value="<?php echo e(old('map_zoom', $meta['map_zoom'] ?? '14')); ?>" min="1" max="20">
                                </div>
                                
                                <div class="mb-3">
                                    <label for="map_type" class="form-label">Type de carte</label>
                                    <select class="form-select" id="map_type" name="map_type">
                                        <option value="roadmap" <?php echo e(old('map_type', $meta['map_type'] ?? '') === 'roadmap' ? 'selected' : ''); ?>>Roadmap</option>
                                        <option value="satellite" <?php echo e(old('map_type', $meta['map_type'] ?? '') === 'satellite' ? 'selected' : ''); ?>>Satellite</option>
                                        <option value="hybrid" <?php echo e(old('map_type', $meta['map_type'] ?? '') === 'hybrid' ? 'selected' : ''); ?>>Hybrid</option>
                                        <option value="terrain" <?php echo e(old('map_type', $meta['map_type'] ?? '') === 'terrain' ? 'selected' : ''); ?>>Terrain</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="st_google_map" name="st_google_map" rows="4"><?php echo e(old('st_google_map', $meta['st_google_map'] ?? '')); ?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="discount" name="discount" value="<?php echo e(old('discount', $meta['discount'] ?? '')); ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="discount_by_people_type" name="discount_by_people_type" value="<?php echo e(old('discount_by_people_type', $meta['discount_by_people_type'] ?? '')); ?>" placeholder="adult,child,infant">
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="tours_include" name="tours_include" rows="6"><?php echo e(old('tours_include', $meta['tours_include'] ?? '')); ?></textarea>
                            <small class="text-muted">HTML accepté</small>
                        </div>
                        
                        <div class="mb-3">
                            <label for="tours_exclude" class="form-label">Ce qui n'est pas inclus</label>
                            <textarea class="form-control" id="tours_exclude" name="tours_exclude" rows="6"><?php echo e(old('tours_exclude', $meta['tours_exclude'] ?? '')); ?></textarea>
                            <small class="text-muted">HTML accepté</small>
                        </div>
                        
                        <div class="mb-3">
                            <label for="tours_highlight" class="form-label">Points forts</label>
                            <textarea class="form-control" id="tours_highlight" name="tours_highlight" rows="6"><?php echo e(old('tours_highlight', $meta['tours_highlight'] ?? '')); ?></textarea>
                            <small class="text-muted">HTML accepté</small>
                        </div>
                        
                        <div class="mb-3">
                            <label for="tours_faq" class="form-label">FAQ</label>
                            <textarea class="form-control" id="tours_faq" name="tours_faq" rows="6"><?php echo e(old('tours_faq', $meta['tours_faq'] ?? '')); ?></textarea>
                            <small class="text-muted">HTML accepté</small>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tours_booking_period" name="tours_booking_period" value="<?php echo e(old('tours_booking_period', $meta['tours_booking_period'] ?? '')); ?>">
                        </div>
                        
                        <div class="mb-3">
                            <label for="st_booking_option_type" class="form-label">Type d'option de réservation</label>
                            <input type="text" class="form-control" id="st_booking_option_type" name="st_booking_option_type" value="<?php echo e(old('st_booking_option_type', $meta['st_booking_option_type'] ?? '')); ?>">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control" id="check_in" name="check_in" value="<?php echo e(old('check_in', $meta['check_in'] ?? '')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control" id="check_out" name="check_out" value="<?php echo e(old('check_out', $meta['check_out'] ?? '')); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="st_allow_cancel" name="st_allow_cancel" value="1" <?php echo e(old('st_allow_cancel', $meta['st_allow_cancel'] ?? '') === 'on' ? 'checked' : ''); ?>>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="st_cancel_percent" name="st_cancel_percent" value="<?php echo e(old('st_cancel_percent', $meta['st_cancel_percent'] ?? '')); ?>" min="0" max="100">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="st_cancel_number_day" name="st_cancel_number_day" value="<?php echo e(old('st_cancel_number_day', $meta['st_cancel_number_day'] ?? '')); ?>" min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ical_url" name="ical_url" value="<?php echo e(old('ical_url', $meta['ical_url'] ?? '')); ?>" placeholder="https://...">
                            <small class="text-muted">Optionnel</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-footer d-flex justify-content-between align-items-center bg-light">
                        <div>
                            ...
                            <a href="<?php echo e(route('admin.circuits.voyages.index')); ?>" class="btn btn-outline-secondary btn-lg waves-effect">Annuler</a>
                        </div>
...
<?php echo $__env->make('layouts.admin-v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\circuits\voyages\edit-complete.blade.php ENDPATH**/ ?>