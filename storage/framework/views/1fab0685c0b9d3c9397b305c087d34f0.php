...
<?php endif; ?>
    ...
    <form action="<?php echo e(route('admin.economic-offers.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <?php echo $__env->make('admin.economic-offers._form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="d-flex justify-content-end gap-2 mt-4">
            <a href="<?php echo e(route('admin.economic-offers.index')); ?>" class="aj-btn aj-btn-soft">Annuler</a>
