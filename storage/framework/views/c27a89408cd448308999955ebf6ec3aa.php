...
<div class="card mt-4">
    <div class="card-body">
        ...
        <?php if($voyage->programDays->isEmpty()): ?>
        ...
        <?php else: ?>
            <div class="accordion" id="accordionItems">
                <?php $__currentLoopData = $voyage->programDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $programDay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $dayItems = $voyage->dayItems->where('day_number', $programDay->day_number)->sortBy('sort_order');
                    ?>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingDay<?php echo e($programDay->day_number); ?>">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" 
                                data-bs-target="#collapseDay<?php echo e($programDay->day_number); ?>" aria-expanded="false" 
                                aria-controls="collapseDay<?php echo e($programDay->day_number); ?>">
                                <strong>Jour <?php echo e($programDay->day_number); ?> : <?php echo e($programDay->title); ?></strong>
                                <span class="badge bg-soft-primary text-primary ms-2"><?php echo e($dayItems->count()); ?> items</span>
                            </button>
                        </h2>
                        <div id="collapseDay<?php echo e($programDay->day_number); ?>" class="accordion-collapse collapse" 
                            aria-labelledby="headingDay<?php echo e($programDay->day_number); ?>" data-bs-parent="#accordionItems">
                            <div class="accordion-body">
                                
                                <?php if($dayItems->isEmpty()): ?>
                                                ...
                                                <?php $__currentLoopData = $dayItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if($item->details): ?>
                                                                <br><small class="text-muted"><?php echo e(Str::limit($item->details, 60)); ?></small>
                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if($item->isMultiDay()): ?>
                                                                J<?php echo e($item->start_day); ?>-<?php echo e($item->end_day); ?>

                                                                <?php if($item->nights > 0): ?>
                                                                    <small class="text-muted">(<?php echo e($item->nights); ?>n)</small>
                                                                <?php endif; ?>
                                                            <?php else: ?>
                                                                J<?php echo e($item->day_number); ?>
                                                        ...
                                                        <td>
                                                            <?php if($item->price_delta_per_person == 0): ?>
                                                                <span class="text-muted">—</span>
                                                            <?php else: ?>
                                                                <?php echo e($item->formatted_price_delta); ?>

                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-sm btn-soft-primary" 
                                                                onclick="editItem(<?php echo e($item->id); ?>)" title="Modifier">
                                                                <i class="bx bx-edit"></i>
                                                            </button>
                                                            <form action="<?php echo e(route('admin.circuits.voyages.items.destroy', [$voyage, $item])); ?>" 
                                ...
                                <button type="button" class="btn btn-sm btn-soft-success" 
                                    onclick="addItemForDay(<?php echo e($programDay->day_number); ?>)">
...
<?php echo $__env->make('admin.circuits.voyages.partials._item_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    function addItemForDay(dayNumber) {
        // Reset form
        itemForm.reset();
        itemForm.action = "<?php echo e(route('admin.circuits.voyages.items.store', $voyage)); ?>";
    ...
    function editItem(itemId) {
        ...
        fetch(`/admin/circuits/voyages/<?php echo e($voyage->id); ?>/items/${itemId}/edit`)
            .then(response => response.json())
            .then(data => {
                itemForm.action = `/admin/circuits/voyages/<?php echo e($voyage->id); ?>/items/${itemId}`;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\circuits\voyages\partials\_items_section.blade.php ENDPATH**/ ?>