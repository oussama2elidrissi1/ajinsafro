...
<footer class="aj-footer-v2">
    <div class="aj-container">
        <div class="aj-footer-v2__cols" style="position:relative;z-index:10;">
            <?php $__currentLoopData = $footerCols; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
                    <h4 class="aj-footer-v2__heading"><?php echo e($col['heading']); ?></h4>
            ...
            <div>
                ...
                <div class="aj-footer-v2__legal">
                    <?php $__currentLoopData = explode("\n", $legalLines); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p style="margin:0 0 8px;"><?php echo e(trim($line)); ?></p>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
    ...
    <div class="aj-payments-v2">
        ...
        <div class="aj-payments-v2__icons">
            <?php $__currentLoopData = $paymentImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <img src="<?php echo e($pm['url']); ?>" alt="<?php echo e($pm['name']); ?>" style="height:<?php echo e($pm['h']); ?>;" loading="lazy">
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views/partner_v2/partials/footer.blade.php ENDPATH**/ ?>