...
<div class="aj-page-head" style="margin-bottom:18px;">
    ...
    <div style="display:flex;gap:10px;flex-wrap:wrap;">
        <?php if(Route::has('admin.agency-accounts.edit')): ?>
            <a href="<?php echo e(route('admin.agency-accounts.edit', $account)); ?>" class="aj-btn primary">Éditer</a>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin-v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\agency-accounts\show.blade.php ENDPATH**/ ?>