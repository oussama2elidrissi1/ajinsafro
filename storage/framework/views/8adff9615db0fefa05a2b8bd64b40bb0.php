<?php $__env->startSection('title'); ?>
    <?php echo e(isset($trashed) && $trashed ? 'Clients supprimés' : 'Clients'); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <?php if(isset($trashed) && $trashed): ?>
                        ...
                        <a href="<?php echo e(route('admin.customers.clients.index')); ?>" class="aj-btn aj-btn-soft mb-3"><i class="bx bx-list-ul me-1"></i> Retour à la liste</a>
                    <?php endif; ?>
                    ...
                    <form method="GET" class="mb-4">
                        ...
                        <div class="aj-filter-grid" style="grid-template-columns: minmax(200px, 1.4fr) repeat(4, minmax(0, .8fr)) minmax(160px, auto) auto;">
                            <div class="aj-field aj-search-wrap">
                                ...
                                <input type="text" name="search" class="aj-control" placeholder="Code, nom, email, tél..." value="<?php echo e(request('search')); ?>">
                            </div>
                            <?php if(!isset($trashed) || !$trashed): ?>
                                <div class="aj-field">
                                ...
                                <div class="aj-field">
                                    <select name="client_type" class="aj-control">
                                        ...
                                        <option value="company" <?php echo e(request('client_type') === 'company' ? 'selected' : ''); ?>>Société</option>
                                ...
                                <div class="aj-field">
                                    <select name="source" class="aj-control">
                                        ...
                                        <option value="phone" <?php echo e(request('source') === 'phone' ? 'selected' : ''); ?>>Téléphone</option>
...
<?php endif; ?>
                                            ...
                                            <td><?php echo e($c->whatsapp_number ?? '—'); ?></td>
                                            <td><?php echo e($c->nationality ?? '—'); ?></td>
                                            <td><?php echo e($c->city ?? '—'); ?></td>
                                            <td><?php echo e($c->traveler_category ?? '—'); ?></td>
                                            <td><?php echo e($c->budget_display ?? '—'); ?></td>
                                            <td>
                                                <?php
...
<?php endif; ?>
                                            ...
                                            <td><?php echo e($c->assignedTo?->name ?? '—'); ?></td>
                                            <td><?php echo e($c->last_contacted_at?->format('d/m/Y') ?? '—'); ?></td>
                                            ...
                                            <td class="text-end">
                                                <?php if(isset($trashed) && $trashed): ?>
                                                    ...
                                                    <form action="<?php echo e(route('admin.customers.clients.force', $c->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Supprimer définitivement ce client ?');">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin-v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\customers\clients\index.blade.php ENDPATH**/ ?>