...
<div id="day-builder-transfers-manager">
    ...
    <div class="card border-primary mb-3" id="transfers-new-form-wrap" style="display: none;">
        ...
        <div class="card-body">
            ...
            <div id="transfers-new-form-el" data-action="<?php echo e(route('admin.circuits.tour-transfers.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="row g-2">
                    <div class="col-12">
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\circuits\voyages\components\TransfersManager.blade.php ENDPATH**/ ?>