    ...
    <div class="card">
        <div class="card-body">
            <form method="GET" class="row g-3 mb-4">
                <div class="col-md-5">
                    <input type="text" name="search" class="form-control" value="<?php echo e($filters['search']); ?>" placeholder="Nom, dÃ©part, arrivÃ©e, type, ville">
                </div>
                <div class="col-md-3">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($detail->cars_address ?: 'â€”'); ?></td>
                                <td>
                                    <?php echo e($transfer->getMeta('aj_transfer_from') ?: 'â€”'); ?>

                                    â†’
                                    <?php echo e($transfer->getMeta('aj_transfer_to') ?: 'â€”'); ?>

                                </td>
                                <td><?php echo e($transfer->getMeta('aj_transfer_vehicle_type') ?: ($transfer->getMeta('aj_transfer_type') ?: 'â€”')); ?></td>
                                <td>
                                ...
                                <td>
                                    <span class="badge bg-<?php echo e($transfer->post_status === 'publish' ? 'success' : 'secondary'); ?>">
                                        <?php echo e($transfer->post_status === 'publish' ? 'PubliÃ©' : 'Brouillon'); ?>

                                    </span>
                                </td>
                                <td class="text-end">
                                    <a href="<?php echo e(route('admin.wordpress.transfers.edit', $transfer)); ?>" class="btn btn-sm btn-soft-primary">Modifier</a>
                                    <form action="<?php echo e(route('admin.wordpress.transfers.destroy', $transfer)); ?>" method="POST" class="d-inline" onsubmit="return confirm('DÃ©placer ce transfert dans la corbeille ?');">
                                        <?php echo csrf_field(); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="8" class="text-center text-muted py-4">Aucun transfert trouvÃ©.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.admin-v6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\wordpress\transfers\index.blade.php ENDPATH**/ ?>