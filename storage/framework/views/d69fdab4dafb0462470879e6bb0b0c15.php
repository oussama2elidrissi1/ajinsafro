    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">Tabs & Accordions</h4>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Use the tab JavaScript plugin—include it individually or through the compiled
                        <code class="highlighter-rouge">bootstrap.js</code> file—to extend our navigational tabs and pills
                        to create tabbable panes of local content, even via dropdown menus.
                    </p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc mb-3">
                        ...
                        attribute, or a button with the <code class="highlighter-rouge">data-bs-target</code> attribute. In
                        both cases,
                        the
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Omit the <code>data-bs-parent</code> attribute on each
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\ui-tabs-accordions.blade.php ENDPATH**/ ?>