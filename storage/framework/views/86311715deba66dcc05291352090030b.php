...
<div class="fixed top-0 left-0 right-0 z-50">
    ...
    <?php if($topbarPhone || $topbarEmail || $socialFacebook || $socialTwitter || $socialInstagram || $socialYoutube): ?>
    <div class="bg-topbar text-white py-2">
        <div class="container mx-auto px-4 flex flex-wrap items-center justify-between gap-2 text-sm">
            <div class="flex flex-wrap items-center gap-4 md:gap-6">
                <?php if($topbarPhone): ?>
                <a href="tel:<?php echo e(preg_replace('/\s+/', '', $topbarPhone)); ?>" class="flex items-center gap-1.5 hover:text-gray-200">
                    ...
                    <span><?php echo e($topbarPhone); ?></span>
                </a>
                <?php endif; ?>
                <?php if($topbarEmail): ?>
                <a href="mailto:<?php echo e($topbarEmail); ?>" class="flex items-center gap-1.5 hover:text-gray-200">
    ...
    <header class="bg-white/90 backdrop-blur-sm border-b border-gray-200/50">
        <div class="container mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-4">
            ...
            <a href="<?php echo e($homeUrl); ?>" class="flex items-center gap-2 shrink-0 min-h-[2.5rem] md:min-h-[2.75rem]">
                <?php if($brandLogoUrl): ?>
                    <img src="<?php echo e($brandLogoUrl); ?>" alt="<?php echo e($brandName); ?>" class="h-8 w-auto max-w-[100px] sm:h-9 sm:max-w-[120px] md:h-10 md:max-w-[160px] object-contain object-left">
                <?php else: ?>
            ...
            <nav id="front-nav" class="hidden lg:flex flex-col lg:flex-row items-center gap-1 w-full lg:w-auto order-last lg:order-none py-4 lg:py-0 border-t lg:border-t-0 border-gray-200" aria-label="Main">
                <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $isActive = request()->is($item['match']); ?>
                    <a href="<?php echo e($item['url']); ?>" class="px-3 py-2 rounded-md font-medium transition <?php echo e($isActive ? 'bg-brand/10 text-brand' : 'text-gray-700 hover:bg-gray-100'); ?>"><?php echo e($item['label']); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </nav>

            <?php if($lowCostEnabled): ?>
                <div class="flex items-center gap-2 md:gap-4">
                    <a href="<?php echo e($lowCostUrl !== '' ? $lowCostUrl : '#'); ?>" class="inline-flex items-center px-4 py-2 rounded-lg bg-brand text-white font-medium hover:bg-brand-dark transition"><?php echo e($lowCostText !== '' ? $lowCostText : 'Formule Low Cost'); ?></a>
                </div>
            <?php endif; ?>
        </div>
    </header>
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\components\front\navbar.blade.php ENDPATH**/ ?>