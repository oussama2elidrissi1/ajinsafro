...
<?php $__env->startSection('title'); ?>
    <?php echo e($isCreate ? 'Creer un tour WordPress' : 'Modifier le tour WordPress'); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startPush('styles'); ?>
    <link href="<?php echo e(URL::asset('css/voyage-edit.css?v=' . $voyageEditCssVersion)); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(URL::asset('css/flight-options-new.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopPush(); ?>

<?php $__env->startPush('styles'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/voyage-edit-fix.css')); ?>?v=<?php echo e(filemtime(public_path('css/voyage-edit-fix.css'))); ?>">
<?php $__env->stopPush(); ?>
...
<div class="voyage-edit-page voyage-workflow-page">
    ...
    <div class="ve-shell">
        <?php echo $__env->make('admin.circuits.voyages.partials._voyage_form_alerts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    ...
    <form action="<?php echo e($isCreate ? route('admin.circuits.voyages.store') : route('admin.circuits.voyages.update', $voyage->ID)); ?>" method="POST" id="edit-voyage-form" data-voyage-id="<?php echo e($voyage->ID ?? 0); ?>" novalidate>
        <?php echo csrf_field(); ?>
        <?php if(!$isCreate): ?>
                    ...
                    <div class="ve-editor-frame">
                        <div class="ve-editor-body">
                            <div class="tab-content ve-tab-content pt-4">
                                ...
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._location', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._pricing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._information', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._extras', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._availability', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._media', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._taxonomies', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._logistics', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._hotels', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._transfers', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._activities', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php echo $__env->make('admin.circuits.voyages.partials.tabs._programme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
    ...
    <?php if(!$isCreate && $laravelV): ?>
        <?php echo $__env->make('admin.circuits.voyages.partials.room_availability.modal', [
            'voyage' => $laravelV,
            'wpTourPostId' => $veWpId,
    ...
    <?php if(!$isCreate): ?>
        <form id="delete-voyage-form" action="<?php echo e(route('admin.circuits.voyages.destroy', $voyage->ID)); ?>" method="POST" class="d-none">
            <?php echo csrf_field(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(URL::asset('js/voyage-edit-page.js?v=' . $voyageEditJsVersion)); ?>"></script>
