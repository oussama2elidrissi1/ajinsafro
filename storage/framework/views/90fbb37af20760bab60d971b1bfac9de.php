            ...
            <div class="reservation-create__grid reservation-create__grid--two">
                ...
                <div class="reservation-create__field">
                    ...
                    <select name="client_traveler_type" id="client_traveler_type" class="reservation-create__input">
                        ...
                        <option value="infant" <?php echo e(old('client_traveler_type') === 'infant' ? 'selected' : ''); ?>>Bebe</option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <?php $__currentLoopData = $oldPassengers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $passenger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="companion-row reservation-create__companion" data-companion-id="<?php echo e($companionKey); ?>" data-traveler-key="<?php echo e($companionKey); ?>">
                    ...
                    <div class="reservation-create__grid reservation-create__grid--two">
                        ...
                        <div class="reservation-create__field"><label class="reservation-create__label">Prenom</label><input type="text" name="passengers[<?php echo e($companionKey); ?>][first_name]" class="reservation-create__input" value="<?php echo e($passenger['first_name'] ?? ''); ?>"></div>
                        <div class="reservation-create__field"><label class="reservation-create__label">Nom</label><input type="text" name="passengers[<?php echo e($companionKey); ?>][last_name]" class="reservation-create__input" value="<?php echo e($passenger['last_name'] ?? ''); ?>"></div>
                        <div class="reservation-create__field"><label class="reservation-create__label">Type voyageur</label><select name="passengers[<?php echo e($companionKey); ?>][type]" class="reservation-create__input"><option value="adult" <?php echo e(($passenger['type'] ?? '') === 'adult' ? 'selected' : ''); ?>>Adulte</option><option value="child" <?php echo e(($passenger['type'] ?? '') === 'child' ? 'selected' : ''); ?>>Enfant</option><option value="infant" <?php echo e(($passenger['type'] ?? '') === 'infant' ? 'selected' : ''); ?>>Bebe</option></select></div>
                        <div class="reservation-create__field"><label class="reservation-create__label">Sexe</label><select name="passengers[<?php echo e($companionKey); ?>][gender]" class="reservation-create__input"><option value="">Selectionner...</option><option value="male" <?php echo e(($passenger['gender'] ?? '') === 'male' ? 'selected' : ''); ?>>Homme</option><option value="female" <?php echo e(($passenger['gender'] ?? '') === 'female' ? 'selected' : ''); ?>>Femme</option></select></div>
                        ...
                        <div class="reservation-create__field"><label class="reservation-create__label">No document</label><input type="text" name="passengers[<?php echo e($companionKey); ?>][document_number]" class="reservation-create__input" value="<?php echo e($passenger['document_number'] ?? ''); ?>"></div>
                    </div>
                </div>
