<section class="reservation-create__panel" data-create-step="6" data-reservation-step="6" hidden>
            ...
            <div class="reservation-create__payment-card">
                ...
                <div class="reservation-create__visa-card">
                    ...
                    <label class="reservation-create__toggle">
                        <input class="form-check-input" type="checkbox" name="visa_ok" id="visa_ok" value="1" <?php echo e(old('visa_ok', true) ? 'checked' : ''); ?>>
                        <span>Visa OK, pas d'assistance nécessaire</span>
                    </label>

                    <div id="assistant-visa-block" class="<?php echo e(old('visa_ok', true) ? 'd-none' : ''); ?>">
                        <div class="reservation-create__grid reservation-create__grid--two">
                            ...
                            <div class="reservation-create__field reservation-create__field--full">
                                ...
                                <textarea name="visa_notes" id="visa_notes" class="reservation-create__input reservation-create__input--textarea" rows="4" placeholder="Suivi visa, pièces manquantes, remarques internes..."><?php echo e(old('visa_notes')); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="reservation-create__actions reservation-create__actions--final">
        ...
        <div class="reservation-create__submit-group">
            <a href="<?php echo e(route('admin.reservations.workspace')); ?>" class="reservation-create__button reservation-create__button--ghost">Annuler</a>
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\reservations\create\partials\step-dossier.blade.php ENDPATH**/ ?>