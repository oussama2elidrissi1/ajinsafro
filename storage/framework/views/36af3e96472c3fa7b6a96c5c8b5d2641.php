        ...
        <?php if(! $legacyEdit): ?>
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="reservation-base-price" name="base_price" class="form-control" value="<?php echo e($initialBasePrice); ?>" min="0" step="0.01" placeholder="0.00" readonly>
                </div>
                <div class="col-md-8">
