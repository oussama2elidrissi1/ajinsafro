...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('admin.partner-commission-rules.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="type" class="form-select" required>
                            <option value="percent" <?php echo e(old('type', 'percent') === 'percent' ? 'selected' : ''); ?>>Pourcentage</option>
                            <option value="fixed" <?php echo e(old('type') === 'fixed' ? 'selected' : ''); ?>>Montant fixe (DH)</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Valeur <span class="text-danger">*</span></label>
                        <input type="number" name="value" class="form-control" step="0.01" min="0" value="<?php echo e(old('value')); ?>" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Volume min. (optionnel)</label>
                        <input type="number" name="min_volume" class="form-control" min="0" value="<?php echo e(old('min_volume')); ?>" placeholder="Nb ventes">
                    </div>
                    <div class="col-md-4">
