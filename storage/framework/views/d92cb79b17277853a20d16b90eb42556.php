    ...
    <div class="aj-container aj-topbar__inner">
        <div class="aj-topbar__left">
            <div class="aj-topbar__socials">
                <a href="<?php echo e($instagramUrl !== '' ? $instagramUrl : '#'); ?>" class="aj-topbar__social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <div class="aj-topbar__contact">
                <span class="aj-topbar__item"><?php echo e(data_get($headerData, 'email')); ?></span>
                <span class="aj-topbar__item"><?php echo e(data_get($headerData, 'phone')); ?></span>
            </div>
        </div>
        ...
        <div class="aj-topbar__right">
            <div class="aj-topbar__auth">
                <?php if($user): ?>
                    <?php if($profileUrl): ?>
                        <a href="<?php echo e($profileUrl); ?>" class="aj-topbar__auth-link">Profil</a>
                    <?php endif; ?>

                    <?php if($usesPartnerLogout): ?>
                    ...
                    <?php elseif(\Illuminate\Support\Facades\Route::has('logout.get')): ?>
                        <a href="<?php echo e(route('logout.get')); ?>" class="aj-topbar__auth-link aj-topbar__auth-link--signup">D&eacute;connexion</a>
                    <?php endif; ?>
                <?php else: ?>
                    <a href="<?php echo e(data_get($headerData, 'login_url')); ?>" class="aj-topbar__auth-link">SE CONNECTER</a>
                    <a href="<?php echo e(data_get($headerData, 'signup_url')); ?>" class="aj-topbar__auth-link aj-topbar__auth-link--signup">S&rsquo;INSCRIRE</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\layouts\partials\internal-v2-topbar.blade.php ENDPATH**/ ?>