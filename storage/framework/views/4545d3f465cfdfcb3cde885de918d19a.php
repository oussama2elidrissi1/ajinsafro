            ...
            <div class="email-leftbar card">
                ...
                <div class="mt-2">
                    <a href="#" class="d-flex align-items-start">
                        <img class="d-flex me-3 rounded-circle" src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>"
                    ...
                    <a href="#" class="d-flex align-items-start">
                        <img class="d-flex me-3 rounded-circle" src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>"
                            alt="Generic placeholder image" height="36">
                        <div class="flex-1 chat-user-box">
                    ...
                    <a href="#" class="d-flex align-items-start">
                        <img class="d-flex me-3 rounded-circle" src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>"
                            alt="Generic placeholder image" height="36">
                        <div class="flex-1 chat-user-box">
                    ...
                    <a href="#" class="d-flex align-items-start">
                        <img class="d-flex me-3 rounded-circle" src="<?php echo e(URL::asset('build/images/users/avatar-6.jpg')); ?>"
                            alt="Generic placeholder image" height="36">
                        <div class="flex-1 chat-user-box">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-4 d-flex align-items-start">
                            <img class="d-flex me-3 rounded-circle avatar-sm" src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>"
                        ...
                        <div class="row">
                            <div class="col-xl-2 col-6">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>"
                                        alt="Card image cap">
                            ...
                            <div class="col-xl-2 col-6">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>"
                                        alt="Card image cap">
                                    <div class="py-2 text-center">
                                        <a href="" class="fw-medium">Download</a>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\email-read.blade.php ENDPATH**/ ?>