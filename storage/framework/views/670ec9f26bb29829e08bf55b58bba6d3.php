            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if($airlines->isEmpty()): ?>
                        <p class="text-muted mb-0">Aucune compagnie. <a href="<?php echo e(route('admin.circuits.airlines.create')); ?>">Créer une compagnie</a> pour l�?Tutiliser dans les vols des voyages.</p>
                    <?php else: ?>
