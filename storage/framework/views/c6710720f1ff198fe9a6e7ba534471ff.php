<?php $__env->startSection('title', 'Messagerie interne'); ?>
...
<script>
    (function () {
        const channelsUrl = <?php echo json_encode(route('partner.messages.channels'), 15, 512) ?>;
        const createDirectUrl = <?php echo json_encode(route('partner.messages.direct'), 15, 512) ?>;
        const channelMessagesUrlTpl = <?php echo json_encode(route('partner.messages.channel.messages', ['channel' => '__CHANNEL__']), 512) ?>;
        const channelSendUrlTpl = <?php echo json_encode(route('partner.messages.channel.send', ['channel' => '__CHANNEL__']), 512) ?>;
...
<?php echo $__env->make('partner_v2.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\partner\v2\messages\index.blade.php ENDPATH**/ ?>