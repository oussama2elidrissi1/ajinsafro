                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="page-title mb-0 font-size-18">Material Design</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc mb-2">Use
                                    <code>&lt;i class="mdi mdi-golf-cart"&gt;&lt;/i&gt;</code> <span
                                        class="badge bg-success font-size-12">v 4.6.95</span>.
                                </p>
                                <div class="row icon-demo-content">
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-api-off"></i> mdi mdi-api-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-lightbulb-multiple-outline"></i> mdi
                                        mdi-lightbulb-multiple-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-lightbulb-multiple"></i> mdi mdi-lightbulb-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-lightbulb-group-outline"></i> mdi
                                        mdi-lightbulb-group-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-lightbulb-group"></i> mdi mdi-lightbulb-group
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-home-lightbulb-outline"></i> mdi
                                        mdi-home-lightbulb-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-home-lightbulb"></i> mdi mdi-home-lightbulb
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-edge-legacy"></i> mdi mdi-edge-legacy
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-shield-edit"></i> mdi mdi-shield-edit
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-shield-edit-outline"></i> mdi mdi-shield-edit-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-shield-refresh"></i> mdi mdi-shield-refresh
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-shield-refresh-outline"></i> mdi
                                        mdi-shield-refresh-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-golf-cart"></i> mdi mdi-golf-cart
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-phone-off-outline"></i> mdi mdi-phone-off-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-phone-missed-outline"></i> mdi mdi-phone-missed-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-quote-open-outline"></i> mdi
                                        mdi-format-quote-open-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-quote-close-outline"></i> mdi
                                        mdi-format-quote-close-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-phone-check"></i> mdi mdi-phone-check
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-phone-check-outline"></i> mdi mdi-phone-check-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-toaster-off"></i> mdi mdi-toaster-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-audio-video-off"></i> mdi mdi-audio-video-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-amplifier-off"></i> mdi mdi-amplifier-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-phone-ring"></i> mdi mdi-phone-ring
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-phone-ring-outline"></i> mdi mdi-phone-ring-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-share-circle"></i> mdi mdi-share-circle
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-reply-circle"></i> mdi mdi-reply-circle
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-fridge-off"></i> mdi mdi-fridge-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-fridge-off-outline"></i> mdi mdi-fridge-off-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-fridge-alert"></i> mdi mdi-fridge-alert
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-fridge-alert-outline"></i> mdi mdi-fridge-alert-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-water-boiler-alert"></i> mdi mdi-water-boiler-alert
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-water-boiler-off"></i> mdi mdi-water-boiler-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-washing-machine-alert"></i> mdi mdi-washing-machine-alert
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-dishwasher-off"></i> mdi mdi-dishwasher-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-tumble-dryer-off"></i> mdi mdi-tumble-dryer-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-washing-machine-off"></i> mdi mdi-washing-machine-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-comment-edit"></i> mdi mdi-comment-edit
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-printer-3d-nozzle-alert"></i> mdi
                                        mdi-printer-3d-nozzle-alert
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-printer-3d-nozzle-alert-outline"></i> mdi
                                        mdi-printer-3d-nozzle-alert-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-align-horizontal-center"></i> mdi
                                        mdi-align-horizontal-center
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-align-horizontal-left"></i> mdi mdi-align-horizontal-left
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-align-horizontal-right"></i> mdi
                                        mdi-align-horizontal-right
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-align-vertical-bottom"></i> mdi mdi-align-vertical-bottom
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-align-vertical-center"></i> mdi mdi-align-vertical-center
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-align-vertical-top"></i> mdi mdi-align-vertical-top
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-distribute-horizontal-center"></i> mdi
                                        mdi-distribute-horizontal-center
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-distribute-horizontal-left"></i> mdi
                                        mdi-distribute-horizontal-left
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-distribute-horizontal-right"></i> mdi
                                        mdi-distribute-horizontal-right
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-distribute-vertical-bottom"></i> mdi
                                        mdi-distribute-vertical-bottom
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-distribute-vertical-center"></i> mdi
                                        mdi-distribute-vertical-center
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-distribute-vertical-top"></i> mdi
                                        mdi-distribute-vertical-top
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-car-info"></i> mdi mdi-car-info
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-crown-outline"></i> mdi mdi-crown-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-shopping-outline"></i> mdi mdi-shopping-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-strategy"></i> mdi mdi-strategy
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alert-rhombus"></i> mdi mdi-alert-rhombus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alert-rhombus-outline"></i> mdi mdi-alert-rhombus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-rv-truck"></i> mdi mdi-rv-truck
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-image-off-outline"></i> mdi mdi-image-off-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-movie-search"></i> mdi mdi-movie-search
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-movie-search-outline"></i> mdi mdi-movie-search-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-view-agenda-outline"></i> mdi mdi-view-agenda-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-view-grid-outline"></i> mdi mdi-view-grid-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-view-grid-plus-outline"></i> mdi
                                        mdi-view-grid-plus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-note-text-outline"></i> mdi mdi-note-text-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-window-open-variant"></i> mdi mdi-window-open-variant
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-window-closed-variant"></i> mdi mdi-window-closed-variant
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-cog-clockwise"></i> mdi mdi-cog-clockwise
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-cog-counterclockwise"></i> mdi mdi-cog-counterclockwise
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chart-snakey"></i> mdi mdi-chart-snakey
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chart-snakey-variant"></i> mdi mdi-chart-snakey-variant
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-vanity-light"></i> mdi mdi-vanity-light
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-router"></i> mdi mdi-router
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-image-edit"></i> mdi mdi-image-edit
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-image-edit-outline"></i> mdi mdi-image-edit-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-edit-outline"></i> mdi mdi-file-edit-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-edit"></i> mdi mdi-file-edit
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-bell-check"></i> mdi mdi-bell-check
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-bell-check-outline"></i> mdi mdi-bell-check-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-spider-thread"></i> mdi mdi-spider-thread
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-spider"></i> mdi mdi-spider
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-scooter"></i> mdi mdi-scooter
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-plus-thick"></i> mdi mdi-plus-thick
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alert-circle-check"></i> mdi mdi-alert-circle-check
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alert-circle-check-outline"></i> mdi
                                        mdi-alert-circle-check-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-state-machine"></i> mdi mdi-state-machine
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-usb-port"></i> mdi mdi-usb-port
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-cloud-lock"></i> mdi mdi-cloud-lock
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-cloud-lock-outline"></i> mdi mdi-cloud-lock-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-robot-mower-outline"></i> mdi mdi-robot-mower-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-share-all"></i> mdi mdi-share-all
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-share-all-outline"></i> mdi mdi-share-all-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-google-cloud"></i> mdi mdi-google-cloud
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-robot-mower"></i> mdi mdi-robot-mower
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-rewind-5"></i> mdi mdi-rewind-5
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-fast-forward-5"></i> mdi mdi-fast-forward-5
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-shape-oval-plus"></i> mdi mdi-shape-oval-plus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-timeline-clock"></i> mdi mdi-timeline-clock
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-timeline-clock-outline"></i> mdi
                                        mdi-timeline-clock-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-multiple-check-outline"></i> mdi
                                        mdi-account-multiple-check-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-multiple-remove"></i> mdi
                                        mdi-account-multiple-remove
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-multiple-remove-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-lightbulb-cfl"></i> mdi mdi-lightbulb-cfl
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-lightbulb-cfl-off"></i> mdi mdi-lightbulb-cfl-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-card-plus"></i> mdi mdi-card-plus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-card-plus-outline"></i> mdi mdi-card-plus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-layers-search"></i> mdi mdi-layers-search
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-layers-search-outline"></i> mdi mdi-layers-search-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-selection-search"></i> mdi mdi-selection-search
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-select-search"></i> mdi mdi-select-search
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-magnify-remove-cursor"></i> mdi mdi-magnify-remove-cursor
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-offer"></i> mdi mdi-offer
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-magnify-remove-outline"></i> mdi
                                        mdi-magnify-remove-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-checkerboard-plus"></i> mdi mdi-checkerboard-plus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-checkerboard-minus"></i> mdi mdi-checkerboard-minus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-checkerboard-remove"></i> mdi mdi-checkerboard-remove
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-handshake"></i> mdi mdi-handshake
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-radio-off"></i> mdi mdi-radio-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-language-fortran"></i> mdi mdi-language-fortran
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-archive-outline"></i> mdi mdi-archive-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-kotlin"></i> mdi mdi-kotlin
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-lol"></i> mdi mdi-emoticon-lol
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-lol-outline"></i> mdi mdi-emoticon-lol-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-tag-text"></i> mdi mdi-tag-text
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-tag-minus-outline"></i> mdi mdi-tag-minus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-tag-plus-outline"></i> mdi mdi-tag-plus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-tag-remove-outline"></i> mdi mdi-tag-remove-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-tag-outline"></i> mdi mdi-tag-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-tag-off-outline"></i> mdi mdi-tag-off-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-tag-off"></i> mdi mdi-tag-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-battery-heart"></i> mdi mdi-battery-heart
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-battery-heart-outline"></i> mdi mdi-battery-heart-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-battery-heart-variant"></i> mdi mdi-battery-heart-variant
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-sync"></i> mdi mdi-file-sync
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-sync-outline"></i> mdi mdi-file-sync-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-bus-marker"></i> mdi mdi-bus-marker
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chart-multiple"></i> mdi mdi-chart-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-vector-polyline-plus"></i> mdi mdi-vector-polyline-plus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-vector-polyline-minus"></i> mdi mdi-vector-polyline-minus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-vector-polyline-edit"></i> mdi mdi-vector-polyline-edit
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-vector-polyline-remove"></i> mdi
                                        mdi-vector-polyline-remove
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-table-headers-eye"></i> mdi mdi-table-headers-eye
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-table-headers-eye-off"></i> mdi mdi-table-headers-eye-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-bicycle-basket"></i> mdi mdi-bicycle-basket
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-question"></i> mdi mdi-beaker-question
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-question-outline"></i> mdi
                                        mdi-beaker-question-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-alert"></i> mdi mdi-beaker-alert
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-alert-outline"></i> mdi mdi-beaker-alert-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-plus"></i> mdi mdi-beaker-plus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-plus-outline"></i> mdi mdi-beaker-plus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-minus"></i> mdi mdi-beaker-minus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-minus-outline"></i> mdi mdi-beaker-minus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-remove"></i> mdi mdi-beaker-remove
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-remove-outline"></i> mdi mdi-beaker-remove-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-check"></i> mdi mdi-beaker-check
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-beaker-check-outline"></i> mdi mdi-beaker-check-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-minus"></i> mdi mdi-flask-minus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-minus-outline"></i> mdi mdi-flask-minus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-plus"></i> mdi mdi-flask-plus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-plus-outline"></i> mdi mdi-flask-plus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-remove"></i> mdi mdi-flask-remove
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-remove-outline"></i> mdi mdi-flask-remove-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-empty-minus"></i> mdi mdi-flask-empty-minus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-empty-minus-outline"></i> mdi
                                        mdi-flask-empty-minus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-empty-plus"></i> mdi mdi-flask-empty-plus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-empty-plus-outline"></i> mdi
                                        mdi-flask-empty-plus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-empty-remove"></i> mdi mdi-flask-empty-remove
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-empty-remove-outline"></i> mdi
                                        mdi-flask-empty-remove-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-digital-ocean"></i> mdi mdi-digital-ocean
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-webrtc"></i> mdi mdi-webrtc
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-seat-passenger"></i> mdi mdi-seat-passenger
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-folder-move-outline"></i> mdi mdi-folder-move-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-home-remove"></i> mdi mdi-home-remove
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-exclamation-thick"></i> mdi mdi-exclamation-thick
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-web-clock"></i> mdi mdi-web-clock
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-barcode-off"></i> mdi mdi-barcode-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-desk"></i> mdi mdi-desk
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-gold"></i> mdi mdi-gold
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-round-bottom-empty"></i> mdi
                                        mdi-flask-round-bottom-empty
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-round-bottom-empty-outline"></i> mdi
                                        mdi-flask-round-bottom-empty-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-round-bottom-outline"></i> mdi
                                        mdi-flask-round-bottom-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-flask-round-bottom"></i> mdi mdi-flask-round-bottom
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-certificate-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-message-text-clock-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-message-processing-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-message-settings-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-message-text-lock-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-sort-alphabetical-descending"></i> mdi
                                        mdi-sort-alphabetical-descending
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-sort-alphabetical-ascending"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-minus-box-multiple-outline"></i> mdi
                                        mdi-minus-box-multiple-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-plus-box-multiple-outline"></i> mdi
                                        mdi-plus-box-multiple-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-pencil-box-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-gender-male-female-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-bottle-tonic-skull-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-bottle-tonic-plus-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-supervisor-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-cursor-default-gesture-outline"></i> mdi
                                        mdi-cursor-default-gesture-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-cursor-default-gesture"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-flow-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-list-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-hexagon-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-settings-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-iframe-variable-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-iframe-parentheses-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-briefcase-clock-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-electric-switch-closed"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-folder-download-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-confused-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-battery-alert-variant-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-table-box-multiple-outline"></i> mdi
                                        mdi-file-table-box-multiple-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-table-box-multiple"></i> mdi
                                        mdi-file-table-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-table-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-horizontal-rotate-clockwise"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-decimal-comma-decrease"></i> mdi
                                        mdi-decimal-comma-decrease
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-decimal-comma-increase"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-folder-information-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-smart-card-reader-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-book-information-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-calendar-blank-multiple"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-settings-variant-outline"></i> mdi
                                        mdi-file-settings-variant-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-folder-settings-variant"></i> mdi
                                        mdi-folder-settings-variant
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-folder-settings-variant-outline"></i> mdi
                                        mdi-folder-settings-variant-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-folder-settings-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-list-bulleted-triangle"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-settings-transfer-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alphabetical-variant-off"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-car-windshield-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-box-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-powerpoint-box-outline"></i> mdi
                                        mdi-file-powerpoint-box-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-excel-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-powerpoint-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-content-save-alert-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-home-thermometer-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-focus-field-horizontal"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-frown-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-page-layout-header-footer"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-content-save-edit-outline"></i> mdi
                                        mdi-content-save-edit-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-content-save-all-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-note-off-outline"></i> mdi
                                        mdi-music-note-off-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-accidental-sharp"></i> mdi
                                        mdi-music-accidental-sharp
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-accidental-double-sharp"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-accidental-double-flat"></i> mdi
                                        mdi-music-accidental-double-flat
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-accidental-natural"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-note-whole-dotted"></i> mdi
                                        mdi-music-note-whole-dotted
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-note-sixteenth-dotted"></i> mdi
                                        mdi-music-note-sixteenth-dotted
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-note-quarter-dotted"></i> mdi
                                        mdi-music-note-quarter-dotted
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-note-half-dotted"></i> mdi
                                        mdi-music-note-half-dotted
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-music-note-eighth-dotted"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-swap-horizontal-circle"></i> mdi
                                        mdi-swap-horizontal-circle
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-swap-horizontal-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-swap-vertical-circle-outline"></i> mdi
                                        mdi-swap-vertical-circle-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-text-rotation-vertical"></i> mdi
                                        mdi-format-text-rotation-vertical
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-text-rotation-up"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-text-rotation-angle-up"></i> mdi
                                        mdi-format-text-rotation-angle-up
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-text-rotation-angle-down"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-newspaper-variant-multiple"></i> mdi
                                        mdi-newspaper-variant-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-newspaper-variant-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chart-bell-curve-cumulative"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-approximately-equal-box"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-lock-open-variant-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-letter-starts-with"></i> mdi
                                        mdi-format-letter-starts-with
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-letter-ends-with"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-folder-account-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-minus-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-remove-outline"></i> mdi
                                        mdi-credit-card-remove-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-expansion-card-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-timeline-alert-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-10-box-multiple"></i> mdi
                                        mdi-numeric-10-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-10-box-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-10-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-multiple-outline"></i> mdi
                                        mdi-credit-card-multiple-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-off-outline"></i> mdi
                                        mdi-credit-card-off-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-plus-outline"></i> mdi
                                        mdi-credit-card-plus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-refund-outline"></i> mdi
                                        mdi-credit-card-refund-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-scan-outline"></i> mdi
                                        mdi-credit-card-scan-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-settings-outline"></i> mdi
                                        mdi-credit-card-settings-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-marker-outline"></i> mdi
                                        mdi-credit-card-marker-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-wireless-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-search"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-plus-outline"></i> mdi
                                        mdi-file-document-box-plus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-plus"></i> mdi
                                        mdi-file-document-box-plus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-minus"></i> mdi
                                        mdi-file-document-box-minus
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-minus-outline"></i> mdi
                                        mdi-file-document-box-minus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-remove "></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chart-timeline-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-boom-gate-alert-outline"></i> mdi
                                        mdi-boom-gate-alert-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-boom-gate-down-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-multiple-plus-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-check"></i> mdi
                                        mdi-file-document-box-check
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-check-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-gamepad-variant-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-calendar-repeat-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-delimited-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-video-wireless-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-backspace-reverse-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-gamepad-square-outline"></i> mdi
                                        mdi-gamepad-square-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chart-areaspline-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-frequently-asked-questions"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-top-right-bottom-left"></i> mdi
                                        mdi-arrow-top-right-bottom-left
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-top-left-bottom-right"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-map-marker-question-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-map-marker-remove-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-email-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-email-open-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-map-marker-alert-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-credit-card-clock-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-human-male-height-variant"></i> mdi
                                        mdi-human-male-height-variant
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-0-box-multiple"></i> mdi
                                        mdi-numeric-0-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-1-box-multiple"></i> mdi
                                        mdi-numeric-1-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-2-box-multiple"></i> mdi
                                        mdi-numeric-2-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-3-box-multiple"></i> mdi
                                        mdi-numeric-3-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-4-box-multiple"></i> mdi
                                        mdi-numeric-4-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-5-box-multiple"></i> mdi
                                        mdi-numeric-5-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-6-box-multiple"></i> mdi
                                        mdi-numeric-6-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-7-box-multiple"></i> mdi
                                        mdi-numeric-7-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-8-box-multiple"></i> mdi
                                        mdi-numeric-8-box-multiple
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-9-box-multiple"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-calendar-account-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-weather-night-partly-cloudy"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-weather-partly-snowy-rainy"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-weather-partly-lightning"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-stretch-to-page-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-calendar-weekend-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-selection-ellipse-arrow-inside"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-badge-horizontal"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-check-underline-circle"></i> mdi
                                        mdi-check-underline-circle
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-check-underline-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-calendar-month-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-gamepad-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-picture-in-picture-bottom-right"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-picture-in-picture-top-right"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-bookmark-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-signal-distance-variant"></i> mdi
                                        mdi-signal-distance-variant
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-weather-cloudy-arrow-right"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-bag-personal-off-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-content-save-move-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-color-highlight"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-printer-3d-nozzle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-camera-wireless-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-badge-alert-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-screw-machine-round-top"></i> mdi
                                        mdi-screw-machine-round-top
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-screw-machine-flat-top"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-thermometer-chevron-up"></i> mdi
                                        mdi-thermometer-chevron-up
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-thermometer-chevron-down"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-edit-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-card-details-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-diving-scuba-tank-multiple"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-closed-caption-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-list-bulleted-square"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-sort-variant-lock-open"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-tongue-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-angry-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-source-repository-multiple"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-account-outline"></i> mdi
                                        mdi-clipboard-account-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-arrow-down-outline"></i> mdi
                                        mdi-clipboard-arrow-down-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-arrow-up-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-close-box-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-briefcase-search-outline"></i> mdi
                                        mdi-briefcase-search-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-briefcase-download-outline"></i> mdi
                                        mdi-briefcase-download-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-briefcase-upload-outline"></i> mdi
                                        mdi-briefcase-upload-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-briefcase-edit-outline"></i> mdi
                                        mdi-briefcase-edit-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-briefcase-remove-outline"></i> mdi
                                        mdi-briefcase-remove-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-briefcase-plus-outline"></i> mdi
                                        mdi-briefcase-plus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-briefcase-minus-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-image-size-select-small"></i> mdi
                                        mdi-image-size-select-small
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-image-size-select-large"></i> mdi
                                        mdi-image-size-select-large
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-image-size-select-actual"></i> mdi
                                        mdi-image-size-select-actual
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-9-plus-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-9-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-8-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-7-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-6-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-5-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-4-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-3-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-2-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-1-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-numeric-0-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-z-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-y-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-x-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-w-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-v-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-u-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-t-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-s-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-r-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-q-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-p-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-o-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-n-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-m-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-l-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-k-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-j-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-i-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-h-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-g-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-f-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-e-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-d-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-c-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-b-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-alpha-a-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-check-box-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-basketball-hoop-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-ballot-recount-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-shield-airplane-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-network-outline"></i> mdi
                                        mdi-account-network-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-upload-network-outline"></i> mdi
                                        mdi-upload-network-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-access-point-network-off"></i> mdi
                                        mdi-access-point-network-off
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-console-network-outline"></i> mdi
                                        mdi-console-network-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-download-network-outline"></i> mdi
                                        mdi-download-network-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-folder-key-network-outline"></i> mdi
                                        mdi-folder-key-network-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-folder-network-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-play-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-text-play-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-multiple-minus-outline"></i> mdi
                                        mdi-account-multiple-minus-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-playlist-music-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-calendar-check-outline"></i> mdi
                                        mdi-calendar-check-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-calendar-remove-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-inbox-multiple-outline"></i> mdi
                                        mdi-inbox-multiple-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-cloud-download-outline"></i> mdi
                                        mdi-cloud-download-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-arrow-right-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-multiple-check"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-remove-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-search-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-account-supervisor-circle"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-animation-play-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-bottom-left-bold-outline"></i> mdi
                                        mdi-arrow-bottom-left-bold-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-bottom-left-thick"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-bottom-right-bold-outline"></i> mdi
                                        mdi-arrow-bottom-right-bold-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-bottom-right-thick"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-collapse-horizontal"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-collapse-vertical"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-decision-auto-outline"></i> mdi
                                        mdi-arrow-decision-auto-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-decision-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-down-bold-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-down-bold-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-expand-horizontal"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-left-bold-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-left-bold-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-left-right-bold-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-right-bold-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-right-bold-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-split-horizontal"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-top-left-bold-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-top-right-bold-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-up-bold-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-arrow-up-down-bold-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-battery-alert-bluetooth"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-battery-bluetooth-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-battery-charging-wireless-alert"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-battery-unknown-bluetooth"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-bookmark-minus-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-camera-metering-center"></i> mdi
                                        mdi-camera-metering-center
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-camera-metering-matrix"></i> mdi
                                        mdi-camera-metering-matrix
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-camera-metering-partial"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-cellphone-settings-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chart-scatter-plot-hexbin"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chevron-down-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chevron-down-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chevron-left-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chevron-left-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chevron-right-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chevron-right-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chevron-up-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-chevron-up-circle-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-check-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-pulse-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-clipboard-text-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-comment-arrow-left-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-comment-arrow-right-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-comment-search-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-comment-text-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-content-save-settings-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-dots-horizontal-circle"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-devil-outline"></i> mdi
                                        mdi-emoticon-devil-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-excited-outline"></i> mdi
                                        mdi-emoticon-excited-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-happy-outline"></i> mdi
                                        mdi-emoticon-happy-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-emoticon-neutral-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-feature-search-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-multiple"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-file-document-box-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-annotation-minus"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-font-size-decrease"></i> mdi
                                        mdi-format-font-size-decrease
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-font-size-increase"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-letter-case-lower"></i> mdi
                                        mdi-format-letter-case-lower
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-format-letter-case-upper"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-gesture-swipe-horizontal"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-gesture-swipe-vertical"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-gesture-two-double-tap"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-heart-multiple-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-keyboard-settings-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-language-ruby-on-rails"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-message-settings-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-monitor-cellphone-star"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-network-strength-1-alert"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-network-strength-2-alert"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-network-strength-3-alert"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-network-strength-4-alert"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-network-strength-off-outline"></i> mdi
                                        mdi-network-strength-off-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-network-strength-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-page-layout-sidebar-left"></i> mdi
                                        mdi-page-layout-sidebar-left
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-page-layout-sidebar-right"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-phone-rotate-landscape"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-router-wireless-settings"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-shield-account-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-signal-cellular-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-source-commit-end-local"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-source-commit-next-local"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-source-commit-start-next-local"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-star-four-points-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-star-three-points-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-swap-horizontal-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-television-classic-off"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-thought-bubble-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-toggle-switch-off-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-two-factor-authentication"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-unfold-less-horizontal"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-unfold-more-horizontal"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-view-dashboard-outline"></i> mdi
                                        mdi-view-dashboard-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-view-dashboard-variant"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-weather-lightning-rainy"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-wifi-strength-alert-outline"></i> mdi
                                        mdi-wifi-strength-alert-outline
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-wifi-strength-lock-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-wifi-strength-off-outline"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-xbox-controller-battery-alert"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-xbox-controller-battery-empty"></i> mdi
                                        mdi-xbox-controller-battery-empty
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-xbox-controller-battery-full"></i> mdi
                                        mdi-xbox-controller-battery-full
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-xbox-controller-battery-low"></i> mdi
                                        mdi-xbox-controller-battery-low
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-xbox-controller-battery-medium"></i> mdi
                                        mdi-xbox-controller-battery-medium
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-xbox-controller-battery-unknown"></i> mdi
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="mdi mdi-youtube-creator-studio"></i> mdi
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\icons-materialdesign.blade.php ENDPATH**/ ?>