                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="page-title mb-0 font-size-18">Font Awesome</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc mb-2">Use
                                    <code>&lt;i class="fab fa-500px"&gt;&lt;/i&gt;</code> <span
                                        class="badge bg-success">v 5.8.1</span>.
                                </p>
                                ...
                                <div class="row icon-demo-content">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="fab fa-acquisitions-incorporated"></i> fab
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="fab fa-creative-commons-pd-alt"></i> fab
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="fab fa-creative-commons-sampling"></i> fab
                                        fa-creative-commons-sampling
                                    </div>
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <i class="fab fa-creative-commons-sampling-plus"></i> fab
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\icons-fontawesome.blade.php ENDPATH**/ ?>