    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">Jquery Knob Chart</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="text-center" dir="ltr">
                                ...
                                <input class="knob" data-width="150" data-fgcolor="#3b5de7" data-displayinput="false"
                                    value="35">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="text-center" dir="ltr">
                                ...
                                <input class="knob" data-width="150" data-cursor="true" data-fgcolor="#45cb85"
                                    value="29">
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="text-center" dir="ltr">
                                ...
                                <input class="knob" data-width="150" data-cursor="true" data-fgcolor="#ff715b"
                                    value="29">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\charts-knob.blade.php ENDPATH**/ ?>