                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($user->roles->first()->name ?? $user->base_role ?? 'â€”'); ?></td>
                                        <td>
                                        ...
                                        <td class="d-flex gap-1">
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin.settings.utilisateurs.toggle-active', $user)); ?>">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn btn-sm btn-warning"><?php echo e($user->is_active ? 'DÃ©sactiver' : 'Activer'); ?></button>
                                            </form>
...
<?php echo $__env->make('layouts.admin-v6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\settings\utilisateurs\index.blade.php ENDPATH**/ ?>