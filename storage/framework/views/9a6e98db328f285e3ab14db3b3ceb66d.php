...
(function() {
    ...
    const channelsUrl = '<?php echo e(route("admin.messagerie.channels")); ?>';
    const createChannelUrl = '<?php echo e(route("admin.messagerie.channels.create")); ?>';
    ...
    function loadMessages() {
        ...
        const messagesUrl = '<?php echo e(url("admin/messagerie/channels")); ?>/' + currentChannelId + '/messages';
    ...
    function sendMessage() {
        ...
        const sendUrl = '<?php echo e(url("admin/messagerie/channels")); ?>/' + currentChannelId + '/messages';
        fetch(sendUrl, {
            method: 'POST',
            headers: {
