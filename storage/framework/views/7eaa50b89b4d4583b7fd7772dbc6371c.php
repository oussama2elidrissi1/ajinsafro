        ...
        <div class="row">
            <div class="col-lg-4 mb-3" data-voyage-themes-block>
                ...
                <div
                    ...
                    data-assigned-ids="<?php echo e(implode(',', $selectedThemeIds)); ?>"
                >
                    <?php $__currentLoopData = $allVoyageThemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $th): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex align-items-center gap-2 mb-2 ve-voyage-theme-row" data-theme-id="<?php echo e((int) $th->id); ?>">
                            <div class="form-check mb-0 flex-grow-1">
                                <input
                                    class="form-check-input"
                                    type="checkbox"
                                    name="voyage_theme_ids[]"
                                    value="<?php echo e((int) $th->id); ?>"
                                    id="voyage_theme_<?php echo e((int) $th->id); ?>"
                                    <?php if(in_array((int) $th->id, $selectedThemeIds, true)): echo 'checked'; endif; ?>
                                >
                                <label class="form-check-label" for="voyage_theme_<?php echo e((int) $th->id); ?>"><?php echo e($th->name); ?></label>
                            </div>
                            <div class="btn-group btn-group-sm">
                                <button
                                    type="button"
                                    class="btn btn-outline-secondary ve-voyage-theme-edit"
                                    data-theme-id="<?php echo e((int) $th->id); ?>"
                                    data-name="<?php echo e(e($th->name)); ?>"
                                    data-slug="<?php echo e(e($th->slug)); ?>"
                                    title="Modifier"
                                >
                    ...
                    <?php if($allVoyageThemes->isEmpty()): ?>
...
<script>
(function() {
    const baseUrl = <?php echo json_encode(route('admin.circuits.voyage-themes.index'), 15, 512) ?>;
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\circuits\voyages\partials\_voyage_laravel_themes.blade.php ENDPATH**/ ?>