...
<div class="flight-manager"
     ...
     data-day-number="<?php echo e($dayNumber); ?>"
     data-total-days="<?php echo e($totalDays); ?>"
     id="<?php echo e($containerId); ?>">
    ...
    <div class="flights-content">
        ...
        <?php if($isCompact): ?>
            <div data-compact-flight-section="outbound">
                <?php echo $__env->make('admin.circuits.voyages.partials._flight_section_focused', [
                    'type' => 'outbound',
            ...
            <div class="alert alert-info compact-flight-guidance" data-compact-flight-section="mid">
                <p class="mb-2">Le Vol Aller se configure sur Jour 1, le Vol Retour sur Jour <?php echo e($totalDays); ?>, et les vols pendant le circuit sur le jour courant.</p>
                <div class="d-flex gap-2 flex-wrap">
                    <button type="button" class="btn btn-sm btn-outline-primary" data-flight-jump-day="1">
                        Configurer Vol Aller (Jour 1)
                    </button>
                    <button type="button" class="btn btn-sm btn-outline-primary" data-flight-jump-day="<?php echo e($totalDays); ?>">
                        Configurer Vol Retour (Jour <?php echo e($totalDays); ?>)
                    </button>
                </div>
            </div>
        ...
        <?php else: ?>
            <?php echo $__env->make('admin.circuits.voyages.partials._flight_options_sections', [
                'flightOptionsWithIndex' => $flightOptionsWithIndex,
...
<?php if($isCompact): ?>
    <script>
    (function() {
        const container = document.getElementById('<?php echo e($containerId); ?>');
...
<?php else: ?>
    ...
    <script>
    (function() {
        var container = document.getElementById('<?php echo e($containerId); ?>');
        ...
        var endpoints = {
            list: '<?php echo e(route('admin.circuits.airlines.ajax.list')); ?>',
            store: '<?php echo e(route('admin.circuits.airlines.ajax.store')); ?>',
            updateBase: '<?php echo e(url('/admin/circuits/airlines/ajax')); ?>',
            destroyBase: '<?php echo e(url('/admin/circuits/airlines/ajax')); ?>',
        };
...
<?php endif; ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\circuits\voyages\partials\_flight_manager.blade.php ENDPATH**/ ?>