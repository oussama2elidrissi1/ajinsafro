...
<?php $__env->startSection('title', 'HÃ´tel du circuit â€” ' . $tour->post_title); ?>
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    ...
                    <p class="small text-muted mb-2">Cet hÃ´tel circuit est rattachÃ© Ã  ce voyage (tour_id = <?php echo e($tour->ID); ?>).</p>
            ...
            <?php if($hotel): ?>
                ...
                <div class="card shadow-sm mb-3">
                    <div class="card-header bg-light d-flex align-items-center">
                        ...
                        <?php if($hotel->stars): ?>
                            <span class="badge bg-warning text-dark ms-auto">â˜… <?php echo e($hotel->stars); ?> Ã©toiles</span>
                        <?php endif; ?>
                    </div>
                    <div class="card-body">
                        <table class="table table-sm table-borderless mb-0">
                            <tbody>
                                <tr><td class="text-nowrap pe-3 fw-medium text-muted" style="width:140px;">ID hÃ´tel circuit</td><td><code><?php echo e($hotel->id); ?></code></td></tr>
                                <tr><td class="pe-3 fw-medium text-muted">Nom</td><td><?php echo e($hotel->hotel_name ?? 'â€”'); ?></td></tr>
                                <tr><td class="pe-3 fw-medium text-muted">Adresse</td><td><?php echo e($hotel->address ?? 'â€”'); ?></td></tr>
                                <tr><td class="pe-3 fw-medium text-muted">Type de chambre</td><td><?php echo e($hotel->room_type ?? 'â€”'); ?></td></tr>
                                <tr><td class="pe-3 fw-medium text-muted">Formule repas</td><td><?php echo e($hotel->meal_plan ?? 'â€”'); ?></td></tr>
                                <?php if($hotel->check_in_day !== null || $hotel->check_out_day !== null): ?>
                                    <tr><td class="pe-3 fw-medium text-muted">Jours</td><td>Check-in jour <?php echo e($hotel->check_in_day ?? 'â€”'); ?> / Check-out jour <?php echo e($hotel->check_out_day ?? 'â€”'); ?></td></tr>
                                <?php endif; ?>
            ...
            <?php else: ?>
                <div class="card shadow-sm mb-3 border-warning">
                    <div class="card-body text-center text-muted py-4">
                        ...
                        <a href="<?php echo e(route('admin.circuits.tour-hotels.edit', $tour->ID)); ?>" class="btn btn-primary btn-sm mt-2">Renseigner l'hÃ´tel</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
                ...
                <div class="card shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0 small">
                            ...
                            <li><strong>HÃ´tel</strong> : <?php echo e($hotel->hotel_name ?: 'â€”'); ?></li>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $hotel->rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($room->room_label ?? 'â€”'); ?></td>
                                            <td><code class="small"><?php echo e($room->room_code ?? 'â€”'); ?></code></td>
                                            ...
                                            <td><?php echo e($room->supplement ? number_format((float) $room->supplement, 0, ',', ' ') . ' DH' : 'â€”'); ?></td>
                                            <td class="small text-muted" style="max-width:180px;"><?php echo e($room->description ? \Str::limit($room->description, 50) : 'â€”'); ?></td>
                                            <td><?php if($room->is_default): ?><span class="badge bg-success">Oui</span><?php else: ?><span class="text-muted">â€”</span><?php endif; ?></td>
...
<?php echo $__env->make('layouts.admin-v6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\circuits\tour-hotels\show.blade.php ENDPATH**/ ?>