...
<div
    ...
    aria-hidden="true"
    data-laravel-voyage-id="<?php echo e($voyage->id); ?>"
    data-wp-tour-post-id="<?php echo e($raWpTourPostId); ?>"
    data-server-wp-travel-dates-count="<?php echo e($raServerWpDates); ?>"
    data-server-laravel-departures-count="<?php echo e($raServerLaravelDeps); ?>"
    data-departures-url="<?php echo e($raDeparturesUrl); ?>"
    data-sync-departures-url="<?php echo e($raSyncDeparturesUrl); ?>"
    data-panel-base="<?php echo e($raPanelBase); ?>"
>
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\circuits\voyages\partials\room_availability\modal.blade.php ENDPATH**/ ?>