        ...
        <div class="dossier-page-head">
            <div>
                <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                    <span class="dossier-pill <?php echo e($dossierBadge['class']); ?>"><?php echo e($dossierBadge['label']); ?></span>
                    <span class="dossier-pill <?php echo e($paymentBadge['class']); ?>"><?php echo e($paymentBadge['label']); ?></span>
                </div>
                <h1>Dossier <?php echo e($dossier->dossier_number ?: 'En attente de confirmation'); ?></h1>
                <p>Vue détaillée du dossier client, du voyage, des paiements, documents et actions opérationnelles.</p>
            </div>

            <div class="dossier-actions">
                <a href="<?php echo e($backUrl ?? route('admin.reservation-dossiers.index')); ?>" class="dossier-btn dossier-btn-soft">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('admin.reservations.invoice', $reservation)); ?>" target="_blank"><i class="bx bx-receipt me-2"></i>Voir facture</a></li>
                        <?php if($mailToUrl): ?>
                            <li><a class="dropdown-item" href="<?php echo e($mailToUrl); ?>"><i class="bx bx-envelope me-2"></i>Contacter le client</a></li>
                        <?php endif; ?>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <form action="<?php echo e(route('admin.reservations.cancel', $reservation)); ?>" method="POST" onsubmit="return confirm('Annuler ce dossier ?');">
                                <?php echo csrf_field(); ?>
        ...
        <section class="dossier-card dossier-hero">
            <div class="dossier-hero-media">
                <?php if($offerImageUrl): ?>
                    <img src="<?php echo e($offerImageUrl); ?>" alt="<?php echo e($offer?->name ?? 'Offre liée'); ?>" onerror="this.style.display='none'; this.nextElementSibling.style.display='grid';">
            ...
            <div class="dossier-hero-copy">
                <div>
                    ...
                    <h2 class="dossier-hero-title"><?php echo e($offer?->name ?? 'Offre non renseignée'); ?></h2>
                    <p class="text-muted mb-0"><?php echo e($offer?->destination ?? 'Destination non renseignée'); ?></p>
                </div>
                ...
                <div class="dossier-hero-meta">
                    ...
                    <div class="dossier-meta-card">
                        <span>Dossier</span>
                        <strong><?php echo e($dossier->dossier_number ?: 'En attente'); ?></strong>
                    </div>
                </div>
            </div>
        </section>
                ...
                <section class="dossier-card">
                    ...
                    <div class="dossier-card-body">
                        <div class="info-grid mb-3">
                            ...
                            <div class="info-item">
                                <span>Email</span>
                                <div><?php echo e($clientEmail ?: '—'); ?></div>
                            </div>
                            <div class="info-item">
                                <span>Téléphone</span>
                                <div><?php echo e($clientPhone ?: '—'); ?></div>
                            </div>
                            <div class="info-item">
                                <span>Adresse</span>
                                <div><?php echo e($clientAddress ?: '—'); ?></div>
                            </div>
                        </div>

                        <div class="d-flex flex-wrap gap-2">
                            <?php if($clientProfileUrl): ?>
                                <a href="<?php echo e($clientProfileUrl); ?>" class="dossier-btn dossier-btn-soft">
                                    <i class="bx bx-user-circle"></i>
                                    <span>Voir le profil client</span>
                                </a>
                            <?php endif; ?>
                            <?php if($mailToUrl): ?>
                                <a href="<?php echo e($mailToUrl); ?>" class="dossier-btn dossier-btn-soft">
                                    <i class="bx bx-envelope"></i>
                                    <span>Envoyer un email</span>
                                </a>
                            <?php endif; ?>
                            <?php if($whatsAppUrl): ?>
                                <a href="<?php echo e($whatsAppUrl); ?>" target="_blank" rel="noopener" class="dossier-btn dossier-btn-soft">
                    ...
                    <div class="dossier-card-body">
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <strong><?php echo e($offer?->destination ?? '—'); ?></strong>
                            </div>
                            <div class="info-item">
                                <span>Date de départ</span>
                                <div><?php echo e($departure?->start_date?->format('d/m/Y') ?? '—'); ?></div>
                            </div>
                            <div class="info-item">
                                <span>Durée</span>
                                <div><?php echo e($durationLabel ?: '—'); ?></div>
                            </div>
                            <div class="info-item">
                                <span>Agence</span>
                                <div><?php echo e($reservation->partner?->name ?? 'Ajinsafro'); ?></div>
                            </div>
                            <div class="info-item">
                                <span>Point de vente</span>
                                <div><?php echo e($reservation->branch?->name ?? '—'); ?></div>
                            </div>
                            <div class="info-item">
                                <span>Agent / commercial</span>
                                <div><?php echo e($reservation->assignedTo?->name ?? $reservation->agent?->name ?? $reservation->creator?->name ?? '—'); ?></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="dossier-card">
                    <div class="dossier-card-header">
                        <div class="d-flex justify-content-between align-items-center gap-2">
                            ...
                            <span class="passenger-badge"><?php echo e(max(1, $passengers->count())); ?> passager<?php echo e(max(1, $passengers->count()) > 1 ? 's' : ''); ?></span>
                        </div>
                    </div>
                    <div class="dossier-card-body">
                        <div class="passenger-list">
                            <?php if($passengers->isNotEmpty()): ?>
                                <?php $__currentLoopData = $passengers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $passenger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="passenger-row">
                                        <div class="passenger-head">
                                            <div>
                                                <div class="passenger-name"><?php echo e(trim(($passenger->first_name ?? '').' '.($passenger->last_name ?? '')) ?: 'Passager'); ?></div>
                                                <div class="passenger-meta">
                                                    <?php echo e(ucfirst((string) ($passenger->type ?: $passenger->traveler_type ?: 'adulte'))); ?>

                                                    <?php if($passenger->phone): ?>
                                                        • <?php echo e($passenger->phone); ?>

                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <span class="dossier-pill is-completed"><?php echo e($passenger->document_type ?: 'Document'); ?></span>
                                        </div>
                                        <div class="passenger-meta mt-2">
                                            <?php echo e($passenger->document_number ?: 'Document non renseigné'); ?>
                            ...
                            <?php else: ?>
                                <div class="passenger-row">
                                    <div class="passenger-head">
                                        <div>
                                            <div class="passenger-name"><?php echo e($clientName); ?></div>
                ...
                <section class="dossier-card">
                    <div class="dossier-card-header">
                        <div class="d-flex justify-content-between align-items-center gap-2">
                            ...
                            <a href="<?php echo e($allClientReservationsUrl); ?>" class="dossier-btn dossier-btn-soft">
                    ...
                    <div class="dossier-card-body">
                        <?php if($relatedReservations->isNotEmpty()): ?>
                            <div class="related-list">
                                <?php $__currentLoopData = $relatedReservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="related-row">
                                        <div class="related-head">
                                            <div>
                                                <div class="related-title">#<?php echo e($related->id); ?> • <?php echo e($related->dossier_number ?? 'Sans numéro'); ?></div>
                                                <div class="related-meta">
                                                    <?php echo e($related->client?->full_name ?: trim(($related->client_first_name ?? '').' '.($related->client_last_name ?? '')) ?: '—'); ?>

                                                    • <?php echo e($related->departure?->start_date?->format('d/m/Y') ?? optional($related->created_at)->format('d/m/Y') ?? '—'); ?>

                                                </div>
                                            </div>
                                            <div class="text-end">
                                                <span class="dossier-pill <?php echo e($relatedStatus['class']); ?>"><?php echo e($relatedStatus['label']); ?></span>
                                                <div class="related-price mt-2"><?php echo e(number_format((float) ($related->total_amount ?? 0), 2, ',', ' ')); ?> DH</div>
                                            </div>
                                        </div>
                                        <div class="mt-3">
                                            <a href="<?php echo e(route('admin.reservations.show', $related)); ?>" class="dossier-btn dossier-btn-soft">
                    ...
                    <div class="dossier-card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="documents-panel" role="tabpanel" aria-labelledby="documents-tab">
                                                ...
                                                <div class="document-head">
                                                    <div>
                                                        ...
                                                        <div class="document-meta">
                                                            <span class="text-dark fw-bold">Description : <?php echo e($document->title); ?></span>
                                                            • <?php echo e(ucfirst(str_replace('_', ' ', (string) $document->type))); ?>

                                                            • <?php echo e(optional($document->created_at)->format('d/m/Y H:i') ?? '—'); ?>

                                                            • <?php echo e($document->creator?->name ?? 'Système'); ?>

                                                        </div>
                                                    </div>
                                                    <?php if($documentUrl($document)): ?>
                                                        <a href="<?php echo e($documentUrl($document)); ?>" target="_blank" rel="noopener" class="dossier-btn dossier-btn-soft">
                                ...
                                <form action="<?php echo e(route('admin.reservations.documents.store', $reservation)); ?>" method="POST" enctype="multipart/form-data" class="dossier-form-grid">
                                    <?php echo csrf_field(); ?>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                            ...
                            <div class="tab-pane fade" id="notes-panel" role="tabpanel" aria-labelledby="notes-tab">
                                <?php if($noteEntries->isNotEmpty()): ?>
                                    <div class="notes-list mb-3">
                                        <?php $__currentLoopData = $noteEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noteEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="note-row">
                                                <div class="note-meta mb-2">
                                                    <?php echo e(optional($noteEntry->created_at)->format('d/m/Y H:i') ?? '—'); ?>

                                                    • <?php echo e($noteEntry->user?->name ?? 'Système'); ?>

                                                </div>
                                                <div class="text-dark" style="white-space: pre-line;"><?php echo e($noteEntry->note); ?></div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php elseif($notesContent !== ''): ?>
                                    <div class="note-row mb-3">
                                        <div class="note-meta mb-2">Notes internes existantes</div>
                                        <div class="text-dark" style="white-space: pre-line;"><?php echo e($notesContent); ?></div>
                                    </div>
                                <?php else: ?>
                                    <div class="empty-state mb-3">Aucune note interne enregistrée.</div>
                                <?php endif; ?>

                                <?php if(auth()->user()->can('reservations.view_internal_notes') || auth()->user()->can('reservations.update')): ?>
                                    <form action="<?php echo e(route('admin.reservations.notes.store', $reservation)); ?>" method="POST" class="dossier-form-grid">
                                        <?php echo csrf_field(); ?>
                                        <div>
            ...
            <div class="dossier-stack">
                <section class="dossier-card">
                    ...
                    <div class="dossier-card-body summary-grid">
                        ...
                        <div class="summary-row">
                            <span>Extras</span>
                            <?php $extrasTotal = (float) ($dossier->extras_total ?? $reservation->extras_total ?? 0); ?>
                            <?php if($hasCalculatedFinancials || $extrasTotal > 0): ?>
                                <strong><?php echo e(number_format($extrasTotal, 2, ',', ' ')); ?> DH</strong>
                            <?php else: ?>
                                <strong class="text-muted" style="font-size:0.95rem;">—</strong>
                            <?php endif; ?>
                        </div>
                ...
                <?php $roomAllocations = $reservation->reservationRooms ?? collect(); ?>
                <?php if($roomAllocations->isEmpty()): ?>
                    <section class="dossier-card" style="border-color: #f59e0b; background: linear-gradient(135deg, #fffbeb, #ffffff);">
                        ...
                        <div class="dossier-card-body">
                            ...
                            <div class="mt-3">
                                <?php if(Route::has('admin.reservations.edit')): ?>
                                    <a href="<?php echo e(route('admin.reservations.edit', $reservation)); ?>" class="dossier-btn dossier-btn-soft">
                        ...
                        <div class="actions-list">
                            <div class="action-row">
                                <div class="d-flex justify-content-between align-items-center gap-3">
                                    ...
                                    <a href="<?php echo e(route('admin.reservations.invoice', $reservation)); ?>" target="_blank" class="dossier-btn dossier-btn-soft">
                            ...
                            <div class="action-row">
                                <div class="d-flex justify-content-between align-items-center gap-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <?php if($mailToUrl): ?>
                                            <a href="<?php echo e($mailToUrl); ?>" class="dossier-btn dossier-btn-soft"><i class="bx bx-envelope"></i><span>Email</span></a>
                                        <?php endif; ?>
                                        <?php if($whatsAppUrl): ?>
                                            <a href="<?php echo e($whatsAppUrl); ?>" target="_blank" rel="noopener" class="dossier-btn dossier-btn-soft"><i class="bx bxl-whatsapp"></i><span>WhatsApp</span></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="dossier-card" id="payment-form">
                    ...
                    <div class="dossier-card-body">
                        <form action="<?php echo e(route('admin.reservations.payments.store', $reservation)); ?>" method="POST" enctype="multipart/form-data" class="dossier-form-grid">
                            <?php echo csrf_field(); ?>
                            <div class="row g-3">
                                <div class="col-md-6">
