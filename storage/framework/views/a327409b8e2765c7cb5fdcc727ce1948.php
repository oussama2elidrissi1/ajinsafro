                    ...
                    <div class="rd-card-grid">
                        ...
                        <section class="rd-panel" id="dossier-update-card">
                            <div class="rd-panel-head">
                                ...
                                <a href="<?php echo e(route('admin.reservations.edit', $reservation)); ?>" class="rd-btn rd-btn-soft rd-btn-sm"><i class="bx bx-external-link"></i><span>Ouvrir l�?Tédition complète</span></a>
                            </div>
                            <div class="rd-panel-body">
