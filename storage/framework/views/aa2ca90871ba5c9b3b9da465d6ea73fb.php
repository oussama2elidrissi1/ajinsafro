...
<div id="tour-hotels-wrapper" data-wp-site-url="<?php echo e($wpSiteUrl); ?>">

    <?php if($otherHotels->isNotEmpty()): ?>
        <datalist id="tour-hotels-wp-datalist">
            <?php $__currentLoopData = $otherHotels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <?php if($wpHotelId <= 0) continue; ?>
                <option value="<?php echo e($wpHotelId); ?> - <?php echo e($hotelLabel); ?><?php echo e($hotelAddress !== '' ? (' - ' . $hotelAddress) : ''); ?>"></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </datalist>
    <?php endif; ?>

    <div id="tour-hotels-container">
        <?php $__currentLoopData = $hotelsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hi => $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="card mb-3 border tour-hotel-row"
                data-index="<?php echo e($hi); ?>"
                data-hotel-id="<?php echo e(optional($h)->id ?? ''); ?>"
                data-source-hotel-id="<?php echo e(old("tour_hotels.{$hi}.source_hotel_id", '')); ?>">
                <?php if(optional($h)->id): ?>
                    <input type="hidden" name="tour_hotels[<?php echo e($hi); ?>][id]" value="<?php echo e($h->id); ?>">
                <?php endif; ?>
                <input type="hidden" name="tour_hotels[<?php echo e($hi); ?>][hotel_id]" value="<?php echo e(old("tour_hotels.{$hi}.hotel_id", '')); ?>">
                <input type="hidden" name="tour_hotels[<?php echo e($hi); ?>][source_hotel_id]" value="<?php echo e(old("tour_hotels.{$hi}.source_hotel_id", '')); ?>">
                ...
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-start gap-3">
                    <div class="tour-hotel-card-heading lh-sm">
                        <div class="tour-hotel-card-title fw-semibold">Séjour <?php echo e($hi + 1); ?></div>
                ...
                <div class="card-body tour-hotel-card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select form-select-sm tour-hotel-check-in" name="tour_hotels[<?php echo e($hi); ?>][check_in_day]" data-index="<?php echo e($hi); ?>">
                                <?php for($d = 1; $d <= $lastDayNumber; $d++): ?>
                                    <option value="<?php echo e($d); ?>" <?php echo e($checkInDay === $d ? 'selected' : ''); ?>>Jour <?php echo e($d); ?></option>
                                <?php endfor; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select form-select-sm tour-hotel-check-out" name="tour_hotels[<?php echo e($hi); ?>][check_out_day]" data-index="<?php echo e($hi); ?>">
                                <?php for($d = 1; $d <= $lastDayNumber; $d++): ?>
                                    <option value="<?php echo e($d); ?>" <?php echo e($checkOutDay === $d ? 'selected' : ''); ?>>Jour <?php echo e($d); ?></option>
                                <?php endfor; ?>
                            </select>
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            <span class="tour-hotel-nights-badge badge bg-light text-dark border fw-normal px-3 py-2">
                                ...
                                <span class="tour-hotel-nights-count"><?php echo e($nuits); ?></span> nuit<?php echo e($nuits !== 1 ? 's' : ''); ?>
                        ...
                        <div class="col-md-3 d-flex align-items-end pb-1">
                            <div class="form-check mb-1">
                                <input type="checkbox" class="form-check-input" name="tour_hotels[<?php echo e($hi); ?>][is_optional]" value="1" <?php echo e(old("tour_hotels.{$hi}.is_optional", optional($h)->is_optional ?? false) ? 'checked' : ''); ?>>
                                ...
                                <div class="row g-2 align-items-end">
                                    <div class="col-lg-8">
                                        ...
                                        <input type="text"
                                            ...
                                            value="<?php echo e($initialSearchValue); ?>"
                                    ...
                                    <div class="col-lg-4 d-flex flex-wrap gap-2">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-secondary tour-hotel-unlink-wp-btn <?php echo e($linkedWpHotelId > 0 ? '' : 'd-none'); ?>">
                                            <i class="bx bx-unlink"></i>
                                        </button>
                                    </div>
                                </div>

                                <div class="tour-hotel-linked-summary mt-3 <?php echo e($linkedWpHotelId > 0 ? '' : 'd-none'); ?>" data-linked-id="<?php echo e($linkedWpHotelId > 0 ? $linkedWpHotelId : ''); ?>">
                                    <div class="d-flex align-items-start gap-3">
                                        <div class="tour-hotel-linked-summary-image-wrap <?php echo e($initialSummaryImageUrl !== '' ? '' : 'd-none'); ?>">
                                            <img src="<?php echo e($initialSummaryImageUrl); ?>" alt="" class="tour-hotel-linked-summary-image">
                                        </div>
                                        <div class="tour-hotel-linked-summary-content">
                                            <div class="tour-hotel-linked-summary-name fw-semibold"><?php echo e($initialHotelName !== '' ? $initialHotelName : ($linkedWpHotelId > 0 ? ('Hebergement #' . $linkedWpHotelId) : '')); ?></div>
                                            ...
                                            <div class="d-flex align-items-center gap-2 mt-1">
                                                <span class="badge rounded-pill bg-soft-primary text-primary tour-hotel-linked-summary-id">
                                                    <?php echo e($linkedWpHotelId > 0 ? ('#' . $linkedWpHotelId) : ''); ?>

                                                </span>
                                                <a href="<?php echo e($initialWpUrl); ?>" target="_blank" rel="noopener" class="small tour-hotel-linked-summary-link <?php echo e($initialWpUrl !== '' ? '' : 'd-none'); ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-sm tour-hotel-name-input tour-hotel-identity-field"
                                name="tour_hotels[<?php echo e($hi); ?>][hotel_name]"
                                value="<?php echo e(old("tour_hotels.{$hi}.hotel_name", optional($h)->hotel_name ?? '')); ?>"
                                placeholder="Ex : Ibis Marrakech Centre">
                        </div>

                        <div class="col-md-2">
                            <label class="form-label small mb-1">Étoiles</label>
                            <input type="number" class="form-control form-control-sm tour-hotel-stars-input tour-hotel-identity-field"
                                name="tour_hotels[<?php echo e($hi); ?>][stars]"
                                value="<?php echo e(old("tour_hotels.{$hi}.stars", optional($h)->stars ?? '')); ?>"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control form-control-sm tour-hotel-address-input tour-hotel-identity-field"
                                name="tour_hotels[<?php echo e($hi); ?>][address]"
                                value="<?php echo e(old("tour_hotels.{$hi}.address", optional($h)->address ?? '')); ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-sm tour-hotel-meal-input tour-hotel-identity-field"
                                name="tour_hotels[<?php echo e($hi); ?>][meal_plan]"
                                value="<?php echo e(old("tour_hotels.{$hi}.meal_plan", optional($h)->meal_plan ?? '')); ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control form-control-sm tour-hotel-identity-field"
                                name="tour_hotels[<?php echo e($hi); ?>][notes]"
                                rows="2"
                                placeholder="Informations complémentaires pour l'équipe"><?php echo e(old("tour_hotels.{$hi}.notes", optional($h)->notes ?? '')); ?></textarea>
                        </div>

                        
                        <div class="col-12 tour-hotel-media-block">
                            <label class="form-label small mb-1">Photo de l'hôtel</label>
                            <input type="hidden" class="tour-hotel-identity-field" name="tour_hotels[<?php echo e($hi); ?>][image_id]" id="<?php echo e($hid); ?>" value="<?php echo e(old("tour_hotels.{$hi}.image_id", optional($h)->image_id ?? '')); ?>">
                            <div class="d-flex flex-wrap align-items-center gap-3">
                                <div id="<?php echo e($hid); ?>_preview_wrap" class="border rounded overflow-hidden bg-light" style="width:120px;height:80px;display:<?php echo e($himgUrl ? 'flex' : 'none'); ?>;">
                                    <img id="<?php echo e($hid); ?>_preview" src="<?php echo e($himgUrl); ?>" alt="" class="img-fluid" style="max-width:100%;max-height:100%;object-fit:cover;">
                                </div>
                                <div class="tour-hotel-media-actions d-flex gap-2">
                                    <button type="button" class="btn btn-sm btn-outline-secondary ajtb-logistique-media-btn"
                                        data-target="tour_hotel" data-input="<?php echo e($hid); ?>" data-preview="<?php echo e($hid); ?>_preview" data-preview-wrap="<?php echo e($hid); ?>_preview_wrap">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-danger ajtb-logistique-media-remove"
                                        data-input="<?php echo e($hid); ?>" data-preview="<?php echo e($hid); ?>_preview" data-preview-wrap="<?php echo e($hid); ?>_preview_wrap">
                                        <i class="bx bx-x"></i>
                                    </button>
                                </div>
                            </div>
...
(function () {
    ...
    var wpDataBase = '<?php echo e(url("admin/circuits/wp-hotels")); ?>';
    var wpSiteUrl = (wrapper.getAttribute('data-wp-site-url') || '').replace(/\/+$/, '');
    var wpHotelsDataset = <?php echo json_encode($wpHotelsDataset, 15, 512) ?>;
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\circuits\voyages\partials\_tour_hotels_section.blade.php ENDPATH**/ ?>