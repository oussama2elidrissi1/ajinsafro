...
<?php $__env->startSection('title', 'Group Deals â€” Participants'); ?>
    ...
    <div class="card">
        <div class="card-body">
            <form method="get" class="row g-3 mb-4">
                <div class="col-md-6">
                    <input type="text" name="q" class="form-control" value="<?php echo e($filters['q'] ?? ''); ?>" placeholder="Nom, email ou tÃ©lÃ©phone">
                </div>
                <div class="col-md-3 d-flex gap-2">
                    <button class="btn btn-outline-primary flex-fill">Filtrer</button>
                    <a href="<?php echo e(route('admin.group-deals.participants.index')); ?>" class="btn btn-light">RÃ©initialiser</a>
                </div>
            </form>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                ...
                                <div class="text-muted small"><?php echo e($participant->email ?: 'â€”'); ?> Â· <?php echo e($participant->phone ?: 'â€”'); ?></div>
                            </td>
                            <td>
                            ...
                            <td class="small text-muted"><?php echo e(optional($participant->joined_at)->format('d/m/Y H:i') ?: 'â€”'); ?></td>
                            <td class="text-end">
                                <?php if($participant->groupDeal): ?>
...
<?php echo $__env->make('layouts.admin-v6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\group-deals\participants\index.blade.php ENDPATH**/ ?>