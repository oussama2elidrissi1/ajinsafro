                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3 mb-4">
                                        <label for="input-date2" class="form-label">Date Style 2</label>
                                    ...
                                    <div class="mb-3 mb-4">
                                        <label for="input-datetime" class="form-label">Date time</label>
                                    ...
                                    <div>
                                        <label for="input-currency" class="form-label">Currency:</label>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-4 mt-lg-0">
                                    ...
                                    <div>
                                        <label class="form-label" for="input-email">Email
                                            address::</label>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\form-mask.blade.php ENDPATH**/ ?>