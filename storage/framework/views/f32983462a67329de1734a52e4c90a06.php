...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">Modifier : <?php echo e($airline->name); ?></h4>
    ...
    <form action="<?php echo e(route('admin.circuits.airlines.update', $airline)); ?>" method="POST">
        <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="<?php echo e(old('name', $airline->name)); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="iata_code" class="form-label">Code IATA</label>
                            <input type="text" class="form-control" id="iata_code" name="iata_code" value="<?php echo e(old('iata_code', $airline->code_iata)); ?>" maxlength="10">
                        </div>
                        <div class="mb-3">
                            <label for="logo_url" class="form-label">URL du logo</label>
                            <input type="text" class="form-control" id="logo_url" name="logo_url" value="<?php echo e(old('logo_url', $airline->logo_path)); ?>">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" <?php echo e(old('is_active', $airline->is_active) ? 'checked' : ''); ?>>
