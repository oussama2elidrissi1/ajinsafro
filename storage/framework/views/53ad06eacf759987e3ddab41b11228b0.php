            ...
            <div class="reservation-create__payment-card">
                ...
                <div class="reservation-create__grid reservation-create__grid--two">
                    <div class="reservation-create__field">
                        ...
                        <input type="date" name="payment_date" id="payment_date" class="reservation-create__input" value="<?php echo e(old('payment_date', now()->toDateString())); ?>">
                    </div>
                    <div class="reservation-create__field">
                    ...
                    <div class="reservation-create__field">
                        ...
                        <input type="number" name="payment_amount" id="payment_amount" class="reservation-create__input" value="<?php echo e(old('payment_amount', 0)); ?>" min="0" step="0.01" placeholder="0.00">
                    </div>
                    <div class="reservation-create__field">
                        <label class="reservation-create__label" for="payment_reference">Référence paiement</label>
                        <input type="text" name="payment_reference" id="payment_reference" class="reservation-create__input" value="<?php echo e(old('payment_reference')); ?>" placeholder="Reçu, transaction, bordereau…">
                    </div>
                    <div class="reservation-create__field">
                    ...
                    <div class="reservation-create__field reservation-create__field--full">
                        ...
                        <textarea name="payment_note" id="payment_note" class="reservation-create__input reservation-create__input--textarea" rows="4" placeholder="Détail du règlement, échéance, point de suivi…"><?php echo e(old('payment_note')); ?></textarea>
                    </div>
                </div>
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\reservations\create\partials\step-payment.blade.php ENDPATH**/ ?>