        ...
        <aside class="aj-v4-sidebar" aria-label="Navigation principale">
            ...
            <nav class="aj-v4-sidebar__nav">
                ...
                <div class="aj-v4-sidebar__subnav">
                    ...
                    <a href="<?php echo e(route('admin.dashboard.v2')); ?>" class="aj-v4-sidebar__subitem <?php echo e($dashboardRouteIs('admin.dashboard.v2') ? 'is-active' : ''); ?>">Dashboard V2</a>
                    <a href="<?php echo e(route('admin.dashboard.v3')); ?>" class="aj-v4-sidebar__subitem <?php echo e($dashboardRouteIs('admin.dashboard.v3') ? 'is-active' : ''); ?>">Dashboard V3</a>
                    <a href="<?php echo e(route('admin.dashboard.v4')); ?>" class="aj-v4-sidebar__subitem <?php echo e($dashboardRouteIs('admin.dashboard.v4') ? 'is-active' : ''); ?>">Dashboard V4</a>
                </div>
                ...
                <div class="aj-v4-topbar__actions">
                    <div class="aj-v4-topbar__row">
                        ...
                        <div class="aj-v4-user">
                            <div class="aj-v4-user__photo"><?php echo e($dashboardInitials); ?></div>
                    ...
                    <div class="aj-v4-topbar__controls">
                        ...
                        <a href="<?php echo e(route('admin.reservations.create')); ?>" class="aj-v4-primary-btn">＋ Nouvelle réservation</a>
                    </div>
                </div>
            </header>
            ...
            <section class="aj-v4-grid aj-v4-analytics-grid">
                        ...
                        <div class="aj-v4-legend">
                            <?php $__currentLoopData = $destinationShare; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="aj-v4-legend__row">
                                    <span class="aj-v4-legend__name"><i class="aj-v4-dot" style="background: <?php echo e($item['color']); ?>;"></i><?php echo e($item['name']); ?></span>
                ...
                <article class="aj-v4-card aj-v4-panel">
                    ...
                    <div class="aj-v4-gauge">
                        ...
                        <div class="aj-v4-gauge__center"><strong><?php echo e($confirmedRatio); ?>%</strong><span>Confirmées</span></div>
                    </div>
            ...
            <section class="aj-v4-grid aj-v4-activity-grid">
                <article class="aj-v4-card aj-v4-panel">
                    <div class="aj-v4-panel__head">
                        ...
                        <a href="<?php echo e(route('admin.reservations.workspace')); ?>" class="aj-v4-chip">Calendrier</a>
                    </div>
                        ...
                        <table class="aj-v4-table">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $departures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php echo e($departure['date']); ?></td>
                                        <td><?php echo e($departure['city']); ?></td>
                                        <td><?php echo e($departure['name']); ?></td>
                                        <td><?php echo e($departure['sold']); ?> / <?php echo e($departure['capacity']); ?></td>
                                        <td><span class="aj-v4-status <?php echo e($statusClass); ?>"><?php echo e($departure['status']); ?></span></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
                ...
                <article class="aj-v4-card aj-v4-panel">
                    <div class="aj-v4-panel__head">
                        ...
                        <a href="<?php echo e(route('admin.reservations.index')); ?>" class="aj-v4-link">Voir tout</a>
                    </div>
                    <div class="aj-v4-list">
                        <?php $__currentLoopData = $recentReservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="aj-v4-reservation">
                                <div class="aj-v4-mini-avatar"><?php echo e(mb_strtoupper(mb_substr($reservation['client'], 0, 2))); ?></div>
                                ...
                                <div class="aj-v4-amount"><?php echo e($reservation['amount']); ?><small class="aj-v4-status <?php echo e($reservation['status'] === 'En attente' ? 'wait' : 'ok'); ?>"><?php echo e($reservation['status']); ?></small></div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </article>
                    ...
                    <div class="aj-v4-list">
                        <?php $__currentLoopData = $operationalAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="aj-v4-alert">
                                <div class="aj-v4-alert-icon <?php echo e($alert['tone'] === 'warn' ? 'warning' : ''); ?>"><i class="<?php echo e($alert['icon']); ?>"></i></div>
                                <div class="aj-v4-item">
                                    <strong><?php echo e($alert['label']); ?></strong>
                                    <span>Suivi du pilotage quotidien</span>
                                </div>
                                <div class="aj-v4-alert-time"><?php echo e($alert['value']); ?></div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <section class="aj-v4-grid aj-v4-metrics-grid" style="margin-top:18px;">
                <article class="aj-v4-card aj-v4-panel">
                    <div class="aj-v4-panel__head">
                        ...
                        <a href="<?php echo e(route('admin.dashboard.v3')); ?>" class="aj-v4-chip">Comparer V3</a>
                    </div>
                    <div class="aj-v4-list">
                        <?php $__currentLoopData = $salesChannels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="aj-v4-card" style="padding:15px; background:#fff; border-color:#edf2f8; box-shadow:none;">
                                <div class="aj-v4-panel__head" style="margin-bottom:0;">
                                    <div>
                                        <p class="aj-v4-panel__title" style="font-size:14px;"><?php echo e($channel['name']); ?></p>
                                        <p class="aj-v4-panel__subtitle">Répartition commerciale</p>
                                    </div>
                                    <span class="aj-v4-chip"><?php echo e($channel['value']); ?></span>
                                </div>
                                <div class="aj-v4-progress" style="margin-top:12px;">
                                    <div class="aj-v4-progress__bar"><div class="aj-v4-progress__fill" style="width: <?php echo e($channelPercent); ?>%;"></div></div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                            ...
                            <div class="aj-v4-card" style="padding:14px; background:#fff; border-color:#edf2f8; box-shadow:none;">
                                <div class="aj-v4-panel__head" style="margin-bottom:0;">
                                    <div style="display:flex; gap:12px; align-items:center; min-width:0;">
                                        <div class="aj-v4-alert-icon <?php echo e($alert['tone'] === 'warn' ? 'warning' : ''); ?>"><i class="<?php echo e($alert['icon']); ?>"></i></div>
                                        <div>
                                            <p class="aj-v4-panel__title" style="font-size:14px;"><?php echo e($alert['label']); ?></p>
                                            <p class="aj-v4-panel__subtitle">Suivi du pilotage quotidien</p>
                                        </div>
                                    </div>
                                    <span class="aj-v4-chip"><?php echo e($alert['value']); ?></span>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
