...
<style>
    ...
    body.aj-admin-compact .dashboard-v4-donut {
        ...
        margin: 0 auto;
        border-radius: 50%;
        background: <?php echo e($destinationConic); ?>;
        position: relative;
    ...
    body.aj-admin-compact .dashboard-v4-objective-fill {
        width: <?php echo e(max(35, min(95, (int) $confirmedRatio))); ?>%;
        height: 100%;
        border-radius: inherit;
        background: #f28c28;
    }
...
<div class="dashboard-v4-page">
        ...
        <div class="dashboard-v4-hero-grid">
            <div>
                <div class="dashboard-v4-brand">
                    <img src="<?php echo e(\App\Models\Setting::brandLogoUrl('dark')); ?>" alt="Ajinsafro">
                </div>
                ...
                <div class="dashboard-v4-actions">
                    <a href="<?php echo e(route('admin.reservations.workspace')); ?>" class="dashboard-v4-btn is-primary">
                        <i class="bx bx-calendar-check"></i>
                        Ouvrir le workspace
                    </a>
                    <a href="<?php echo e(route('admin.dashboard.v3')); ?>" class="dashboard-v4-btn is-secondary">
            ...
            <div class="dashboard-v4-hero-side">
                <div class="dashboard-v4-side-card">
                    ...
                    <p class="dashboard-v4-side-value"><?php echo e(number_format((float) $revenueTotal, 0, ',', ' ')); ?> DH</p>
                    <p class="dashboard-v4-side-meta">Evolution mensuelle: +<?php echo e(number_format($monthEvolution, 1, ',', ' ')); ?>%</p>
                </div>
                <div class="dashboard-v4-side-card">
                    <p class="dashboard-v4-side-label">Réservations</p>
                    <p class="dashboard-v4-side-value"><?php echo e(number_format($reservationsTotal, 0, ',', ' ')); ?></p>
    ...
    <section class="dashboard-v4-metrics">
        <article class="dashboard-v4-card dashboard-v4-panel">
            ...
            <div style="margin-top: 14px; font-size: 30px; font-weight: 900; color: #0f243d;"><?php echo e(number_format((float) $revenueTotal, 0, ',', ' ')); ?> DH</div>
        ...
        <article class="dashboard-v4-card dashboard-v4-panel">
            ...
            <div style="margin-top: 14px; font-size: 30px; font-weight: 900; color: #0f243d;"><?php echo e(number_format($reservationsTotal, 0, ',', ' ')); ?></div>
        ...
        <article class="dashboard-v4-card dashboard-v4-panel">
            ...
            <div style="margin-top: 14px; font-size: 30px; font-weight: 900; color: #0f243d;"><?php echo e(number_format($departuresActive, 0, ',', ' ')); ?></div>
        ...
        <article class="dashboard-v4-card dashboard-v4-panel">
            ...
            <div style="margin-top: 14px; font-size: 30px; font-weight: 900; color: #0f243d;"><?php echo e(number_format($agentsActive, 0, ',', ' ')); ?></div>
        ...
        <article class="dashboard-v4-card dashboard-v4-panel">
            ...
            <div class="dashboard-v4-chart">
                <div class="dashboard-v4-bars">
                    <?php $__currentLoopData = $revenueSeries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="dashboard-v4-bar-item">
                            <div class="dashboard-v4-bar-track">
                                <div class="dashboard-v4-bar" style="height: <?php echo e($percent); ?>%;"></div>
                            </div>
                            <div class="dashboard-v4-bar-label"><?php echo e($item['month']); ?></div>
                            <div class="dashboard-v4-bar-value"><?php echo e(number_format($item['revenue'], 0, ',', ' ')); ?> DH</div>
                        </div>
        ...
        <article class="dashboard-v4-card dashboard-v4-panel">
            ...
            <div class="dashboard-v4-donut-wrap">
                ...
                <div class="dashboard-v4-legend">
                    <?php $__currentLoopData = $destinationShare; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="dashboard-v4-legend-item">
                            <span class="dashboard-v4-legend-left">
                                <span class="dashboard-v4-dot" style="background: <?php echo e($item['color']); ?>;"></span>
    ...
    <section class="dashboard-v4-grid grid-three">
        <article class="dashboard-v4-card dashboard-v4-panel">
            <div class="dashboard-v4-panel-head">
                ...
                <a href="<?php echo e(route('admin.reservations.workspace')); ?>" class="dashboard-v4-pill">
            ...
            <div class="dashboard-v4-table">
                <?php $__currentLoopData = $departures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="dashboard-v4-row dashboard-v4-departure-row">
                        <div>
                            <div style="font-weight: 900; color: #0f243d;"><?php echo e($item['name']); ?></div>
                            <div class="dashboard-v4-mini-meta">
                                <span><i class="bx bx-map"></i> <?php echo e($item['city']); ?></span>
                                <span><?php echo e($item['price']); ?></span>
                            </div>
                        </div>
                        <div style="font-weight: 800; color: #22354c;"><?php echo e($item['date']); ?></div>
                        <div>
                            <span class="dashboard-v4-status <?php echo e(str_contains($item['status'], 'Urgent') ? 'is-danger' : (str_contains($item['status'], 'complet') ? 'is-warn' : 'is-ok')); ?>">
                        ...
                        <div class="dashboard-v4-progress">
                            <div class="dashboard-v4-progress-meta">
                                <span><?php echo e($item['sold']); ?>/<?php echo e($item['capacity']); ?> vendus</span>
                                <span><?php echo e($remaining); ?> restants</span>
                            </div>
                            <div class="dashboard-v4-progress-bar">
                                <div class="dashboard-v4-progress-fill" style="width: <?php echo e(min(100, $progress)); ?>%;"></div>
                            </div>
                        </div>
                        <div style="display: flex; justify-content: flex-end;">
                            <a href="<?php echo e(route('admin.reservations.workspace')); ?>" class="dashboard-v4-btn is-primary" style="padding: 9px 12px;">
                ...
                <?php $__currentLoopData = $operationalAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="dashboard-v4-list-item">
                        <div class="dashboard-v4-list-head">
                            <div>
                                <p class="dashboard-v4-list-title"><?php echo e($alert['label']); ?></p>
                                <p class="dashboard-v4-list-subtitle">Suivi du pilotage quotidien</p>
                            </div>
                            <span class="dashboard-v4-pill"><?php echo e($alert['value']); ?></span>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <section class="dashboard-v4-grid grid-two">
        <article class="dashboard-v4-card dashboard-v4-panel">
            <div class="dashboard-v4-panel-head">
                ...
                <a href="<?php echo e(route('admin.reservations.index')); ?>" class="dashboard-v4-pill">Voir tout</a>
            </div>
            ...
            <div class="dashboard-v4-list">
                <?php $__currentLoopData = $recentReservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="dashboard-v4-list-item">
                        <div class="dashboard-v4-list-head">
                            <div>
                                <p class="dashboard-v4-list-title"><?php echo e($reservation['client']); ?></p>
                                <p class="dashboard-v4-list-subtitle"><?php echo e($reservation['trip']); ?> - <?php echo e($reservation['agent']); ?></p>
                            </div>
                            <div style="display: grid; justify-items: end; gap: 6px;">
                                <span class="dashboard-v4-status <?php echo e($statusClasses[$reservation['status']] ?? 'is-ok'); ?>"><?php echo e($reservation['status']); ?></span>
                                <span style="font-size: 14px; font-weight: 900; color: #0f243d;"><?php echo e($reservation['amount']); ?></span>
                            </div>
                        </div>
                        <div class="dashboard-v4-list-subtitle" style="margin-top: 8px;"><?php echo e($reservation['time']); ?></div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </article>
        ...
        <article class="dashboard-v4-card dashboard-v4-panel">
            <div class="dashboard-v4-panel-head">
                ...
                <a href="<?php echo e(route('admin.dashboard.v3')); ?>" class="dashboard-v4-pill">Comparer V3</a>
            </div>
            ...
            <div class="dashboard-v4-list">
                <?php $__currentLoopData = $salesChannels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="dashboard-v4-list-item">
                        <div class="dashboard-v4-list-head">
                            <div>
                                <p class="dashboard-v4-list-title"><?php echo e($channel['name']); ?></p>
                                <p class="dashboard-v4-list-subtitle">Répartition commerciale</p>
                            </div>
                            <span class="dashboard-v4-pill"><?php echo e($channel['value']); ?></span>
                        </div>
                        <div class="dashboard-v4-progress" style="margin-top: 12px;">
                            <div class="dashboard-v4-progress-bar">
                                <div class="dashboard-v4-progress-fill" style="width: <?php echo e($channelPercent); ?>%;"></div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="dashboard-v4-footer-actions">
        <a href="<?php echo e(route('admin.reservations.workspace')); ?>" class="dashboard-v4-floating">
