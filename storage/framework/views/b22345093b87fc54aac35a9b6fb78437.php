                ...
                <div class="dropdown d-none d-sm-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="<?php echo e(URL::asset('build/images/flags/spain.jpg')); ?>" alt="user-image" class="me-1" height="12">
                            <span class="align-middle">Spanish</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="<?php echo e(URL::asset('build/images/flags/germany.jpg')); ?>" alt="user-image" class="me-1" height="12">
                            <span class="align-middle">German</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="<?php echo e(URL::asset('build/images/flags/italy.jpg')); ?>" alt="user-image" class="me-1" height="12">
                            <span class="align-middle">Italian</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="<?php echo e(URL::asset('build/images/flags/russia.jpg')); ?>" alt="user-image" class="me-1" height="12">
            ...
            <div>
                ...
                <div class="navbar-brand-box">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo e($adminBrandLogoSmUrl); ?>" alt="<?php echo e($adminBrandName); ?>" class="admin-brand-logo-sm">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo e($adminBrandLogoDarkUrl); ?>" alt="<?php echo e($adminBrandName); ?>" class="admin-brand-logo">
                        </span>
                    </a>
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo e($adminBrandLogoLightUrl); ?>" alt="<?php echo e($adminBrandName); ?>" class="admin-brand-logo">
                        </span>
                    </a>
                </div>
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\layouts\topbar.blade.php ENDPATH**/ ?>