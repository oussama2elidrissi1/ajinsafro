...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => 'Performance points de vente','subtitle' => 'Comparatif des réservations, du chiffre d�?Taffaires et des commissions estimées par point de vente.','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Performance points de vente','subtitle' => 'Comparatif des réservations, du chiffre d�?Taffaires et des commissions estimées par point de vente.','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            ['label' => 'Admin', 'url' => route('admin.dashboard')],
            ['label' => 'Points de vente', 'url' => route('admin.agencies.index')],
            ['label' => 'Performance'],
        ])]); ?>
