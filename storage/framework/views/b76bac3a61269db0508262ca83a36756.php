...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => 'Performance points de vente','subtitle' => 'Comparatif des rÃ©servations, du chiffre dâ€™affaires et des commissions estimÃ©es par point de vente.','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Performance points de vente','subtitle' => 'Comparatif des rÃ©servations, du chiffre dâ€™affaires et des commissions estimÃ©es par point de vente.','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            ['label' => 'Admin', 'url' => route('admin.dashboard')],
            ['label' => 'Points de vente', 'url' => route('admin.agencies.index')],
            ['label' => 'Performance'],
        ])]); ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center border rounded-3 px-3 py-2">
                                <div>
                                    ...
                                    <div class="text-muted small">
                                        <?php echo e($row['employee']->branch?->name ?: 'â€”'); ?> Â· <?php echo e($row['employee']->position ?: 'â€”'); ?>

                                    </div>
                                </div>
                                <span class="aj-badge aj-badge-info"><?php echo e($row['count']); ?> rÃ©sa</span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.admin-v6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\agencies\performance.blade.php ENDPATH**/ ?>