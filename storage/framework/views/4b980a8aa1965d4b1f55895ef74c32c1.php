...
<div class="voyage-edit-page">
    ...
    <form id="create-voyage-form" action="<?php echo e(route('admin.circuits.voyages.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="ve-shell">
    <?php if($errors->any()): ?>
    ...
    <?php endif; ?>
        ...
        ?>
                    ...
                    <div class="flight-card-view" id="create-flight-0-card-view">
                        <div class="flight-card-admin" style="min-width: 320px;">
                            <div class="flight-card-header">
                                <span class="flight-card-title">�o^ FLIGHT �?� <span id="create-flight-0-dep-label"><?php echo e(old('flights.0.depart_airport') ?: old('flights.0.depart_city') ?: $flightDash); ?></span> to <span id="create-flight-0-arr-label"><?php echo e(old('flights.0.arrive_airport') ?: old('flights.0.arrive_city') ?: $flightDash); ?></span></span>
                            ...
                            <div class="flight-card-body">
                                ...
                                <div class="flight-card-col flight-card-baggage">
                                    <div>Cabin: <span id="create-flight-0-cabin-bag"><?php echo e(old('flights.0.cabin_baggage') ?: $flightDash); ?></span></div>
                                    <div>Check-in: <span id="create-flight-0-checkin-bag"><?php echo e(old('flights.0.checkin_baggage') ?: $flightDash); ?></span></div>
                                </div>
                            </div>
                            <div class="flight-card-badge-wrap">
                                <span class="flight-badge-tentative" id="create-flight-0-tentative-badge" style="display:<?php echo e(old('flights.0.is_tentative') ? 'inline-block' : 'none'); ?>">Tentative Flight</span>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6"><label class="form-label">Type de cabine</label>
                                <select class="form-select" name="flights[0][cabin_class]">
                                    <?php $__currentLoopData = \App\Models\TourFlight::cabinOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-12"><input type="hidden" name="flights[0][is_default]" id="create_flights_0_is_default" value="<?php echo e($hasSecondFlightCreate ? (old('flights.0.is_default', true) ? '1' : '0') : '1'); ?>"></div>
                ...
                <div class="flight-block" id="create-flight-2-block" style="<?php echo e($hasSecondFlightCreate ? '' : 'display:none;'); ?>">
                    <div class="flight-card-view" id="create-flight-1-card-view">
                        <div class="flight-card-admin" style="min-width: 320px;">
                            <div class="flight-card-header">
                                <span class="flight-card-title">�o^ FLIGHT �?� <span id="create-flight-1-dep-label"><?php echo e(old('flights.1.departure_airport') ?: $flightDash); ?></span> to <span id="create-flight-1-arr-label"><?php echo e(old('flights.1.arrival_airport') ?: $flightDash); ?></span></span>
                            ...
                            <div class="flight-card-body">
                                ...
                                <div class="flight-card-col flight-card-baggage">
                                    <div>Cabin: <span id="create-flight-1-cabin-bag"><?php echo e(old('flights.1.cabin_baggage') ?: $flightDash); ?></span></div>
                                    <div>Check-in: <span id="create-flight-1-checkin-bag"><?php echo e(old('flights.1.checkin_baggage') ?: $flightDash); ?></span></div>
                                </div>
                            </div>
                            <div class="flight-card-badge-wrap">
                                <span class="flight-badge-tentative" id="create-flight-1-tentative-badge" style="display:<?php echo e(old('flights.1.is_tentative') ? 'inline-block' : 'none'); ?>">Tentative Flight</span>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="tours_program_style" id="tours_program_style" class="form-select">
                                <option value="style1" <?php echo e(old('tours_program_style', 'style1') === 'style1' ? 'selected' : ''); ?>>Style 1</option>
                                <option value="style2" <?php echo e(old('tours_program_style') === 'style2' ? 'selected' : ''); ?>>Style 2</option>
                                <option value="style3" <?php echo e(old('tours_program_style') === 'style3' ? 'selected' : ''); ?>>Style 3</option>
                            </select>
                ...
                <div class="card ve-sidebar-card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="adult_price" name="adult_price" value="<?php echo e(old('adult_price')); ?>" step="0.01" min="0" placeholder="5000">
                        </div>

                        <div class="mb-3">
                            <label for="child_price" class="form-label">Prix Enfant (MAD)</label>
                            <input type="number" class="form-control" id="child_price" name="child_price" value="<?php echo e(old('child_price')); ?>" step="0.01" min="0" placeholder="3000">
                        </div>

                        <div class="mb-3">
                            <label for="min_price" class="form-label">Prix Minimum (MAD)</label>
                            <input type="number" class="form-control" id="min_price" name="min_price" value="<?php echo e(old('min_price')); ?>" step="0.01" min="0">
                        </div>

                        <div class="mb-3">
                            <label for="min_people" class="form-label">Nombre min. de personnes</label>
                            <input type="number" class="form-control" id="min_people" name="min_people" value="<?php echo e(old('min_people')); ?>" min="1" placeholder="2">
                        </div>
                        
                        <div class="mb-3">
                            <label for="max_people" class="form-label">Nombre max. de personnes</label>
                            <input type="number" class="form-control" id="max_people" name="max_people" value="<?php echo e(old('max_people')); ?>" min="1" placeholder="15">
                        </div>

                        <div class="mb-3">
                            <label for="hero_image_id" class="form-label">Image principale du voyage (Hero / Cover)</label>
                            <input type="number" class="form-control" id="hero_image_id" name="hero_image_id" value="<?php echo e(old('hero_image_id')); ?>" placeholder="Ex. 14434" min="0">
                        </div>
                            ...
                            <div id="hero-gallery-container" class="row g-2">
                                <?php for($i = 0; $i < 5; $i++): ?>
                                    ...
                                    <div class="col-6 col-md-4">
                                        <div class="hero-gallery-item border rounded p-2 bg-white" data-index="<?php echo e($i); ?>" style="font-size: 12px;">
                                            <label class="form-label small mb-1 d-block">
                                                Image <?php echo e($i === 0 ? 'Principale' : ($i + 1)); ?>

                                            </label>
                                            <div class="hero-gallery-preview-wrap mb-2" style="width: 100%; height: 100px; border: 1px solid #ddd; border-radius: 4px; overflow: hidden; background: #f8f9fa; display: <?php echo e($img_url ? 'block' : 'none'); ?>;">
                                            ...
                                            <div class="hero-gallery-placeholder mb-2" style="width: 100%; height: 100px; border: 2px dashed #ddd; border-radius: 4px; display: flex; align-items: center; justify-content: center; background: #f8f9fa; <?php echo e($img_url ? 'display: none;' : ''); ?>">
                                                <span class="text-muted" style="font-size: 11px;">Aucune image</span>
                                            </div>
                                            <div class="d-flex gap-1 flex-wrap">
                                                <button type="button" class="btn btn-outline-primary btn-sm hero-gallery-upload-btn" data-index="<?php echo e($i); ?>" style="font-size: 10px; padding: 2px 6px;">
                                                    <i class="bx bx-upload"></i> Upload
                                                </button>
                                                <button type="button" class="btn btn-outline-secondary btn-sm hero-gallery-choose-btn" data-index="<?php echo e($i); ?>" style="font-size: 10px; padding: 2px 6px;">
                                                    <i class="bx bx-images"></i> Choisir
                                                </button>
                                                <button type="button" class="btn btn-outline-danger btn-sm hero-gallery-remove-btn" data-index="<?php echo e($i); ?>" style="font-size: 10px; padding: 2px 6px;" <?php echo e(!$img_id ? 'disabled' : ''); ?>>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const oldProgramItems = <?php echo json_encode(old('tours_program', []), 512) ?>;
        ...
        var heroGalleryUploadUrl = "<?php echo e(route('admin.circuits.voyages.hero-image.upload', ['id' => 0])); ?>"; // Will be updated after tour creation
        ...
        document.querySelectorAll('.hero-gallery-choose-btn').forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                if (id && !isNaN(id) && parseInt(id) > 0) {
                    ...
                    fetch('<?php echo e(url("admin/wp-media/get")); ?>/' + id, {
