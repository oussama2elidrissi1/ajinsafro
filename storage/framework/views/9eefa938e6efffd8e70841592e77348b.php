...
<div class="ws-pax-page px-2 px-md-0">
    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3 mb-4">
        <div>
            <a href="<?php echo e(route('admin.reservations.workspace')); ?>"
            ...
            <?php if($wpTourTitle && $wpTourTitle !== $voyage->name): ?>
                <p class="small text-muted mb-0 mt-1"><i class="fas fa-database me-1"></i>Fiche Laravel : <?php echo e($voyage->name); ?></p>
            <?php endif; ?>
        </div>
