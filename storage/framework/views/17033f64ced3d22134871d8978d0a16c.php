    ...
    <div class="reservation-create">
        ...
        <form method="post" action="<?php echo e(route('admin.reservations.store')); ?>" enctype="multipart/form-data" id="reservation-create-form">
            ...
            <div class="reservation-create__layout">
                <?php echo $__env->make('admin.reservations.create.partials.stepper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.admin-v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\reservations\create.blade.php ENDPATH**/ ?>