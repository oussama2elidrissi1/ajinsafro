            ...
            <div class="card mb-3 shadow-sm">
                <div class="card-body p-3">
                    ...
                    <div class="mail-list mt-4">
                        <a href="<?php echo e(route('admin.reservations.messages', ['folder' => 'inbox'])); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e(($folder ?? '') === 'inbox' && !request('branch_id') && !request('label_id') ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
                            <i class="bx bx-inbox me-2 font-size-18"></i>
                            <span>Inbox</span>
                            <span class="ms-auto">(<?php echo e($inboxCount); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('admin.reservations.messages', ['folder' => 'unread'])); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e(($folder ?? '') === 'unread' ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
                            <i class="bx bx-envelope me-2 font-size-18"></i>
                            <span>Non lus</span>
                            <span class="ms-auto">(<?php echo e($unreadCount); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('admin.reservations.messages', ['folder' => 'starred'])); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e(($folder ?? '') === 'starred' ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
                            <i class="bx bx-star me-2 font-size-18"></i>
                            <span>Starred</span>
                            <span class="ms-auto">(<?php echo e($starredCount); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('admin.reservations.messages', ['folder' => 'important'])); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e(($folder ?? '') === 'important' ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
                            <i class="bx bx-diamond me-2 font-size-18"></i>
                            <span>Important</span>
                            <span class="ms-auto">(<?php echo e($importantCount); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('admin.reservations.messages', ['folder' => 'draft'])); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e(($folder ?? '') === 'draft' ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
                            <i class="bx bx-file me-2 font-size-18"></i>
                            <span>Draft</span>
                            <span class="ms-auto">(<?php echo e($draftCount); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('admin.reservations.messages', ['folder' => 'sent'])); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e(($folder ?? '') === 'sent' ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
                            <i class="bx bx-send me-2 font-size-18"></i>
                            <span>Sent Mail</span>
                            <span class="ms-auto">(<?php echo e($sentCount); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('admin.reservations.messages', ['folder' => 'trash'])); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e(($folder ?? '') === 'trash' ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
                    ...
                    <div class="mail-list">
                        <?php $__currentLoopData = $labels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('admin.reservations.messages', ['label_id' => $label->id])); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e((int)request('label_id') === (int)$label->id ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
                    ...
                    <div class="mail-list">
                        <a href="<?php echo e(route('admin.reservations.messages')); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e(!request('branch_id') ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
                            <i class="bx bx-building-house me-2"></i> Toutes
                        </a>
                        <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('admin.reservations.messages', ['branch_id' => $b->id])); ?>" class="d-flex align-items-center py-2 px-2 rounded <?php echo e((int)request('branch_id') === (int)$b->id ? 'bg-primary bg-opacity-10 text-primary' : 'text-body'); ?>">
            ...
            <div class="card shadow-sm">
                <div class="btn-toolbar msg-toolbar p-3 border-bottom flex-wrap gap-2" role="toolbar">
                    <div class="btn-group btn-group-sm">
                        <a href="<?php echo e(route('admin.reservations.messages', ['folder' => 'inbox'])); ?>" class="btn btn-primary" title="Inbox"><i class="bx bx-inbox"></i></a>
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <ul class="dropdown-menu">
                            <?php $__currentLoopData = $labels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <form action="<?php echo e(route('admin.reservations.messages', ['label_id' => $label->id])); ?>" method="get" class="d-inline">
                    ...
                    <div class="btn-group btn-group-sm ms-auto">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.reservations.messages', ['folder' => 'unread'])); ?>">Non lus</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.reservations.messages', ['folder' => 'important'])); ?>">Important</a></li>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="list-group-item list-group-item-action d-flex align-items-start py-3 <?php echo e($isUnread ? 'bg-info bg-opacity-10' : ''); ?>" data-message-id="<?php echo e($msg->id); ?>">
                            ...
                            <div class="me-2 mt-1">
                                <form action="<?php echo e(route('admin.reservations.messages.star', $msg->id)); ?>" method="post" class="d-inline">
                                    ...
                                    <button type="submit" class="btn btn-link p-0 border-0 text-warning">
                                        <i class="bx <?php echo e($isStarred ? 'bxs-star' : 'bx-star'); ?> font-size-18"></i>
                                    </button>
                                </form>
                            </div>
                            <a href="<?php echo e(route('admin.reservations.messages.show', $msg->id)); ?>" class="flex-grow-1 min-w-0 text-decoration-none text-body">
                                ...
                                <div class="mt-1">
                                    <?php if($msg->label): ?>
                                        <span class="badge bg-<?php echo e($msg->label->color); ?> me-2"><?php echo e($msg->label->name); ?></span>
                                    <?php endif; ?>
                                    <?php echo e(Str::limit($msg->subject, 70)); ?>
                ...
                <?php if($messages->hasPages()): ?>
                    <div class="p-2 border-top"><?php echo e($messages->links()); ?></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
