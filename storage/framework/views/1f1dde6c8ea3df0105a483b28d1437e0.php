...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('admin.wordpress.transfers.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <?php echo $__env->make('admin.wordpress.transfers._form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="mt-3">
