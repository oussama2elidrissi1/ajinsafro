            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-3 align-items-center">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="rounded avatar-xl" alt=" ">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="rounded-top avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="rounded-end avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="rounded-bottom avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="rounded-start avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" class="rounded-circle avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" class="rounded-pill w-25 h-auto">
                    </div>
                </div>
            </div>
        </div><!-- end col -->
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="rounded-0 avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="rounded-1 avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="rounded-2 avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="rounded-3 avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="rounded-4 avatar-xl" alt="">
                        <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" class="rounded-5 avatar-xl" alt="">
                    </div>
                </div><!-- end cardbody -->
            </div><!-- end card -->
        </div><!-- end col -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\ui-general.blade.php ENDPATH**/ ?>