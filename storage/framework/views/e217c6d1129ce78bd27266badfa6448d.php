            ...
            <div class="col-md-6 col-xl-4">
                <div class="card border shadow-sm h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="text-muted small mb-2">Cl̩ : <code><?php echo e($g['key']); ?></code></p>
                        <p class="mb-3"><span class="badge bg-light text-dark border"><?php echo e($g['count']); ?> valeur(s)</span></p>
                        <a href="<?php echo e(route('admin.settings.referentiels-metier.group', ['groupKey' => $g['key']])); ?>" class="btn btn-primary btn-sm mt-auto">G̩rer</a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin-v6', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\admin\settings\business_references\index.blade.php ENDPATH**/ ?>