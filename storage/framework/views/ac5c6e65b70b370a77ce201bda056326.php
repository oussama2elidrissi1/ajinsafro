        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <p class="mb-1 font-size-18 fw-medium">�? partir de <?php echo e(number_format($voyage->price_from ?? 0, 0, ',', ' ')); ?> <?php echo e($voyage->currency_symbol); ?></p>
                    ...
                    <?php if($voyage->discount_percent !== null && $voyage->discount_percent > 0): ?>
                        <div class="col-md-6 text-md-end">
                            ...
                            <span class="badge bg-success font-size-14">�?conomie : <?php echo e(number_format($voyage->discount_amount, 0, ',', ' ')); ?> <?php echo e($voyage->currency_symbol); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
