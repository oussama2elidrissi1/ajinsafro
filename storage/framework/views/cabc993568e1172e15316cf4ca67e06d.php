...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div class="p-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-gray-50/50">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <div class="agent-dashboard-range inline-flex items-center rounded-xl border border-gray-200 bg-white p-1">
                    ...
                    ?>
                    <a class="<?php echo e($btn); ?>" href="<?php echo e(request()->fullUrlWithQuery(['range' => 'today'])); ?>" aria-current="<?php echo e($range === 'today' ? 'page' : 'false'); ?>">Today</a>
                    <a class="<?php echo e($btn); ?>" href="<?php echo e(request()->fullUrlWithQuery(['range' => 'week'])); ?>" aria-current="<?php echo e($range === 'week' ? 'page' : 'false'); ?>">This week</a>
                    <a class="<?php echo e($btn); ?>" href="<?php echo e(request()->fullUrlWithQuery(['range' => 'month'])); ?>" aria-current="<?php echo e($range === 'month' ? 'page' : 'false'); ?>">This month</a>
                    <a class="<?php echo e($btn); ?>" href="<?php echo e(request()->fullUrlWithQuery(['range' => null])); ?>" aria-current="<?php echo e($range === null ? 'page' : 'false'); ?>">All</a>
                </div>
                <?php if($reservationsListUrl): ?>
                    <a href="<?php echo e($reservationsListUrl); ?>" class="text-[10px] font-bold text-[#0083c4] hover:underline uppercase tracking-wider">Voir tout</a>
                <?php endif; ?>
            </div>
        </div>
            ...
            <table class="w-full text-left border-collapse whitespace-nowrap min-w-[720px]">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentReservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="py-4 px-6 font-semibold text-gray-800"><?php echo e($reservation->id); ?></td>
                        ...
                        <?php if($isManager): ?>
                            <td class="py-4 px-6 text-xs text-gray-600"><?php echo e($reservation->agent?->name ?? '—'); ?></td>
                        <?php endif; ?>
                        <td class="py-4 px-6">
                            <?php
                        ...
                        <td class="py-4 px-6 text-gray-500"><?php echo e(optional($reservation->created_at)->format('d/m/Y H:i')); ?></td>
                        <td class="py-4 px-6 text-right font-bold text-gray-800">
                            <?php echo e(number_format((float) ($reservation->paid_amount ?? 0), 0, ',', ' ')); ?> DH
                        </td>
                        <td class="py-4 px-6 text-right">
                            <?php if($canOpenReservation): ?>
                                <a href="<?php echo e(route('admin.reservations.show', $reservation)); ?>" class="text-[#0083c4] font-bold text-xs hover:underline">Ouvrir</a>
                            <?php else: ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr><td colspan="<?php echo e($isManager ? 8 : 7); ?>" class="py-10 px-6 text-center text-gray-500">Aucune réservation trouvée.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-custom border border-gray-100 flex flex-col overflow-hidden">
        <div class="p-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
            ...
            <?php if(Route::has('admin.customers.clients.index') && auth()->user()->can('customers.clients.view')): ?>
                <a href="<?php echo e(route('admin.customers.clients.index')); ?>" class="text-[10px] font-bold text-[#0083c4] hover:underline uppercase tracking-wider">Voir tout</a>
            <?php endif; ?>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="py-4 px-5 font-semibold text-gray-800"><?php echo e($client->client_code); ?></td>
                        <td class="py-4 px-5 text-gray-700"><?php echo e($client->full_name ?: trim(($client->first_name ?? '') . ' ' . ($client->last_name ?? ''))); ?></td>
                        <td class="py-4 px-5 text-gray-500"><?php echo e($client->email ?: ($client->phone ?: '—')); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\agent\partials\dashboard-tables.blade.php ENDPATH**/ ?>