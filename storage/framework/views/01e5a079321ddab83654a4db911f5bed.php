...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">Fiche client â€“ <?php echo e($client->full_name); ?></h4>
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <a href="<?php echo e(route('admin.customers.clients.index')); ?>" class="btn btn-outline-secondary btn-sm">Retour Ã  la liste</a>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">RÃ©sumÃ©</h5>
                    ...
                    <p class="mb-1"><strong>Type :</strong>
                        <span class="badge <?php echo e($client->client_type === 'company' ? 'bg-info' : ($client->client_type === 'agency' ? 'bg-secondary' : 'bg-light text-dark')); ?>">
                            <?php echo e($client->client_type === 'individual' ? 'Particulier' : ($client->client_type === 'company' ? 'SociÃ©tÃ©' : 'Agence')); ?>
                    ...
                    <?php if($client->assignedTo): ?>
                        <p class="mb-1"><strong>AssignÃ© Ã  :</strong> <?php echo e($client->assignedTo->name); ?></p>
                    <?php endif; ?>
                    <p class="mb-0 small text-muted">CrÃ©Ã© le <?php echo e($client->created_at->format('d/m/Y H:i')); ?>

                        <?php if($client->updated_at && $client->updated_at != $client->created_at): ?>
                            Â· ModifiÃ© le <?php echo e($client->updated_at->format('d/m/Y H:i')); ?>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <h5 class="card-title">CoordonnÃ©es</h5>
                    <?php if($client->email): ?><p class="mb-1"><a href="mailto:<?php echo e($client->email); ?>"><?php echo e($client->email); ?></a></p><?php endif; ?>
                    <?php if($client->phone): ?><p class="mb-1">TÃ©l : <?php echo e($client->phone); ?></p><?php endif; ?>
        ...
        <div class="col-lg-8">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <p class="mb-1"><strong>Passeport :</strong> <?php echo e($client->passport_number ?? 'â€”'); ?> <?php if($client->passport_expiry_date): ?> (exp. <?php echo e($client->passport_expiry_date->format('d/m/Y')); ?>) <?php endif; ?></p>
                    <p class="mb-1"><strong>CIN / ID :</strong> <?php echo e($client->national_id_number ?? 'â€”'); ?></p>
                    <p class="mb-0"><strong>Visa :</strong> <?php echo e($client->visa_required ? 'Requis â€“ ' . $client->visa_status : 'Non requis'); ?></p>
                </div>
            </div>

            <div class="card mb-3">
                <div class="card-body">
                    <h5 class="card-title">PrÃ©fÃ©rences voyage</h5>
                    <p class="mb-1"><strong>CatÃ©gorie :</strong> <?php echo e($client->traveler_category ?? 'â€”'); ?></p>
                    <p class="mb-1"><strong>Destination prÃ©fÃ©rÃ©e :</strong> <?php echo e($client->preferred_destination ?? 'â€”'); ?></p>
                    <p class="mb-1"><strong>Budget :</strong> <?php echo e($client->budget_display ?? 'â€”'); ?></p>
                    <?php if($client->special_requests): ?>
                        <p class="mb-0"><strong>Demandes spÃ©ciales :</strong><br><?php echo e($client->special_requests); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <?php if($client->company_name || $client->billing_name): ?>
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <?php if($client->company_name): ?><p class="mb-1"><strong>SociÃ©tÃ© :</strong> <?php echo e($client->company_name); ?></p><?php endif; ?>
            ...
            <div class="card mb-3 border-secondary">
                <div class="card-body">
                    <h5 class="card-title text-muted">RÃ©servations / Devis / Paiements</h5>
                    <p class="text-muted small mb-0">Ã€ venir : liens vers les rÃ©servations, devis et paiements associÃ©s Ã  ce client.</p>
                </div>
            </div>
        </div>
    </div>
