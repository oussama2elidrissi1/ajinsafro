...
<?php $__env->startSection('content'); ?>
            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.settings.index')); ?>">Param�f¨tres</a></li>
    ...
    <ul class="nav nav-tabs mb-4" role="tablist">
        <li class="nav-item">
            <a class="nav-link <?php echo e(($tab ?? 'header') === 'header' ? 'active' : ''); ?>" data-bs-toggle="tab" href="#tab-header" role="tab">Header</a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo e(($tab ?? 'header') === 'content' ? 'active' : ''); ?>" data-bs-toggle="tab" href="#tab-content" role="tab">Contenu</a>
        </li>
    </ul>
    ...
    <div class="tab-pane fade <?php echo e(($tab ?? 'header') === 'header' ? 'show active' : ''); ?>" id="tab-header" role="tabpanel">
        <form action="<?php echo e(url('/admin/settings/home-page/header')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        ...
                        <label class="form-check-label" for="hdr_enabled">Activer le header personnalis�f©</label>
                    </div>
                    <div class="form-check form-switch mb-3">
                        ...
                        <label class="form-check-label" for="hdr_sitewide">Appliquer le header �f  toutes les pages WordPress</label>
                    </div>
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="hdr_footer_sitewide">Appliquer le footer personnalis�f© �f  toutes les pages</label>
                    </div>
                    <p class="small text-muted mt-1 mb-0">Le header et le footer personnalis�f©s remplacent ceux du th�f¨me WordPress sur toutes les pages.</p>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="header[topbar_enabled]" value="1" id="hdr_topbar"
                               <?php echo e(old('header.topbar_enabled', data_get($header, 'topbar_enabled')) ? 'checked' : ''); ?>>
                        <label class="form-check-label" for="hdr_topbar">Afficher la topbar</label>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">T�f©l�f©phone</label>
                    ...
                    <h6 class="mt-3 mb-2">R�f©seaux sociaux</h6>
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label">Facebook</label>
                            <input type="url" class="form-control" name="header[socials][facebook]"
                                   value="<?php echo e(old('header.socials.facebook', data_get($header, 'socials.facebook'))); ?>" placeholder="https://...">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Twitter / X</label>
                            <input type="url" class="form-control" name="header[socials][twitter]"
                                   value="<?php echo e(old('header.socials.twitter', data_get($header, 'socials.twitter'))); ?>" placeholder="https://...">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">YouTube</label>
                            <input type="url" class="form-control" name="header[socials][youtube]"
                                   value="<?php echo e(old('header.socials.youtube', data_get($header, 'socials.youtube'))); ?>" placeholder="https://...">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Instagram</label>
                            <input type="url" class="form-control" name="header[socials][instagram]"
                                   value="<?php echo e(old('header.socials.instagram', data_get($header, 'socials.instagram'))); ?>" placeholder="https://...">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">LinkedIn</label>
                            <input type="url" class="form-control" name="header[socials][linkedin]"
                                   value="<?php echo e(old('header.socials.linkedin', data_get($header, 'socials.linkedin'))); ?>" placeholder="https://...">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="header[navbar_enabled]" value="1" id="hdr_navbar"
                               <?php echo e(old('header.navbar_enabled', data_get($header, 'navbar_enabled')) ? 'checked' : ''); ?>>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="url" class="form-control" name="header[logo_url]"
                                   value="<?php echo e(old('header.logo_url', data_get($header, 'logo_url'))); ?>" placeholder="https://...">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Upload logo</label>
                            <input type="file" class="form-control" name="header[logo_file]" accept="image/*">
                        </div>
                        <?php if(data_get($header, 'logo_url')): ?>
                            <div class="col-12">
                                <img src="<?php echo e(data_get($header, 'logo_url')); ?>" alt="Logo" style="max-height:50px">
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="header[show_auth_links]" value="1" id="hdr_auth"
                                       <?php echo e(old('header.show_auth_links', data_get($header, 'show_auth_links')) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="header[login_url]"
                                   value="<?php echo e(old('header.login_url', data_get($header, 'login_url', '/login'))); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Sign Up URL</label>
                            <input type="text" class="form-control" name="header[signup_url]"
                                   value="<?php echo e(old('header.signup_url', data_get($header, 'signup_url', '/register'))); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="header[menu_source]" id="hdr_menu_source">
                                <option value="wp_menu" <?php echo e(old('header.menu_source', data_get($header, 'menu_source')) === 'wp_menu' ? 'selected' : ''); ?>>Menu WordPress</option>
                                <option value="laravel_links" <?php echo e(old('header.menu_source', data_get($header, 'menu_source')) === 'laravel_links' ? 'selected' : ''); ?>>Liens manuels</option>
                            </select>
                        </div>
                        <div class="col-md-4" id="hdr_wp_menu_wrap">
                            ...
                            <input type="text" class="form-control" name="header[wp_menu_location]"
                                   value="<?php echo e(old('header.wp_menu_location', data_get($header, 'wp_menu_location', 'primary'))); ?>" placeholder="primary">
                        </div>
                    </div>
                    ...
                    <div id="hdr_links_wrap" class="mt-3" style="display:none">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <small class="text-muted"><i class="fas fa-arrows-alt"></i> Utilisez les fl�f¨ches pour r�f©organiser l'ordre</small>
                        </div>
                        <div id="hdr-links-container" class="vstack gap-3">
                            <?php $__currentLoopData = old('header.links', data_get($header, 'links', [])); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $li => $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="border rounded p-3 hdr-link-row bg-light" data-index="<?php echo e($li); ?>">
                                    <input type="hidden" name="header[links][<?php echo e($li); ?>][order]" class="hdr-link-order" value="<?php echo e(data_get($link, 'order', $li + 1)); ?>">
                                    <div class="row g-2 align-items-center mb-2">
                                        ...
                                        <div class="col-auto text-center" style="min-width:40px">
                                            <span class="badge bg-primary hdr-order-display"><?php echo e(data_get($link, 'order', $li + 1)); ?></span>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label small mb-0">Texte</label>
                                            <input class="form-control form-control-sm" name="header[links][<?php echo e($li); ?>][label]" value="<?php echo e(data_get($link, 'label')); ?>" placeholder="Ex: HOTEL">
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <label class="form-label small mb-0">Ic�f´ne FA</label>
                                        ...
                                        <div class="col-auto d-flex align-items-end gap-2">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="header[links][<?php echo e($li); ?>][active]" value="1" <?php echo e(data_get($link, 'active') ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-auto d-flex align-items-end"><button type="button" class="btn btn-sm btn-outline-danger hdr-remove-link">�f�?"</button></div>
                                    </div>
                                    ...
                                    <div class="hdr-children-list ms-4 ps-3 border-start border-2 border-primary">
                                        ...
                                        <?php $__currentLoopData = data_get($link, 'children', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ci => $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="row g-2 align-items-center mb-1 hdr-child-row bg-white rounded p-1" data-child-index="<?php echo e($ci); ?>">
                                                <input type="hidden" name="header[links][<?php echo e($li); ?>][children][<?php echo e($ci); ?>][order]" class="hdr-child-order" value="<?php echo e(data_get($child, 'order', $ci + 1)); ?>">
                                                ...
                                                <div class="col-2"><input class="form-control form-control-sm" name="header[links][<?php echo e($li); ?>][children][<?php echo e($ci); ?>][icon]" value="<?php echo e(data_get($child, 'icon', '')); ?>" placeholder="Ic�f´ne FA"></div>
                                                <div class="col-auto"><button type="button" class="btn btn-sm btn-outline-danger hdr-remove-child py-0 px-1">�f�?"</button></div>
                                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="small text-muted mb-3">Ce bouton s'affiche �f  droite de la navbar avec un effet de gradient orange/rouge et une animation.</p>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">Texte du bouton</label>
                            <input type="text" class="form-control" name="header[lowcost_text]"
                                   value="<?php echo e(old('header.lowcost_text', data_get($header, 'lowcost_text', 'Formule low cost'))); ?>" placeholder="Formule low cost">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">URL du bouton</label>
                            <input type="text" class="form-control" name="header[lowcost_url]"
                                   value="<?php echo e(old('header.lowcost_url', data_get($header, 'lowcost_url', '#'))); ?>" placeholder="/low-cost">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="tab-pane fade <?php echo e(($tab ?? 'header') === 'content' ? 'show active' : ''); ?>" id="tab-content" role="tabpanel">
        <form action="<?php echo e(route('admin.settings.home-page.update')); ?>" method="POST" enctype="multipart/form-data" id="home-page-settings-form">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="hero[type]" id="hero_type" required>
                                ...
                                <option value="video" <?php echo e(old('hero.type', data_get($settings, 'hero.type')) === 'video' ? 'selected' : ''); ?>>Vid�f©o</option>
                            </select>
                        </div>
                        <div class="col-md-8">
                            <label class="form-label">Titre</label>
                            <input type="text" class="form-control" name="hero[title]" value="<?php echo e(old('hero.title', data_get($settings, 'hero.title'))); ?>" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label">Sous-titre</label>
                            <input type="text" class="form-control" name="hero[subtitle]" value="<?php echo e(old('hero.subtitle', data_get($settings, 'hero.subtitle'))); ?>">
                        </div>
                        <div class="col-md-6" id="hero_image_url_wrap">
                            <label class="form-label">Image URL</label>
                            <input type="url" class="form-control" name="hero[image_url]" value="<?php echo e(old('hero.image_url', data_get($settings, 'hero.image_url'))); ?>" placeholder="https://...">
                        </div>
                        ...
                        <div class="col-md-6" id="hero_video_url_wrap">
                            <label class="form-label">Vid�f©o URL (YouTube/Vimeo/mp4)</label>
                        ...
                        <div class="col-md-6" id="hero_video_file_wrap">
                            ...
                            <small class="text-muted d-block mt-1">Max 50MB. Si l'upload �f©choue, utilisez un lien vid�f©o.</small>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="hero[cta_text]" value="<?php echo e(old('hero.cta_text', data_get($settings, 'hero.cta_text'))); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">CTA URL</label>
                            <input type="url" class="form-control" name="hero[cta_url]" value="<?php echo e(old('hero.cta_url', data_get($settings, 'hero.cta_url'))); ?>" placeholder="https://...">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="range" class="form-range" min="0" max="1" step="0.01" name="hero[overlay]" id="hero_overlay"
                                   value="<?php echo e(old('hero.overlay', data_get($settings, 'hero.overlay', 0.35))); ?>">
                            <small class="text-muted">Valeur: <span id="hero_overlay_value"><?php echo e(old('hero.overlay', data_get($settings, 'hero.overlay', 0.35))); ?></span></small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php
                $sectionLabels = [
                    ...
                    'accommodations' => 'S�f©jours uniques',
                    'holiday_theme' => 'Voyages par th�f¨me',
                    'regions' => 'Destinations',
                    'good_spots' => 'Bons coins',
                    'whatsapp_banner' => 'Banni�f¨re WhatsApp',
                    'cruises' => 'Croisi�f¨res',
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <h5 class="card-title mb-0">Ordre et visibilit�f© des sections</h5>
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary" id="section-add-custom">Section personnalis�f©e</button>
                    </div>
                </div>
                <div class="card-body">
                    <p class="text-muted small mb-3">R�f©ordonnez les sections avec les fl�f¨ches. D�f©cochez pour masquer une section sur la page d'accueil.</p>
                    <div id="section-order-container" class="vstack gap-2">
                        <?php $__currentLoopData = $sectionOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $secKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(str_starts_with((string)$secKey, 'custom_')): ?>
                                <?php $custom = $customSections[$secKey] ?? ['title' => '', 'content' => '']; ?>
                                <div class="border rounded p-3 section-order-row bg-light" data-section-key="<?php echo e($secKey); ?>">
                                    ...
                                    <div class="d-flex align-items-start gap-2 flex-wrap">
                                        <div class="d-flex flex-column gap-0">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-secondary section-move-down" title="Descendre">â�?��?o</button>
                                        </div>
                                        <div class="form-check form-switch align-self-center">
                                            <input class="form-check-input" type="checkbox" name="sections[<?php echo e($secKey); ?>]" value="1"
                                                   <?php echo e(old("sections.$secKey", data_get($settings, "sections.$secKey", true)) ? 'checked' : ''); ?>>
                                            <label class="form-check-label">Activer</label>
                                        </div>
                                        <div class="flex-grow-1">
                                            <label class="form-label small mb-0">Section personnalis�f©e â�,��?� Titre</label>
                                        ...
                                        <div class="align-self-center">
                                            <button type="button" class="btn btn-sm btn-outline-danger section-remove">�f�?"</button>
                                        </div>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="border rounded p-2 section-order-row d-flex align-items-center gap-2" data-section-key="<?php echo e($secKey); ?>">
                                    ...
                                    <div class="ms-auto">
                                        <button type="button" class="btn btn-sm btn-outline-secondary section-remove" title="Retirer de la liste">�f�?"</button>
                                    </div>
                                </div>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="sections[search]" value="1"
                               <?php echo e(old('sections.search', data_get($settings, 'sections.search', true)) ? 'checked' : ''); ?>>
                        <label class="form-check-label">Afficher la barre de recherche dans le hero</label>
                    </div>
                    <label class="form-label">Shortcode</label>
                    <input type="text" class="form-control" name="search[shortcode]" value="<?php echo e(old('search.shortcode', data_get($settings, 'search.shortcode', '[traveler_search]'))); ?>">
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body row g-3">
                    <div class="col-md-6">
                        <label class="form-label">Titre</label>
                        <input type="text" class="form-control" name="last_minute[title]" value="<?php echo e(old('last_minute.title', data_get($settings, 'last_minute.title', 'Cap sur les tendances du moment'))); ?>" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Nombre d'items</label>
                        <input type="number" class="form-control" min="1" max="20" name="last_minute[count]" value="<?php echo e(old('last_minute.count', data_get($settings, 'last_minute.count', 4))); ?>" required>
                    </div>
                    <div class="col-md-3 d-flex align-items-end">
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" name="last_minute[featured_only]" value="1"
                                   <?php echo e(old('last_minute.featured_only', data_get($settings, 'last_minute.featured_only')) ? 'checked' : ''); ?>>
            ...
            <div class="card">
                <div class="card-header"><h5 class="card-title mb-0">D�f©couvrez des s�f©jours uniques</h5></div>
                <div class="card-body row g-3">
                    <div class="col-md-6">
                        <label class="form-label">Titre</label>
                        <input type="text" class="form-control" name="accommodations[title]" value="<?php echo e(old('accommodations.title', data_get($settings, 'accommodations.title', 'D�f©couvrez des s�f©jours uniques'))); ?>">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Nombre d'items</label>
                    ...
                    <div class="col-12">
                        <p class="text-muted small mb-0">Affiche les h�f´tels et locations (post types: st_hotel, st_rental) les plus r�f©cents.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Voyages par th�f¨me</h5>
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        ...
                        <label class="form-check-label" for="holiday_enabled">Activer la section Voyages par th�f¨me</label>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <label class="form-label">Sur-titre</label>
                            <input type="text" class="form-control" name="holiday_theme[eyebrow]" value="<?php echo e(old('holiday_theme.eyebrow', data_get($holidayTheme, 'eyebrow', 'Voyages par th�f¨me'))); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Titre ligne 1</label>
                            <input type="text" class="form-control" name="holiday_theme[title_line_1]" value="<?php echo e(old('holiday_theme.title_line_1', data_get($holidayTheme, 'title_line_1'))); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Titre ligne 2</label>
                            <input type="text" class="form-control" name="holiday_theme[title_line_2]" value="<?php echo e(old('holiday_theme.title_line_2', data_get($holidayTheme, 'title_line_2'))); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Titre ligne 3</label>
                            <input type="text" class="form-control" name="holiday_theme[title_line_3]" value="<?php echo e(old('holiday_theme.title_line_3', data_get($holidayTheme, 'title_line_3'))); ?>">
                        </div>
                        <div class="col-md-8">
                            <label class="form-label">Sous-titre</label>
                            <input type="text" class="form-control" name="holiday_theme[subtitle]" value="<?php echo e(old('holiday_theme.subtitle', data_get($holidayTheme, 'subtitle'))); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Image gauche URL</label>
                            <input type="text" class="form-control" name="holiday_theme[left_image_url]" value="<?php echo e(old('holiday_theme.left_image_url', data_get($holidayTheme, 'left_image_url'))); ?>">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Image d�f©co URL</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Upload image d�f©co</label>
                            <input type="file" class="form-control" name="holiday_theme_deco_image_file" accept="image/*">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Texte CTA</label>
                            <input type="text" class="form-control" name="holiday_theme[button_text]" value="<?php echo e(old('holiday_theme.button_text', data_get($holidayTheme, 'button_text'))); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">URL CTA</label>
                            <input type="text" class="form-control" name="holiday_theme[button_url]" value="<?php echo e(old('holiday_theme.button_url', data_get($holidayTheme, 'button_url'))); ?>">
                        </div>
                    </div>

                    <h6 class="mb-2">Cartes voyages par th�f¨me</h6>
                            ...
                            <div class="border rounded p-2 holiday-row" data-index="<?php echo e($idx); ?>">
                                <div class="row g-2 align-items-center">
                                    <div class="col-auto d-flex flex-column gap-0">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-secondary holiday-move-down" title="Descendre">â�?��?o</button>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Titre</label>
                                        <input type="text" class="form-control form-control-sm" name="holiday_theme[items][<?php echo e($idx); ?>][title]" value="<?php echo e(data_get($item, 'title')); ?>">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Badge</label>
                                        <input type="text" class="form-control form-control-sm" name="holiday_theme[items][<?php echo e($idx); ?>][badge]" value="<?php echo e(data_get($item, 'badge')); ?>" placeholder="Nouveau">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Description</label>
                                        <input type="text" class="form-control form-control-sm" name="holiday_theme[items][<?php echo e($idx); ?>][description]" value="<?php echo e(data_get($item, 'description')); ?>" placeholder="Texte court">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Image URL</label>
                                        <input type="text" class="form-control form-control-sm" name="holiday_theme[items][<?php echo e($idx); ?>][image_url]" value="<?php echo e(data_get($item, 'image_url')); ?>">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Upload</label>
                                        <input type="file" class="form-control form-control-sm" name="holiday_theme_item_files[<?php echo e($idx); ?>]" accept="image/*">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Btn texte</label>
                                        <input type="text" class="form-control form-control-sm" name="holiday_theme[items][<?php echo e($idx); ?>][button_text]" value="<?php echo e(data_get($item, 'button_text', 'Voir plus')); ?>">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Btn URL</label>
                                        <input type="text" class="form-control form-control-sm" name="holiday_theme[items][<?php echo e($idx); ?>][button_url]" value="<?php echo e(data_get($item, 'button_url', '#')); ?>">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Tags</label>
                                        <input type="text" class="form-control form-control-sm" name="holiday_theme[items][<?php echo e($idx); ?>][tags]" value="<?php echo e(is_array(data_get($item, 'tags')) ? implode(', ', data_get($item, 'tags', [])) : data_get($item, 'tags')); ?>" placeholder="plage, famille, luxe">
                                    </div>
                                    <div class="col-auto">
                                        <div class="form-check form-switch mt-4">
                                            <input class="form-check-input" type="checkbox" name="holiday_theme[items][<?php echo e($idx); ?>][active]" value="1" <?php echo e(data_get($item, 'active', true) ? 'checked' : ''); ?>>
                                            <label class="form-check-label small">Actif</label>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-danger holiday-remove mt-4">�f�?"</button>
                                    </div>
                                    <div class="col-12">
                                        <div class="holiday-preview border rounded p-2 d-flex align-items-center gap-2">
                                            <div class="holiday-preview__img" style="width:64px;height:44px;border-radius:8px;background:#e7edf5 center/cover no-repeat; background-image:url('<?php echo e(e((string) data_get($item, 'image_url', ''))); ?>');"></div>
                                            <div>
                                                <div class="holiday-preview__title fw-bold small"><?php echo e(data_get($item, 'title', 'Titre')); ?></div>
                                                <div class="holiday-preview__meta text-muted small"><?php echo e(data_get($item, 'badge', '')); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Destinations par r�f©gion</h5>
                    <button type="button" class="btn btn-sm btn-outline-primary" id="dbr-add-item">Ajouter une r�f©gion</button>
                </div>
                <div class="card-body">
                    <p class="text-muted small mb-3">Grille 2�f�?"4 c�f´t�f© WordPress. Label obligatoire ; image et lien optionnels.</p>
                    <div class="form-check form-switch mb-3">
                        ...
                        <label class="form-check-label" for="dbr-enabled">Activer la section Destinations par r�f©gion</label>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Titre de la section</label>
                        <input type="text" class="form-control" name="destinations_by_region[title]" value="<?php echo e(old('destinations_by_region.title', data_get($destinationsByRegion, 'title', 'Destinations par r�f©gion'))); ?>" placeholder="Destinations par r�f©gion">
                    </div>
                    <div id="dbr-items-container" class="vstack gap-2">
                        ...
                        ?>
                        <?php $__currentLoopData = $dbrItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border rounded p-2 dbr-row align-items-center" data-index="<?php echo e($idx); ?>">
                                <div class="row g-2 align-items-center">
                                    <div class="col-auto d-flex flex-column gap-0">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-secondary dbr-move-down" title="Descendre">â�?��?o</button>
                                    </div>
                                    ...
                                    <div class="col-auto d-flex align-items-end"><button type="button" class="btn btn-sm btn-outline-danger dbr-remove">�f�?"</button></div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body vstack gap-3">
                    <div class="mb-3">
                        <label class="form-label">Titre de la section</label>
                        <input type="text" class="form-control" name="good_spots_title" value="<?php echo e(old('good_spots_title', data_get($settings, 'good_spots_title', 'Les bons coins sur votre destination'))); ?>">
                    </div>
                    <?php $__currentLoopData = old('good_spots', data_get($settings, 'good_spots', [])); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $spot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($idx < 4): ?>
                        <div class="border rounded p-3">
                            <h6 class="mb-2">Item <?php echo e($idx + 1); ?></h6>
                            <div class="row g-2">
                                ...
                                <div class="col-md-3"><input class="form-control" name="good_spots[<?php echo e($idx); ?>][icon]" value="<?php echo e(data_get($spot, 'icon')); ?>" placeholder="Ic�f´ne FA (ex: fas fa-utensils)"></div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="accordion_slider[autoplay]" value="1" id="accordion_slider_autoplay"
                                       <?php echo e(old('accordion_slider.autoplay', data_get($accordionSlider, 'autoplay', true)) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" min="2000" step="500" name="accordion_slider[autoplay_speed]"
                                   value="<?php echo e(old('accordion_slider.autoplay_speed', data_get($accordionSlider, 'autoplay_speed', 5000))); ?>">
                        </div>
                    </div>
                    ...
                    <div id="accordion-slider-items-container" class="vstack gap-3">
                        <?php $__currentLoopData = $accordionSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border rounded p-3 accordion-slider-row" data-index="<?php echo e($idx); ?>">
                                <div class="row g-2 align-items-start">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="accordion_slider[slides][<?php echo e($idx); ?>][title]" value="<?php echo e(data_get($slide, 'title')); ?>" required>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label small mb-0">Sous-titre</label>
                                        <input type="text" class="form-control form-control-sm" name="accordion_slider[slides][<?php echo e($idx); ?>][subtitle]" value="<?php echo e(data_get($slide, 'subtitle')); ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label small mb-0">Image URL</label>
                                        <input type="text" class="form-control form-control-sm accordion-slider-image-input" name="accordion_slider[slides][<?php echo e($idx); ?>][image]" value="<?php echo e(data_get($slide, 'image')); ?>" placeholder="https://...">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label small mb-0">Upload image</label>
                                        <input type="file" class="form-control form-control-sm" name="accordion_slider_files[<?php echo e($idx); ?>]" accept="image/*">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label small mb-0">Lien</label>
                                        <input type="text" class="form-control form-control-sm" name="accordion_slider[slides][<?php echo e($idx); ?>][link]" value="<?php echo e(data_get($slide, 'link', '#')); ?>" placeholder="https://...">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Texte bouton</label>
                                        <input type="text" class="form-control form-control-sm" name="accordion_slider[slides][<?php echo e($idx); ?>][button_text]" value="<?php echo e(data_get($slide, 'button_text')); ?>" placeholder="S'inscrire">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small mb-0">Style bouton</label>
                                        <select class="form-select form-select-sm" name="accordion_slider[slides][<?php echo e($idx); ?>][button_style]">
                                            <?php $buttonStyle = data_get($slide, 'button_style', 'orange'); ?>
                                            <option value="orange" <?php echo e($buttonStyle === 'orange' ? 'selected' : ''); ?>>Orange</option>
                                            <option value="white" <?php echo e($buttonStyle === 'white' ? 'selected' : ''); ?>>White</option>
                                            <option value="white-arabic" <?php echo e($buttonStyle === 'white-arabic' ? 'selected' : ''); ?>>White Arabic</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label small mb-0">Overlay / gradient</label>
                                        <input type="text" class="form-control form-control-sm" name="accordion_slider[slides][<?php echo e($idx); ?>][overlay_color]" value="<?php echo e(data_get($slide, 'overlay_color')); ?>" placeholder="linear-gradient(...)">
                                    </div>
                                    <div class="col-md-1">
                                        <label class="form-label small mb-0">Ordre</label>
                                        <input type="hidden" class="accordion-slider-order" name="accordion_slider[slides][<?php echo e($idx); ?>][order]" value="<?php echo e(data_get($slide, 'order', $idx + 1)); ?>">
                                    ...
                                    <div class="col-12">
                                        <div class="promo-preview">
                                            <div class="promo-preview__img accordion-slider-preview-img" style="background-image:url('<?php echo e(e((string) data_get($slide, 'image', ''))); ?>');"></div>
                                            <div>
                                                <div class="promo-preview__title accordion-slider-preview-title"><?php echo e(data_get($slide, 'title', 'Titre')); ?></div>
                                                <div class="promo-preview__subtitle accordion-slider-preview-subtitle"><?php echo e(data_get($slide, 'button_text', '')); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="card">
                <div class="card-header"><h5 class="card-title mb-0">Banni�f¨re WhatsApp</h5></div>
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        ...
                        <label class="form-check-label" for="whatsapp_enabled">Activer la banni�f¨re WhatsApp</label>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">Titre</label>
                            <input type="text" class="form-control" name="whatsapp_banner[title]" value="<?php echo e(old('whatsapp_banner.title', data_get($settings, 'whatsapp_banner.title', 'Rejoignez notre cha�f®ne WhatsApp pour suivre nos actualit�f©s voyage'))); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Texte court (description)</label>
                            <input type="text" class="form-control" name="whatsapp_banner[subtitle]" value="<?php echo e(old('whatsapp_banner.subtitle', data_get($settings, 'whatsapp_banner.subtitle', 'Restez inform�f© avec AjinSafro'))); ?>">
                        </div>
                        <div class="col-12">
                            <label class="form-label">Segments meta conserv�f©s pour compatibilit�f©</label>
                            <p class="text-muted small mb-2">Ces champs restent stock�f©s mais ne sont plus affich�f©s sur la home.</p>
                            <?php
                                $features = old('whatsapp_banner.features', data_get($settings, 'whatsapp_banner.features', []));
                                $features = is_array($features) ? $features : [];
                            ?>
                            <?php $__currentLoopData = range(0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <input type="text" class="form-control mb-2" name="whatsapp_banner[features][]" value="<?php echo e($features[$fi] ?? ''); ?>" placeholder="Segment <?php echo e($fi + 1); ?> (optionnel)">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Texte du bouton</label>
                            <input type="text" class="form-control" name="whatsapp_banner[button_text]" value="<?php echo e(old('whatsapp_banner.button_text', data_get($settings, 'whatsapp_banner.button_text', 'Rejoindre'))); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">URL du bouton</label>
                            <input type="text" class="form-control" name="whatsapp_banner[button_url]" value="<?php echo e(old('whatsapp_banner.button_url', data_get($settings, 'whatsapp_banner.button_url', '#'))); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">QR Code URL</label>
                            <input type="text" class="form-control" name="whatsapp_banner[qr_code_url]" value="<?php echo e(old('whatsapp_banner.qr_code_url', data_get($settings, 'whatsapp_banner.qr_code_url'))); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Upload QR Code</label>
                            <input type="file" class="form-control" name="whatsapp_banner_qr_file" accept="image/*">
                        </div>
                        <?php if(data_get($settings, 'whatsapp_banner.qr_code_url')): ?>
                            <div class="col-12">
                                <img src="<?php echo e(data_get($settings, 'whatsapp_banner.qr_code_url')); ?>" alt="QR Code" style="max-height:150px">
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header"><h5 class="card-title mb-0">Croisi�f¨res</h5></div>
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        ...
                        <label class="form-check-label" for="cruises_enabled">Activer la section Croisi�f¨res</label>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">Titre</label>
                            <input type="text" class="form-control" name="cruises[title]" value="<?php echo e(old('cruises.title', data_get($settings, 'cruises.title', 'Croisi�f¨res'))); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Image URL</label>
                            <input type="text" class="form-control" name="cruises[image_url]" value="<?php echo e(old('cruises.image_url', data_get($settings, 'cruises.image_url'))); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Upload Image</label>
                            <input type="file" class="form-control" name="cruises_image_file" accept="image/*">
                        </div>
                        <?php if(data_get($settings, 'cruises.image_url')): ?>
                            <div class="col-12">
                                <img src="<?php echo e(data_get($settings, 'cruises.image_url')); ?>" alt="Cruises" style="max-height:200px">
                            </div>
                        <?php endif; ?>
                        <div class="col-md-6">
                            <label class="form-label">Texte du bouton</label>
                            <input type="text" class="form-control" name="cruises[button_text]" value="<?php echo e(old('cruises.button_text', data_get($settings, 'cruises.button_text', 'D�f©couvrir'))); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">URL du bouton</label>
                            <input type="text" class="form-control" name="cruises[button_url]" value="<?php echo e(old('cruises.button_url', data_get($settings, 'cruises.button_url', '#'))); ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="footer[col2_heading]" value="<?php echo e(old('footer.col2_heading', data_get($settings, 'footer.col2_heading', 'Soci�f©t�f©'))); ?>">
                    </div>
                    <div class="col-12">
                        <label class="form-label">Mentions l�f©gales</label>
                        <textarea class="form-control" name="footer[legal_text]" rows="3" placeholder="Licence N�,° ... | RC: ..."><?php echo e(old('footer.legal_text', data_get($settings, 'footer.legal_text', "Licence N�,° 489117 | RC: 18989\nPatente: 50411316 | I.C.E: 001585417000035\nAjinSafro Recreation SARL AU"))); ?></textarea>
                    </div>
                </div>
            </div>
...
(function () {
    ...
    function newLinkRowHtml(idx, order) {
        ...
        return '<div class="border rounded p-3 hdr-link-row bg-light" data-index="' + idx + '">' +
            ...
            '<div class="col-md-2"><label class="form-label small mb-0">Ic�f´ne FA</label><input class="form-control form-control-sm" name="header[links][' + idx + '][icon]" placeholder="fas fa-hotel"></div>' +
    ...
    function newChildRowHtml(linkIdx, childIdx, order) {
        ...
        return '<div class="row g-2 align-items-center mb-1 hdr-child-row bg-white rounded p-1" data-child-index="' + childIdx + '">' +
            ...
            '<div class="col-2"><input class="form-control form-control-sm" name="header[links][' + linkIdx + '][children][' + childIdx + '][icon]" placeholder="Ic�f´ne FA"></div>' +
            '<div class="col-auto"><button type="button" class="btn btn-sm btn-outline-danger hdr-remove-child py-0 px-1">�f�?"</button></div>' +
            '</div>';
    }
    ...
    /* â�?��,�â�?��,� Ordre des sections + sections personnalis�f©es â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,� */
    ...
    function customSectionRowHtml(secKey) {
        return '<div class="border rounded p-3 section-order-row bg-light" data-section-key="' + secKey + '">' +
            ...
            '<div class="d-flex flex-column gap-0">' +
            '<button type="button" class="btn btn-sm btn-outline-secondary section-move-up" title="Monter">â�?��?~</button>' +
            '<button type="button" class="btn btn-sm btn-outline-secondary section-move-down" title="Descendre">â�?��?o</button></div>' +
            '<div class="form-check form-switch align-self-center">' +
            ...
            '<div class="align-self-center"><button type="button" class="btn btn-sm btn-outline-danger section-remove">�f�?"</button></div></div></div>';
    }
    function builtinSectionRowHtml(secKey) {
        ...
        return '<div class="border rounded p-2 section-order-row d-flex align-items-center gap-2" data-section-key="' + secKey + '">' +
            ...
            '<div class="ms-auto"><button type="button" class="btn btn-sm btn-outline-secondary section-remove" title="Retirer de la liste">�f�?"</button></div></div>';
    }
    ...
    function holidayRowHtml(idx) {
        return '<div class="border rounded p-2 holiday-row" data-index="' + idx + '">' +
            '<div class="row g-2 align-items-center">' +
            '<div class="col-auto d-flex flex-column gap-0"><button type="button" class="btn btn-sm btn-outline-secondary holiday-move-up" title="Monter">â�?��?~</button><button type="button" class="btn btn-sm btn-outline-secondary holiday-move-down" title="Descendre">â�?��?o</button></div>' +
            ...
            '<div class="col-auto"><input type="hidden" class="holiday-order" name="holiday_theme[items][' + idx + '][order]" value="' + idx + '"><button type="button" class="btn btn-sm btn-outline-danger holiday-remove mt-4">�f�?"</button></div>' +
    ...
    /* â�?��,�â�?��,� Destinations par r�f©gion (DBR) â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,�â�?��,� */
    ...
    function dbrRowHtml(idx, order, label, imageUrl, linkUrl) {
        ...
        return '<div class="border rounded p-2 dbr-row align-items-center" data-index="' + idx + '">' +
            '<div class="row g-2 align-items-center">' +
            '<div class="col-auto d-flex flex-column gap-0"><button type="button" class="btn btn-sm btn-outline-secondary dbr-move-up" title="Monter">â�?��?~</button><button type="button" class="btn btn-sm btn-outline-secondary dbr-move-down" title="Descendre">â�?��?o</button></div>' +
