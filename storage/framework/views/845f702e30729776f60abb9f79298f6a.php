            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Remove the default <code class="highlighter-rouge">list-style</code> and left
                        margin on list items
                        (imd-flex align-items-startte children only). <strong>This only applies to imd-flex
                            align-items-startte
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="bg-info-subtle clearfix mt-2">
                                <button type="button" class="btn btn-primary float-start">Example Button floated
                                    left</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\themeforest-uMqxCtcU-qovex-laravel-admin-dashboard-template\Qovex_Laravel_v3.0.0\Admin\resources\views\ui-typography.blade.php ENDPATH**/ ?>