...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => 'Demandes Hajj & Omra','subtitle' => 'Suivez les demandes de reservation envoyees depuis le site public.','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Demandes Hajj & Omra','subtitle' => 'Suivez les demandes de reservation envoyees depuis le site public.','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
            ['label' => 'Admin', 'url' => route('admin.dashboard')],
            ['label' => 'Hajj & Omra', 'url' => route('admin.hajj-omra.index')],
            ['label' => 'Demandes'],
        ])]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.filter-panel','data' => ['action' => route('admin.hajj-omra.requests.index'),'resetUrl' => route('admin.hajj-omra.requests.index'),'gridClass' => 'row g-3 align-items-end']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hajj-omra.requests.index')),'reset-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.hajj-omra.requests.index')),'grid-class' => 'row g-3 align-items-end']); ?>
         <?php $__env->slot('fields', null, []); ?> 
            <div class="col-md-4">
                <label class="form-label">Recherche</label>
                <input type="text" name="q" value="<?php echo e($filters['q']); ?>" class="form-control" placeholder="Nom, email, telephone">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <select name="package_id" class="form-select">
                    ...
                    <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($package->id); ?>" <?php if($filters['package_id'] === $package->id): echo 'selected'; endif; ?>><?php echo e($package->title); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
         <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.empty-state','data' => ['title' => 'Aucune demande','message' => 'Les demandes du site public apparaitront ici.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Aucune demande','message' => 'Les demandes du site public apparaitront ici.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <td class="text-end">
                                <a href="<?php echo e(route('admin.hajj-omra.requests.show', $requestItem)); ?>" class="aj-btn aj-btn-soft btn-sm">
                                    Voir le detail
                                </a>
                            </td>
                        </tr>
