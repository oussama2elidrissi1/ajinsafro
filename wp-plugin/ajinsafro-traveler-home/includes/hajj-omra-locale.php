...
function ajth_ho_translations() {
    return array(
        ...
        'Départ à partir du' => 'المغادرة ابتداءً من',
        'Date de départ' => 'تاريخ المغادرة',
        'villes de départ' => 'مدن المغادرة',
        'offres au catalogue' => 'عروض في الدليل',
        'places disponibles' => 'مقاعد متاحة',
        'Sans limite' => 'بلا حد',
        'Trier par' => 'الترتيب حسب',
        'Prix croissant' => 'السعر تصاعدياً',
        'Toutes' => 'الكل',
        'Masquer les offres complètes' => 'إخفاء العروض المكتملة',
        'Offres disponibles' => 'العروض المتاحة',
        'offre(s)' => 'عرض',
        'place(s)' => 'مقعد',
        'Aucune offre pour ce filtre' => 'لا يوجد عرض مطابق',
        'Choisissez un autre type ou affichez à nouveau les offres complètes.' => 'اختر نوعاً آخر أو أظهر العروض المكتملة مجدداً.',
        'Réinitialiser les filtres' => 'إعادة ضبط التصفية',
        'Complet — liste d’attente' => 'مكتمل — قائمة انتظار',
        'places restantes' => 'مقاعد متبقية',
        'places au total' => 'مقعداً إجمالاً',
        'Détails' => 'التفاصيل',
        'Réserver' => 'احجز الآن',
        'Être alerté' => 'أبلغني',
        'Vous ne trouvez pas la date qui vous convient ?' => 'لم تجد التاريخ المناسب؟',
        'Nos conseillers construisent votre programme Omra sur mesure : hôtel, durée, ville de départ et budget.' => 'يبني مستشارونا برنامج عمرتك حسب الطلب: الفندق والمدة ومدينة المغادرة والميزانية.',
        'Demande sur mesure' => 'طلب برنامج خاص',
        'Nous appeler' => 'اتصل بنا',
        'Offres Omra, Hajj, Ramadan, Low Cost et Premium — hôtels, dates de départ et places restantes mis à jour en direct depuis notre base.' => 'عروض العمرة والحج ورمضان مع الفنادق والمواعيد والمقاعد المتبقية مباشرة من قاعدتنا.',
