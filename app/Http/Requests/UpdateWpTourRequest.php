...
class UpdateWpTourRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tour_hotels.*.check_in_day' => 'nullable|integer|min:1',
            'tour_hotels.*.check_out_day' => 'nullable|integer|min:1',
            ...
            'tour_hotels.*.rooms.*.room_count' => 'nullable|integer|min:1',
            'tour_hotels.*.rooms.*.capacity_adults' => 'nullable|integer|min:0',
            'tour_hotels.*.rooms.*.capacity_children' => 'nullable|integer|min:0',
            'tour_hotels.*.rooms.*.capacity_total' => 'nullable|integer|min:1',
            'tour_hotels.*.rooms.*.supplement' => 'nullable|numeric|min:0',
            'tour_hotels.*.rooms.*.description' => 'nullable|string|max:2000',
            'tour_hotels.*.rooms.*.is_active' => 'nullable|boolean',
            'tour_hotels.*.rooms.*.sort_order' => 'nullable|integer|min:0',
            'tour_hotels.*.rooms.*.is_default' => 'nullable|boolean',
