...
class UpdateClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => ['nullable', 'email', 'max:255', Rule::unique(Client::class, 'email')->ignore($clientId)],
            ...
            'passport_number' => ['nullable', 'string', 'max:50', Rule::unique(Client::class, 'passport_number')->ignore($clientId)],
