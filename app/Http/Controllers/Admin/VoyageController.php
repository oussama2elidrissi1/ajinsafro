...
class VoyageController extends Controller
{
    ...
    public function create(): View
    {
        ...
        $metaKeys = [
            ...
            'min_price', 'base_price', 'sale_price', 'adult_price', 'child_price', 'infant_price', 'child_age_pricing', 'discount', 'discount_type', 'discount_by_people_type', 'calculator_discount_by_people_type',
    ...
    public function edit(int $id): View
    {
        ...
        $meta = [
            ...
            'child_age_pricing' => $wpPost->getMeta('child_age_pricing'),
