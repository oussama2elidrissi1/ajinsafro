...
class CustomRequestQuoteController extends Controller
{
    ...
    private function saveQuotePayload(Request $request, CustomRequestQuote $quote): void
    {
        ...
        $data = $request->validate([
            ...
            'items.*.custom_request_quote_day_id' => ['nullable', 'integer'],
            'items.*.quotation_day_id' => ['nullable', 'integer'],
            'items.*.day_id' => ['nullable', 'integer'],
            'items.*.day_index' => ['nullable', 'integer', 'min:0'],
