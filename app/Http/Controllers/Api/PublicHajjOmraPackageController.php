    ...
    public function index(): JsonResponse
    {
        ...
        $items = $packages->map(function (HajjOmraPackage $package) use ($publicBase) {
            ...
            return array_merge([
                ...
                'whatsapp_phone' => $package->whatsapp_number,
                ...
                // Capacite de reference du prochain depart : sert la jauge d'occupation du catalogue.
                'total_places' => (int) ($nextDeparture?->available_places ?? $package->available_places ?? 0),
