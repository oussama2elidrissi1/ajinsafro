(function () {
    ...
    var fastRoomingFirstEntryPrepared = false;
    ...
    function prepareFastRoomingFirstEntry() {
        if (!isFastMode || fastRoomingFirstEntryPrepared) return;
        fastRoomingFirstEntryPrepared = true;
        roomingAllocations = [];
