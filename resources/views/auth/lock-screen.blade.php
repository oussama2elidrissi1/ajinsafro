...
@section('content')
    <div class="home-btn d-none d-sm-block">
        <a href="{{ route('admin.dashboard') }}" class="text-reset"><i class="fas fa-home h2"></i></a>
    </div>
                    ...
                    <div class="card overflow-hidden">
                        <div class="bg-login text-center">
                            ...
                            <div class="position-relative">
                                ...
                                <a href="{{ route('admin.dashboard') }}" class="logo logo-admin mt-4">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" method="POST" action="{{ route('lock-screen.unlock') }}">
                                    @csrf
