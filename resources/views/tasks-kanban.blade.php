                    ...
                    <div id="upcoming-task" class="pb-1 task-list">
                            ...
                            <div class="card-body">
                                ...
                                <div class="team float-start">
                                    <a href="javascript: void(0);" class="team-member d-inline-block">
                                        <img src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-xs m-1"
                                            alt="">
                                    </a>

                                    <a href="javascript: void(0);" class="team-member d-inline-block">
                                        <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" class="rounded-circle avatar-xs m-1"
                                            alt="">
                                    </a>
                        ...
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div class="team float-start">
                                    <a href="javascript: void(0);" class="team-member d-inline-block">
                                        <img src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" class="rounded-circle avatar-xs m-1"
                                            alt="">
                                    </a>

                                    <a href="javascript: void(0);" class="team-member d-inline-block">
                                        <img src="{{ URL::asset('build/images/users/avatar-7.jpg') }}" class="rounded-circle avatar-xs m-1"
                                            alt="">
                                    </a>
                                </div>
                                <div class="text-end">
                    ...
                    <div id="inprogress-task" class="pb-1 task-list">
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div class="team float-start">
                                    ...
                                    <a href="javascript: void(0);" class="team-member d-inline-block">
                                        <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" class="rounded-circle avatar-xs m-1"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div class="team float-start">
                                    <a href="javascript: void(0);" class="team-member d-inline-block">
                                        <img src="{{ URL::asset('build/images/users/avatar-8.jpg') }}" class="rounded-circle avatar-xs m-1"
                                            alt="">
                                    </a>
                                    <a href="javascript: void(0);" class="team-member d-inline-block">
                                        <div class="avatar-xs">
                                    ...
                                    <a href="javascript: void(0);" class="team-member d-inline-block">
                                        <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="rounded-circle avatar-xs m-1"
                                            alt="">
                                    </a>
                        ...
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div class="team float-start">
                                    <a href="javascript: void(0);" class="team-member d-inline-block">
                                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-xs m-1"
                                            alt="">
                                    </a>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-inline mb-4">
                                    <li class="list-inline-item">
                                        <a href="#">
                                            <div>
                                                <img src="{{ URL::asset('build/images/small/img-1.jpg') }}" class="rounded" alt=""
                                                    height="48">
                                            </div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="#">
                                            <div>
                                                <img src="{{ URL::asset('build/images/small/img-2.jpg') }}" class="rounded" alt=""
                                                    height="48">
                                            </div>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a href="#">
                                            <div>
                                                <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" class="rounded" alt=""
                                                    height="48">
                                            </div>
                                        </a>
                                    </li>
