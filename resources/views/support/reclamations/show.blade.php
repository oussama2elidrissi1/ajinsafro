...
@section('content')
<div class="{{ $supportUsesAgentPortal ? 'aj-agent-dashboard ' : '' }}support-reclamation-page">
...
<style>
    .support-reclamation-page{position:relative;z-index:1;padding:30px 30px 64px;background:transparent;min-height:calc(100vh - 120px)}
    .support-reclamation-shell{width:100%;max-width:1260px;margin:0 auto}
    .support-reclamation-header{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;margin-bottom:18px;padding:22px 24px;border:1px solid #dbe6f2;border-radius:18px;background:rgba(255,255,255,.96);box-shadow:0 16px 38px rgba(15,23,42,.07);backdrop-filter:blur(8px)}
    ...
    .support-reclamation-title h1{margin:0;color:#102a43;font-size:28px;font-weight:900;line-height:1.18}
    ...
    .support-reclamation-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(300px,360px);gap:18px;align-items:start}
    .support-card{overflow:hidden;border:1px solid #dbe6f2;border-radius:16px;background:rgba(255,255,255,.97);box-shadow:0 14px 34px rgba(15,23,42,.06)}
    ...
    .support-attachment img{display:block;width:100%;max-height:460px;object-fit:contain;background:#fff}
    ...
    .agent-portal-content .support-reclamation-page{padding-top:34px}
    ...
    @media (max-width:900px){.support-reclamation-page{padding:22px 18px 48px}}
