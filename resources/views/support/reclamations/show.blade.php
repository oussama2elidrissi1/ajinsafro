...
<style>
    .support-reclamation-page{padding:24px 18px 48px;background:#f3f7fb;min-height:calc(100vh - 120px)}
    .support-reclamation-shell{width:min(1180px,100%);margin:0 auto}
    ...
    .support-reclamation-grid{display:grid;grid-template-columns:minmax(0,1.45fr) minmax(320px,.85fr);gap:18px;align-items:start}
    ...
    .support-message{margin:0 0 16px;color:#334155;font-size:14px;line-height:1.65;white-space:pre-line}
    ...
    @media (max-width:991px){.support-reclamation-grid{grid-template-columns:1fr}.support-reclamation-header{flex-direction:column}.support-reclamation-back{align-self:flex-start}}
