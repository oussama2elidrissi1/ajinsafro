                ...
                <div class="dashboard-v3-card-body">
                    <div class="dashboard-v3-revenue-bars">
                        @foreach($revenueData as $row)
                            @php($height = (int) round(($row['ca'] / max(1, $maxRevenue)) * 190))
                ...
                <div class="dashboard-v3-card-body">
                    <div class="d-grid gap-2">
                        @foreach($recentReservations as $row)
                            @php($statusClass = $statusClasses[$row['status']] ?? 'is-info')
            ...
            <article class="dashboard-v3-card">
                ...
                <div class="dashboard-v3-card-body">
                    @foreach($salesChannels as $row)
                        @php($channelPercentage = (int) round(($row['value'] / max(1, $maxSalesChannel)) * 100))
