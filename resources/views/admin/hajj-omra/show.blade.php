    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <x-admin.form-section title="Resume">
                <div class="d-flex flex-column gap-3">
                    ...
                    <div><strong>Ville de depart :</strong> {{ $package->departure_city ?: 'â€”' }}</div>
                    <div><strong>Destination :</strong> {{ $package->destination ?: 'â€”' }}</div>
        ...
        <div class="col-lg-8">
            <x-admin.form-section title="Description">
                <div class="mb-3"><strong>Description courte</strong><br>{{ $package->short_description ?: 'â€”' }}</div>
                <div><strong>Description detaillee</strong><br>{!! nl2br(e($package->description ?: 'â€”')) !!}</div>
            </x-admin.form-section>

            <x-admin.form-section title="Hotels et services">
                <div class="row g-3">
                    <div class="col-md-6"><strong>Hotel Makkah :</strong> {{ $package->makkah_hotel ?: 'â€”' }}</div>
                    <div class="col-md-6"><strong>Distance Haram Makkah :</strong> {{ $package->makkah_haram_distance ?: 'â€”' }}</div>
                    <div class="col-md-6"><strong>Hotel Madinah :</strong> {{ $package->madinah_hotel ?: 'â€”' }}</div>
                    <div class="col-md-6"><strong>Distance Haram Madinah :</strong> {{ $package->madinah_haram_distance ?: 'â€”' }}</div>
                ...
                @foreach($package->programDays as $programDay)
                    <div class="col-md-6">
                        <div class="border rounded-3 p-3 h-100">
                            ...
                            <div>{{ $programDay->description ?: 'â€”' }}</div>
                        </div>
                    </div>
                @endforeach
            </div>
