...
<aside class="admin-v6-sidebar" id="adminV6Sidebar" aria-label="Navigation Ajinsafro">
    ...
    <div class="aj-sidebar-v2" data-aj-sidebar-v2 data-sidebar-context="{{ $sidebarContext }}">
        <div class="aj-sidebar-v2__brand">
            <a href="{{ $brandHref }}" class="aj-sidebar-v2__brand-link" aria-label="{{ $brandName }}">
                <img src="{{ $brandLogo }}" alt="{{ $brandName }}" class="aj-sidebar-v2__brand-logo">
            </a>
        </div>

        <div class="aj-sidebar-v2__profile">
            <div class="aj-sidebar-v2__avatar-wrap">
                <img src="{{ $user?->avatar_url }}" alt="{{ $user?->name ?? 'Admin' }}" class="aj-sidebar-v2__avatar" onerror="this.style.display='none'; this.nextElementSibling.style.display='grid';">
                <span class="aj-sidebar-v2__avatar-fallback">{{ $initials }}</span>
            </div>
            <div class="aj-sidebar-v2__profile-name">{{ $user?->name ?? 'Admin' }}</div>
            <div class="aj-sidebar-v2__profile-role">{{ $roleLabel }}</div>
