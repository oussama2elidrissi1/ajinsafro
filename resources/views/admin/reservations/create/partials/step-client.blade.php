            ...
            @foreach($oldPassengers as $i => $passenger)
                ...
                <div class="companion-row reservation-create__companion" data-companion-id="{{ $companionKey }}" data-traveler-key="{{ $companionKey }}">
                    ...
                    <div class="reservation-create__grid reservation-create__grid--two">
                        ...
                        <div class="reservation-create__field"><label class="reservation-create__label">Sexe <span class="required-star">*</span></label><select name="passengers[{{ $companionKey }}][gender]" class="reservation-create__input"><option value="">Sélectionner...</option><option value="male" {{ ($passenger['gender'] ?? '') === 'male' ? 'selected' : '' }}>Homme</option><option value="female" {{ ($passenger['gender'] ?? '') === 'female' ? 'selected' : '' }}>Femme</option></select></div>
