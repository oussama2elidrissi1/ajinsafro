            ...
            @foreach($oldPassengers as $i => $passenger)
                ...
                <div class="companion-row reservation-create__companion" data-companion-id="{{ $companionKey }}" data-traveler-key="{{ $companionKey }}">
                    ...
                    <div class="reservation-create__grid reservation-create__grid--two">
                        ...
                        <div class="reservation-create__field"><label class="reservation-create__label">Prenom</label><input type="text" name="passengers[{{ $companionKey }}][first_name]" class="reservation-create__input" value="{{ $passenger['first_name'] ?? '' }}"></div>
                        <div class="reservation-create__field"><label class="reservation-create__label">Nom</label><input type="text" name="passengers[{{ $companionKey }}][last_name]" class="reservation-create__input" value="{{ $passenger['last_name'] ?? '' }}"></div>
                        ...
                        <div class="reservation-create__field"><label class="reservation-create__label">Sexe</label><select name="passengers[{{ $companionKey }}][gender]" class="reservation-create__input"><option value="">Selectionner...</option><option value="male" {{ ($passenger['gender'] ?? '') === 'male' ? 'selected' : '' }}>Homme</option><option value="female" {{ ($passenger['gender'] ?? '') === 'female' ? 'selected' : '' }}>Femme</option></select></div>
