...
<div class="reservation-create-v2">
            ...
            <main class="v2-main">
                ...
                <section class="v2-panel is-active" data-v2-step="1">
                    <div class="v2-card">
                        ...
                        <input type="hidden" name="base_price" id="v2-base-price-hidden" value="{{ old('base_price', '') }}">
                    </div>
                    ...
                    <div class="v2-card">
                        ...
                        <div id="v2-existing-client-block" {{ old('client_mode') !== 'existing' ? 'hidden' : '' }}>
                            <div class="v2-field v2-field--full" style="position:relative;z-index:20;">
                                ...
                                <a href="{{ route('admin.customers.clients.create') }}" target="_blank" rel="noopener" class="v2-link">Créer un nouveau client</a>
                            </div>
                        </div>
                ...
                <section class="v2-panel" data-v2-step="4" hidden>
                    ...
                    <div class="v2-actions v2-actions--final">
                        ...
                        <div class="v2-actions__group">
                            <a href="{{ route('admin.reservations.workspace') }}" class="v2-btn v2-btn--ghost">Annuler</a>
    ...
    <script type="application/json" id="v2-extras-map">{!! json_encode($extrasByVoyage ?? [], JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_UNESCAPED_UNICODE) !!}</script>
</div>
@endsection
