...
@endphp
<tr class="ws-catalog-row group border-b border-gray-100/80 last:border-0 hover:bg-gradient-to-r hover:from-[#e6f3fa]/40 hover:to-transparent transition-colors"
    data-type="{{ $typeKey }}"
