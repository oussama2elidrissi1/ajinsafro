...
<form id="workspace-reservation-form" method="post" action="{{ route('admin.reservations.workspace.store') }}" enctype="multipart/form-data" class="space-y-8">
    ...
    <div id="details-dynamic-container">
        <div id="details-package" class="space-y-4 details-block">
            ...
            <div>
                ...
                <select name="package_room_type" class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#0083c4]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-[#f8fbfd] p-5 rounded-xl border border-blue-100">
            ...
            <input type="number" step="0.01" name="montant_paye" required class="w-full px-4 py-2 bg-white border border-green-200 rounded-xl text-lg font-bold text-green-600 mb-3">
