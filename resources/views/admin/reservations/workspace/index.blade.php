...
<div class="fade-in ws-page {{ $isCommercialReservationsOnly ? 'ws-page--commercial' : 'max-w-[1680px] mx-auto' }} pb-10 overflow-x-hidden">
    ...
    <div id="reservations-main-content" class="commercial-v2-main space-y-6">
        ...
        <div id="ws-view-catalog" class="commercial-v2-panel {{ $workspaceView === 'catalog' ? '' : 'hidden' }}"><div class="commercial-v2-cards-grid">@foreach($sellableRows as $row)@include('admin.reservations.workspace.partials.catalog-row', ['row' => $row, 'mode' => 'card'])@endforeach</div></div>
        ...
        <form id="catalogue-workspace" class="ws-toolbar" method="GET" action="{{ route('admin.reservations.workspace') }}">
            ...
            <div class="ws-toolbar__row ws-toolbar__row--filters-grid">
                ...
                <div class="ws-field">
                    ...
                    <div class="ws-budget-inline">
                        <input type="number" id="ws-filter-budget-max" name="budget_max" value="{{ $workspaceFilters['budget_max'] ?? '' }}" class="ws-input" min="0" step="500" inputmode="numeric" placeholder="30000">
                        <span class="ws-budget-inline__suffix">MAD</span>
                    </div>
                </div>
