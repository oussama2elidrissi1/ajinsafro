...
<div class="row g-3">
    ...
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-bottom d-flex align-items-center justify-content-between">
                <h6 class="mb-0">Départs Group Deal ({{ $voyage->departures->count() }})</h6>
            ...
            <div class="card-body p-0">
                @if($voyage->departures->isEmpty())
                    <div class="p-4 text-center text-muted small">
                        ...
                        <br>Activez l'option Group Deal sur un départ depuis la <a href="{{ route('admin.circuits.voyages.show', $voyage->id) }}">fiche voyage</a>.
                    </div>
                @else
                    <table class="table table-hover mb-0 align-middle">
                        <thead class="table-light">
