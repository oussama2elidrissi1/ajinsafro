        ...
        <div class="col-lg-8">
            <div class="card ve-pane-card mb-0">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-2">Fiche commerciale du voyage</h4>
                    <p class="text-muted small mb-4">Renseignez le titre, la presentation et les elements visibles dans la fiche voyage.</p>
                ...
                <div class="card ve-pane-card ve-basic-side-card mb-0">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Calcule a partir des chambres configurees.</small>
                        </div>
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="hide_adult_in_booking_form">Masquer le champ adulte a la reservation</label>
                        </div>

                        <div class="mb-0">
                            <label for="st_tour_external_booking" class="form-label">Lien de reservation externe</label>
