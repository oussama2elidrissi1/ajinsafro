...
@section('content')
    ...
    <form action="{{ route('admin.circuits.activities.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <small class="text-muted d-block mt-1">Formats acceptés: JPEG, PNG, WebP (max 5MB)</small>
                            <div id="image-preview-wrap" class="mt-3" style="display: none;">
                                <img id="image-preview" src="" alt="Preview" class="img-fluid rounded" style="max-height: 200px; object-fit: cover;">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="base_price" class="form-label">Prix de base</label>
                            <input type="number" class="form-control" id="base_price" name="base_price" value="{{ old('base_price') }}" step="0.01" min="0" placeholder="0.00">
                        </div>
                        <div class="mb-3">
