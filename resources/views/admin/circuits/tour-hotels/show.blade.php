        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    ...
                    <p class="small text-muted mb-2">Cet hôtel circuit est rattaché à ce voyage (tour_id = {{ $tour->ID }}).</p>
            ...
            @else
                <div class="card shadow-sm mb-3 border-warning">
                    <div class="card-body text-center text-muted py-4">
                        ...
                        <a href="{{ route('admin.circuits.tour-hotels.edit', $tour->ID) }}" class="btn btn-primary btn-sm mt-2">Renseigner l'hôtel</a>
                    </div>
                </div>
            @endif
        </div>
