...
<div class="aj-page-head" style="margin-bottom:18px;">
    <div>
        ...
        <p>Vue opérationnelle de l’agence, des réservations et des comptes liés.</p>
    </div>
    <div style="display:flex;gap:10px;flex-wrap:wrap;">
        @if(Route::has('admin.agencies.index'))
            <a href="{{ route('admin.agencies.index') }}" class="aj-btn">Retour agences</a>
        @endif
        @if(Route::has('admin.agency-accounts.index'))
            <a href="{{ route('admin.agency-accounts.index', ['branch_id' => $agency->id]) }}" class="aj-btn">Comptes agences</a>
        @endif
    </div>
</div>
...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-3"><div class="aj-card"><div class="aj-card-body"><div class="aj-subtle">CA agence</div><div style="font-size:28px;font-weight:900;color:#172b4d;">{{ number_format($revenueTotal, 0, ',', ' ') }} €</div></div></div></div>
    ...
    <div class="col-lg-5">
        ...
        <div class="aj-card">
            ...
            <div class="aj-card-body">
                ...
                <div class="aj-subtle">Agence : {{ $agency->agency_type ? ucfirst($agency->agency_type) : '—' }}</div>
