    ...
    <div class="max-w-[1400px] mx-auto px-4 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-2">
            <div class="hidden sm:flex items-center gap-2 bg-white/5 px-3 py-1.5 rounded-lg">
                <img src="{{ auth()->user()->avatar_url }}" alt="Avatar" class="w-7 h-7 rounded-full border border-white/20 object-cover">
                <div class="flex flex-col leading-tight">
                    <span class="font-bold text-white text-[11px]">{{ auth()->user()->name }}</span>
