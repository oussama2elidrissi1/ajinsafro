        ...
        <div class="ksk-layout">
            ...
            <div class="ksk-builder" id="ksk-builder">
                ...
                <nav class="ksk-steps" id="ksk-steps-nav">
                    <button class="ksk-step is-active" data-step="{{ $stepBooking }}"><span class="ksk-step__num">1</span><span class="ksk-step__label">Infos & voyageurs</span></button>
                    <button class="ksk-step" data-step="{{ $stepConfirmation }}"><span class="ksk-step__num">2</span><span class="ksk-step__label">Confirmation</span></button>
                ...
                <section class="ksk-panel is-active" data-panel="{{ $stepBooking }}" id="ksk-panel-booking">
                    ...
                    <div class="ksk-compact-trip">
                        @if($heroSrc)
                            <img src="{{ $heroSrc }}" alt="{{ $voyageName }}" class="ksk-compact-trip__img">
                        @endif
                        <div class="ksk-compact-trip__body">
                            ...
                            <div class="ksk-compact-trip__meta">
                                ...
                                <span @if(! $hasPlaces) hidden @endif id="ksk-compact-city-wrap"><i class="fas fa-plane-departure"></i> <strong id="ksk-compact-city">{{ $hasPlaces ? 'Ville à choisir' : '—' }}</strong></span>
                                <span><i class="fas fa-users"></i> <strong id="ksk-compact-pax">1 adulte</strong></span>
                                <span><i class="fas fa-tag"></i> <strong id="ksk-compact-total">— {{ $cur }}</strong></span>
                            </div>
                        </div>
                    </div>
                    @if($hasPlaces)
...
(function(){
    ...
    function tsRenderSummary() {
        ...
        html += tsSumRow('Voyage', @json($voyageName), 'fa-suitcase');
